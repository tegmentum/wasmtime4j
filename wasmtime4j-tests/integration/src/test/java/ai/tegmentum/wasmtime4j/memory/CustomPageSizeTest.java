...
public class CustomPageSizeTest extends DualRuntimeTest {
  ...
  class StandardPageSizeTests {
    ...
    void shouldCreateMemoryWithStandardPageSize(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should create memory with standard 64KB page size");

      try (Engine engine = Engine.create()) {
        final Store store = engine.createStore();
        resources.add(store);

        final Module module = engine.compileWat(STANDARD_MEMORY_WAT);
    ...
    void shouldGrowMemoryByStandardPageSize(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should grow memory by standard page size");
  ...
  class CustomPageSizeConfigurationTests {
    ...
    void shouldEnableCustomPageSizesViaEngineConfig(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should enable custom page sizes via engine config");
    ...
    void shouldReportCustomPageSizeConfiguration(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should report custom page size configuration");
  ...
  class MemoryBoundaryTests {
    ...
    void shouldHandleMemoryAtPageBoundary(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should handle memory at page boundary");
    ...
    void shouldHandleMemoryGrowthAndAccess(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should handle memory growth and access");
  ...
  class MemoryLimitsTests {
    ...
    void shouldRespectMaximumMemoryLimit(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should respect maximum memory limit");
    ...
    void shouldHandleZeroPageGrowth(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should handle zero page growth");
  ...
  class CustomPageSizeApiTests {
    ...
    void shouldExposePageSizeInformation(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should expose page size information");
    ...
    void shouldCalculateMemorySizeFromPagesCorrectly(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should calculate memory size from pages correctly");
  ...
  class MemoryOperationsWithPageSizeTests {
    ...
    void shouldFillMemoryAcrossPageBoundaries(final RuntimeType runtime) throws Exception {
      setRuntime(runtime);
      LOGGER.info("Testing: should fill memory across page boundaries");
