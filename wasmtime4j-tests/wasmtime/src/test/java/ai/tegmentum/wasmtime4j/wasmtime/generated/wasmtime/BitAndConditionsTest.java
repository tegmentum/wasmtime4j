...
public final class BitAndConditionsTest extends DualRuntimeTest {
  ...
  public void testBitAndConditions(final RuntimeType runtime) throws Exception {
    ...
    try (final WastTestRunner runner = new WastTestRunner()) {
      ...
      // WAT file:
      // ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/BitAndConditionsTest_module1.wat
      final String moduleWat1 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/wasmtime/generated/wasmtime/BitAndConditionsTest_module1.wat");
      ...
      // ( assert_return ( invoke "select_b20" ( i32.const 0) ( i32.const 100) ( i32.const 200)) (
      // i32.const 200))
      runner.assertReturn(
          "select_b20",
          new WasmValue[] {WasmValue.i32(200)},
          WasmValue.i32(0),
          WasmValue.i32(100),
          WasmValue.i32(200));

      // ( assert_return ( invoke "select_b20" ( i32.const 0x100000) ( i32.const 100) ( i32.const
      // 200)) ( i32.const 100))
      runner.assertReturn(
          "select_b20",
          new WasmValue[] {WasmValue.i32(100)},
          WasmValue.i32(0x100000),
          WasmValue.i32(100),
          WasmValue.i32(200));
      ...
      runner.assertReturn(
          "if_b40", new WasmValue[] {WasmValue.i64(100L)}, WasmValue.i64(0x10000000000L));

      // ( assert_return ( invoke "select_b40" ( i64.const 0) ( i64.const 100) ( i64.const 200)) (
      // i64.const 200))
      runner.assertReturn(
          "select_b40",
          new WasmValue[] {WasmValue.i64(200L)},
          WasmValue.i64(0L),
          WasmValue.i64(100L),
          WasmValue.i64(200L));

      // ( assert_return ( invoke "select_b40" ( i64.const 0x10000000000) ( i64.const 100) (
      // i64.const 200)) ( i64.const 100))
      runner.assertReturn(
          "select_b40",
          new WasmValue[] {WasmValue.i64(100L)},
          WasmValue.i64(0x10000000000L),
          WasmValue.i64(100L),
          WasmValue.i64(200L));
      ...
      runner.assertReturn(
          "eqz_b40", new WasmValue[] {WasmValue.i32(0)}, WasmValue.i64(0x10000000000L));

      // ( assert_return ( invoke "if_bit32" ( i32.const 0) ( i32.const 1)) ( i32.const 200))
      runner.assertReturn(
          "if_bit32", new WasmValue[] {WasmValue.i32(200)}, WasmValue.i32(0), WasmValue.i32(1));

      // ( assert_return ( invoke "if_bit32" ( i32.const 0) ( i32.const 0)) ( i32.const 200))
      runner.assertReturn(
          "if_bit32", new WasmValue[] {WasmValue.i32(200)}, WasmValue.i32(0), WasmValue.i32(0));

      // ( assert_return ( invoke "if_bit32" ( i32.const 1) ( i32.const 1)) ( i32.const 200))
      runner.assertReturn(
          "if_bit32", new WasmValue[] {WasmValue.i32(200)}, WasmValue.i32(1), WasmValue.i32(1));

      // ( assert_return ( invoke "if_bit32" ( i32.const 1) ( i32.const 33)) ( i32.const 200))
      runner.assertReturn(
          "if_bit32", new WasmValue[] {WasmValue.i32(200)}, WasmValue.i32(1), WasmValue.i32(33));

      // ( assert_return ( invoke "if_bit32" ( i32.const 1) ( i32.const 0)) ( i32.const 100))
      runner.assertReturn(
          "if_bit32", new WasmValue[] {WasmValue.i32(100)}, WasmValue.i32(1), WasmValue.i32(0));

      // ( assert_return ( invoke "if_bit32" ( i32.const 1) ( i32.const 32)) ( i32.const 100))
      runner.assertReturn(
          "if_bit32", new WasmValue[] {WasmValue.i32(100)}, WasmValue.i32(1), WasmValue.i32(32));

      // ( assert_return ( invoke "if_bit32" ( i32.const 0x100000) ( i32.const 20)) ( i32.const
      // 100))
      runner.assertReturn(
          "if_bit32",
          new WasmValue[] {WasmValue.i32(100)},
      ...
      // ( assert_return ( invoke "if_bit32" ( i32.const 0x100000) ( i32.const 52)) ( i32.const
      // 100))
      runner.assertReturn(
          "if_bit32",
          new WasmValue[] {WasmValue.i32(100)},
      ...
      runner.assertReturn(
          "if_bit64", new WasmValue[] {WasmValue.i64(200L)}, WasmValue.i64(0L), WasmValue.i64(1L));

      // ( assert_return ( invoke "if_bit64" ( i64.const 0) ( i64.const 0)) ( i64.const 200))
      runner.assertReturn(
          "if_bit64", new WasmValue[] {WasmValue.i64(200L)}, WasmValue.i64(0L), WasmValue.i64(0L));

      // ( assert_return ( invoke "if_bit64" ( i64.const 1) ( i64.const 1)) ( i64.const 200))
      runner.assertReturn(
          "if_bit64", new WasmValue[] {WasmValue.i64(200L)}, WasmValue.i64(1L), WasmValue.i64(1L));

      // ( assert_return ( invoke "if_bit64" ( i64.const 1) ( i64.const 33)) ( i64.const 200))
      runner.assertReturn(
          "if_bit64", new WasmValue[] {WasmValue.i64(200L)}, WasmValue.i64(1L), WasmValue.i64(33L));

      // ( assert_return ( invoke "if_bit64" ( i64.const 1) ( i64.const 0)) ( i64.const 100))
      runner.assertReturn(
          "if_bit64", new WasmValue[] {WasmValue.i64(100L)}, WasmValue.i64(1L), WasmValue.i64(0L));

      // ( assert_return ( invoke "if_bit64" ( i64.const 1) ( i64.const 64)) ( i64.const 100))
      runner.assertReturn(
          "if_bit64", new WasmValue[] {WasmValue.i64(100L)}, WasmValue.i64(1L), WasmValue.i64(64L));

      // ( assert_return ( invoke "if_bit64" ( i64.const 0x100000) ( i64.const 20)) ( i64.const
      // 100))
      runner.assertReturn(
          "if_bit64",
          new WasmValue[] {WasmValue.i64(100L)},
          WasmValue.i64(0x100000L),
          WasmValue.i64(20L));

      // ( assert_return ( invoke "if_bit64" ( i64.const 0x100000) ( i64.const 52)) ( i64.const
      // 200))
      runner.assertReturn(
          "if_bit64",
          new WasmValue[] {WasmValue.i64(200L)},
      ...
      // ( assert_return ( invoke "if_bit64" ( i64.const 0x100000) ( i64.const 84)) ( i64.const
      // 100))
      runner.assertReturn(
          "if_bit64",
          new WasmValue[] {WasmValue.i64(100L)},
