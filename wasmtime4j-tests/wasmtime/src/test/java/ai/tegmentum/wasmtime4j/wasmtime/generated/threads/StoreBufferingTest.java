...
/**
 * Store Buffering (SB) memory model test.
 *
 * <p>Tests the Store Buffering litmus test where two threads each store to a location and then load
 * from the other location. With non-atomic operations, any outcome is allowed.
 *
 * <p>Source:
 * https://github.com/bytecodealliance/wasmtime/blob/main/tests/misc_testsuite/threads/SB.wast
 */
public final class StoreBufferingTest extends DualRuntimeTest {

  private static final String SHARED_MEMORY_MODULE =
      "(module (memory (export \"shared\") 1 1 shared))";

  /** Thread 1: stores 1 to offset 0, loads from offset 4, saves result at offset 24. */
  ...
  /** Thread 2: stores 1 to offset 4, loads from offset 0, saves result at offset 32. */
   ...
   *
   * <p>Allowed: (L_0=0 || L_0=1) && (L_1=0 || L_1=1)
   */
  ...
  @DisplayName("Store Buffering - non-atomic")
  public void testStoreBuffering(final RuntimeType runtime) throws Exception {
    setRuntime(runtime);
