  ...
  public void testSinkFloatButDontTrap(final RuntimeType runtime) throws Exception {
    ...
    try (final WastTestRunner runner = new WastTestRunner()) {
      ...
      final String moduleWat1 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/wasmtime/generated/wasmtime/SinkFloatButDontTrapTest_module1.wat");
      runner.compileAndInstantiate(moduleWat1);

      // ( assert_return ( invoke "select-with-sink" ( i32.const 0xfff8)) ( f64.const 0))
      runner.assertReturn(
          "select-with-sink", new WasmValue[] {WasmValue.f64(0.0)}, WasmValue.i32(0xfff8));
      ...
      runner.assertReturn(
          ...
          new WasmValue[] {WasmValue.f64(1.0)},
