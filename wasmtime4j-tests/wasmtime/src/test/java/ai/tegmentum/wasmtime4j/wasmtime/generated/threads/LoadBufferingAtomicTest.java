...
/**
 * Load Buffering (LB) memory model test with atomic operations.
 *
 * <p>Tests the Load Buffering litmus test using atomic loads and stores. With atomic operations,
 * the outcome (L_0=1, L_1=1) is forbidden due to sequential consistency.
 *
 * <p>Allowed results: (L_0=0 && L_1=0) || (L_0=0 && L_1=1) || (L_0=1 && L_1=0)
 *
 * <p>Source:
 * https://github.com/bytecodealliance/wasmtime/blob/main/tests/misc_testsuite/threads/LB_atomic.wast
 */
public final class LoadBufferingAtomicTest extends DualRuntimeTest {

  private static final String SHARED_MEMORY_MODULE =
      "(module (memory (export \"shared\") 1 1 shared))";

  /** Thread 1: atomic load from offset 4, atomic store 1 to offset 0. */
  ...
  /** Thread 2: atomic load from offset 0, atomic store 1 to offset 4. */
  ...
  /**
   * Check module: verifies allowed results. With atomics, (L_0=1 && L_1=1) is forbidden.
   *
   * <p>Allowed: (L_0=0 && L_1=0) || (L_0=0 && L_1=1) || (L_0=1 && L_1=0)
   */
  ...
  @DisplayName("Load Buffering - atomic")
  public void testLoadBufferingAtomic(final RuntimeType runtime) throws Exception {
    setRuntime(runtime);
