 ...
 *
 * <p>This test suite validates the implementation of WebAssembly 3.0 GC features including advanced
 * reference type operations, complex struct and array compositions, incremental and concurrent
 * garbage collection, debugging tools, and safety validation.
 *
 * @since 1.0.0
 */
...
class AdvancedGcEdgeCasesTest {
  ...
  class ReferenceTypeOperationsTest {
    ...
    void testSafeReferenceTypeDowncasting() {
      ...
      StructInstance person =
          gcRuntime.createStruct(personType, List.of(GcValue.i32(25), GcValue.i32(10)));
    ...
    void testNullableReferenceCasts() {
      ...
      Optional<GcObject> nonNullResult =
          gcRuntime.refCastNullable(i31Value, GcReferenceType.I31_REF);
    ...
    void testInvalidCastDetection() {
      ...
      StructType personType =
          StructType.builder().name("Person").field("age", FieldType.i32(), true).build();
  ...
  class ComplexStructArrayTest {
    ...
    void testPackedStructsWithCustomAlignment() {
      ...
      StructInstance packedStruct =
          gcRuntime.createPackedStruct(
              packedType,
    ...
    void testVariableLengthArrays() {
      ArrayType flexArrayType =
          ArrayType.builder().name("FlexArray").elementType(FieldType.i32()).mutable(true).build();

      List<GcValue> flexibleElements =
          List.of(GcValue.i32(100), GcValue.i32(200), GcValue.i32(300));

      ArrayInstance flexArray =
          gcRuntime.createVariableLengthArray(flexArrayType, 5, flexibleElements);
    ...
    void testNestedArraysAndComplexCompositions() {
      ...
      StructInstance point1 =
          gcRuntime.createStruct(pointType, List.of(GcValue.i32(10), GcValue.i32(20)));
      StructInstance point2 =
          gcRuntime.createStruct(pointType, List.of(GcValue.i32(30), GcValue.i32(40)));

      // Create array type that holds struct references
      ArrayType pointArrayType =
          ArrayType.builder()
              .name("PointArray")
      ...
      ArrayInstance nestedArray =
          gcRuntime.createNestedArray(pointArrayType, List.of(point1, point2));
    ...
    void testArrayOperations() {
      ArrayType intArrayType =
          ArrayType.builder().name("IntArray").elementType(FieldType.i32()).mutable(true).build();
  ...
  class AdvancedGcOperationsTest {
    ...
    void testConfigurableGcStrategies() {
      Map<String, Object> generationalParams =
          Map.of(
      ...
      Map<String, Object> concurrentParams =
          Map.of(
    ...
    void testGcPressureMonitoring() {
      ...
      for (int i = 0; i < 1000; i++) {
        ArrayInstance array =
            gcRuntime.createArray(
                ArrayType.builder().elementType(FieldType.i32()).mutable(true).build(), 100);
  ...
  class AdvancedMemoryManagementTest {
    ...
    void testWeakReferencesWithFinalization() {
      ...
      WeakGcReference weakReference =
          gcRuntime.createWeakReference(strongRef, () -> finalized.set(true));
    ...
    void testFinalizationCallbacks() {
      ...
      gcRuntime.registerFinalizationCallback(
          object,
          () -> {
  ...
  class DebuggingProfilingTest {
    ...
    void testHeapInspection() {
      ...
      StructType structType =
          StructType.builder().name("TestStruct").field("value", FieldType.i32(), true).build();
    ...
    void testObjectLifecycleTracking() {
      ...
      Map<Long, ObjectLifecycleTracker.AccessStatistics> accessStats =
          tracker.getAccessStatistics();
  ...
  class SafetyValidationTest {
    ...
    void testReferenceSafetyValidation() {
      ...
      StructInstance node1 =
          gcRuntime.createStruct(nodeType, List.of(GcValue.i32(1), GcValue.nullValue()));
      StructInstance node2 =
          gcRuntime.createStruct(nodeType, List.of(GcValue.i32(2), GcValue.nullValue()));
    ...
    void testTypeSafetyEnforcement() {
      boolean isTypeSafe =
          gcRuntime.enforceTypeSafety(
              "struct_field_access", List.of("field_index", 0, "expected_type", "i32"));
    ...
    void testGcInvariantValidation() {
      ...
      assertTrue(
          validation.getSatisfactionScore() >= 0.0 && validation.getSatisfactionScore() <= 1.0);
