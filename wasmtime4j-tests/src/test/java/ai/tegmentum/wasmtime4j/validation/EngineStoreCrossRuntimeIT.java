...
final class EngineStoreCrossRuntimeIT extends BaseIntegrationTest {
  ...
  final class EngineCreationValidationTests {
    ...
    void shouldProduceIdenticalDefaultEngineCreationResults() {
      ...
      assertThat(result.isValid())
          .as("Cross-runtime concurrent workflow validation failed")
          .isTrue();
      assertThat(result.areResultsIdentical())
  ...
  // Helper classes for structured validation results
    ...
    public String toString() {
      return String.format(
          "EngineValidationResult[valid=%s, debugInfo=%s, consumeFuel=%s, "
  ...
  private static final class WorkflowValidationResult {
    ...
    public static WorkflowValidationResult of(
        final boolean moduleValid,
        final long fuel1,
        final long fuel2,
        final Object data1,
    ...
    public String toString() {
      return String.format(
          "WorkflowValidationResult[moduleValid=%s, fuel1=%d, fuel2=%d, data1=%s, data2=%s]",
