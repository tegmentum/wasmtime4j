 ...
 * <ul>
 *   <li>Environment variable access and management</li>
 *   <li>File system operations with proper isolation</li>
 *   <li>Clock and time operations</li>
 *   <li>Random number generation</li>
 *   <li>Process exit handling</li>
 *   <li>Memory operations</li>
 *   <li>System call integration across both JNI and Panama runtimes</li>
 * </ul>
 *
 * <p>All tests are designed to work with both JNI and Panama implementations to ensure
...
public class WasiIntegrationIT {
            ...
            threads[i] = new Thread(() -> {
                try {
                    for (int j = 0; j < operationsPerThread; j++) {
                        ...
                        assertNotNull(wasiContext.getRuntimeInfo(), "Runtime info should be accessible");
    ...
    void testPanamaSpecificFeatures() throws WasmException {
        ...
        try (WasiContext panamaContext = WasiFactory.createContext(WasiRuntimeType.PANAMA)) {
            ...
            assertTrue(runtimeInfo.getVersion().contains("panama"), "Version should indicate Panama runtime");
    ...
    void testPerformance() throws WasmException {
        ...
        LOGGER.info("Performance test results: " + iterations + " iterations in " + totalTimeMs + "ms (avg: " + avgTimeMs + "ms per iteration)");
