...
public class JniExceptionHandlerImplTest {
  ...
  private static final Logger LOGGER =
      Logger.getLogger(JniExceptionHandlerImplTest.class.getName());
  ...
  public void testCreateCustomHandler() {
    ...
    try (JniExceptionHandlerImpl handler =
        JniExceptionHandlerImpl.create(config, "CustomHandler")) {
      assertNotNull(handler, "Handler should not be null");
  ...
  public void testPerformUnwindingMaxDepth() {
    ...
    try (JniExceptionHandlerImpl handler = JniExceptionHandlerImpl.create(config)) {
  ...
  public void testCloseHandler() {
    ...
    final JniExceptionHandlerImpl handler = JniExceptionHandlerImpl.create();
  ...
  public void testRejectNullConfig() {
    ...
    assertThrows(
        ...
        () -> JniExceptionHandlerImpl.create(null),
  ...
  public void testRejectNullHandlerName() {
    ...
    assertThrows(
        NullPointerException.class,
        () -> JniExceptionHandlerImpl.create(DefaultExceptionHandlingConfig.getDefault(), null),
