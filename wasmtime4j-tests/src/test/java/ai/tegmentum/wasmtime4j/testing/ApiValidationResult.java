 ...
 *
 * <p>This class provides comprehensive validation results for individual API methods
 * including functional correctness, performance metrics, and compliance information.
 */
public final class ApiValidationResult {
    ...
    public static final class Builder {
        ...
        private List<String> validationErrors = java.util.ArrayList<>();
