 ...
 *
 * <p>This class captures comprehensive failure information including the test name,
 * error message, exception details, and execution context for debugging.
 */
public final class TestFailure {
    ...
    public String toString() {
        return String.format("TestFailure{testName='%s', errorMessage='%s', executionTime=%s}",
