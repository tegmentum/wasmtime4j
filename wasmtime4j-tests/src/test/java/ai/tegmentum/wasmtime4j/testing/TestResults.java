 ...
 *
 * <p>This interface aggregates test execution information including pass/fail counts, execution
 * times, and detailed failure information for analysis and reporting.
 */
public interface TestResults {
  ...
  default String getSummary() {
    return String.format(
        ...
        getTotalTests(), getPassedTests(), getFailedTests(), getSkippedTests(), getSuccessRate());
  }
