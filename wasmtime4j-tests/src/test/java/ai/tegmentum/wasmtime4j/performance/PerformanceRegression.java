...
public final class PerformanceRegression {
    ...
    public PerformanceRegression(final RuntimeType runtimeType, final Duration baselineDuration,
                               final Duration currentDuration, final long regressionMs, 
    ...
    public Duration getBaselineDuration() { return baselineDuration; }
    public Duration getCurrentDuration() { return currentDuration; }
    public long getRegressionMs() { return regressionMs; }
    public double getRegressionPercent() { return regressionPercent; }
    
    @Override
    public String toString() {
        return "PerformanceRegression{runtimeType=" + runtimeType + 
               ", regressionPercent=" + String.format("%.1f%%", regressionPercent) +
               ", regressionMs=" + regressionMs + "ms}";
    }
}