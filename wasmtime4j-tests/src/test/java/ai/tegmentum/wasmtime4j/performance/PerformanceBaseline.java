...
public final class PerformanceBaseline {
    ...
    public PerformanceBaseline(final String testName,
        ...
        this.baselineDuration = Objects.requireNonNull(baselineDuration, "baselineDuration cannot be null");
    ...
    public String toString() {
        return "PerformanceBaseline{" +
               ...
               ", baselineDuration=" + baselineDuration.toMillis() + "ms" +
