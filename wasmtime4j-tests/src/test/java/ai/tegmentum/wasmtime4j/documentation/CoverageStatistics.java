 ...
 *
 * <p>Provides comprehensive metrics about the state of documentation across the wasmtime4j API
 * surface.
 *
 * @since 1.0.0
 */
public final class CoverageStatistics {
  ...
  public CoverageStatistics(
    ...
    this.coverageByModule =
        Map.copyOf(Objects.requireNonNull(coverageByModule, "coverageByModule"));
    this.coverageByPackage =
        Map.copyOf(Objects.requireNonNull(coverageByPackage, "coverageByPackage"));
    this.qualityDistribution =
        Map.copyOf(Objects.requireNonNull(qualityDistribution, "qualityDistribution"));
  ...
  public String toString() {
    return "CoverageStatistics{"
        ...
        + documentedEndpoints
        + ", coveragePercentage="
        + String.format("%.2f%%", overallCoveragePercentage)
        + ", totalMethods="
        + totalMethods
        + ", totalClasses="
        + totalClasses
