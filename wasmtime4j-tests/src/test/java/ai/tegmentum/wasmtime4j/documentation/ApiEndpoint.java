 ...
 *
 * <p>An API endpoint encompasses methods, constructors, and fields that form
 * the public interface of the wasmtime4j library.
 *
 * @since 1.0.0
 */
public final class ApiEndpoint {
     ...
     */
    public ApiEndpoint(final String fullyQualifiedName,
        ...
        this.missingDocumentation = List.copyOf(Objects.requireNonNull(missingDocumentation, "missingDocumentation"));
    }
