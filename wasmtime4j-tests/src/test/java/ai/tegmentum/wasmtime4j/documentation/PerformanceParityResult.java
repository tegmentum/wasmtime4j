 ...
 *
 * <p>Contains detailed performance metrics and comparison results to assess
 * whether both implementations meet performance requirements.
 *
 * @since 1.0.0
 */
public final class PerformanceParityResult {
     ...
     */
    public PerformanceParityResult(final Map<String, PerformanceMetric> jniMetrics,
        ...
        this.performanceDifferences = Map.copyOf(Objects.requireNonNull(performanceDifferences, "performanceDifferences"));
    ...
    public double getMaximumDifference() {
        return performanceDifferences.values().stream()
    ...
    public String toString() {
        return "PerformanceParityResult{"
                ...
                + ", maxDifference=" + String.format("%.2f%%", getMaximumDifference())
                + ", threshold=" + String.format("%.2f%%", toleranceThreshold)
                + ", metrics=" + jniMetrics.size()
                + '}';
    }
    ...
    public static final class PerformanceMetric {
         ...
         */
        public PerformanceMetric(final String name,
                                 final double value,
                                 final String unit,
