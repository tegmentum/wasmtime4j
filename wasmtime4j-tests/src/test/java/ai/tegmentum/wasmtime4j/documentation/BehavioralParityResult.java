 ...
 *
 * <p>Contains detailed information about behavioral consistency between
 * JNI and Panama implementations for a single method.
 *
 * @since 1.0.0
 */
public final class BehavioralParityResult {
     ...
     */
    public BehavioralParityResult(final String methodSignature,
    ...
    public String toString() {
        return "BehavioralParityResult{"
                ...
                + ", parityAchieved=" + isParityAchieved
                + ", testCases=" + getTotalTestCases()
                + ", successful=" + getSuccessfulTestCases()
    ...
    public static final class TestCase {
         ...
         */
        public TestCase(final String description,
                        final String input,
