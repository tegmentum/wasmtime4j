 ...
 *
 * <p>Violations indicate areas where the two implementations differ in ways that may affect
...
public final class ParityViolation {
  ...
  public ParityViolation(
    ...
    this.panamaImplementation =
        Objects.requireNonNull(panamaImplementation, "panamaImplementation");
