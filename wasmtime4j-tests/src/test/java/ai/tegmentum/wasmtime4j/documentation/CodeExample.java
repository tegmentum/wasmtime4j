 ...
 *
 * <p>Code examples demonstrate proper usage of API features and are validated to ensure they
...
public final class CodeExample {
  ...
  public CodeExample(
    ...
    this.requiredDependencies =
        List.copyOf(Objects.requireNonNull(requiredDependencies, "requiredDependencies"));
    ...
    this.supportedPlatforms =
        List.copyOf(Objects.requireNonNull(supportedPlatforms, "supportedPlatforms"));
  }
   ...
   *
   * <ul>
   *   <li>Compilation is successful
   *   <li>Execution is successful
   *   <li>Actual output matches expected output
   * </ul>
   *
