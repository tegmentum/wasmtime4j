...
public final class CrossRuntimeExecutionSummary {
    ...
    public String createReport() {
        ...
        sb.append("Consistency Rate: ").append(String.format("%.1f%%", getConsistencyRate())).append('\n');
        sb.append('\n');
        ...
        for (final RuntimeType runtimeType : RuntimeType.values()) {
            if (successCounts.containsKey(runtimeType)) {
                ...
                sb.append("  Success Rate: ").append(String.format("%.1f%%", getSuccessRate(runtimeType))).append('\n');
                sb.append("  Total Duration: ").append(getTotalDuration(runtimeType).toMillis()).append("ms\n");
                sb.append('\n');
            }
        }
    ...
    public String toString() {
        return "CrossRuntimeExecutionSummary{" +
               ...
               ", consistencyRate=" + String.format("%.1f%%", getConsistencyRate()) +
               '}';
    }
    ...
    public static final class Builder {
        ...
        public Builder addTestResult(final CrossRuntimeTestResult result) {
            ...
            if (result.hasPanamaResult()) {
                ...
                } else if (result.getJniResult().isSuccessful() == result.getPanamaResult().isSuccessful()) {
        ...
        private void processRuntimeResult(final RuntimeType runtimeType, final RuntimeTestExecution execution) {
