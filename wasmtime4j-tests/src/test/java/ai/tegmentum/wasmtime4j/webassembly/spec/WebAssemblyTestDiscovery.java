...
/**
 * Automated WebAssembly test discovery for comprehensive test suite execution. Discovers and
 * categorizes WebAssembly test cases from various sources.
 *
 * <p>This class provides comprehensive test discovery functionality for:
 *
 * <ul>
 *   <li>Official WebAssembly specification tests
 *   <li>Conformance validation tests
 *   <li>Edge case and corner case tests
 *   <li>Cross-implementation compatibility tests
 * </ul>
 *
 * @since 1.0.0
 */
public final class WebAssemblyTestDiscovery {
  ...
  private static final Pattern SPEC_TEST_PATTERN = Pattern.compile(".*/spec/.*|.*/testsuite/.*");
  ...
  public List<WebAssemblyTestCase> discoverSpecificationTests() throws IOException {
    ...
    final TestDiscoveryVisitor visitor =
        new TestDiscoveryVisitor(TestType.SPECIFICATION, SPEC_TEST_PATTERN);
  ...
  public List<WebAssemblyTestCase> discoverConformanceTests() throws IOException {
    ...
    final List<WebAssemblyTestCase> tests = new ArrayList<>();
    final TestDiscoveryVisitor visitor =
        new TestDiscoveryVisitor(TestType.CONFORMANCE, CONFORMANCE_TEST_PATTERN);
  ...
  public List<WebAssemblyTestCase> discoverEdgeCaseTests() throws IOException {
    ...
    final List<WebAssemblyTestCase> tests = new ArrayList<>();
    final TestDiscoveryVisitor visitor =
        new TestDiscoveryVisitor(TestType.EDGE_CASE, EDGE_CASE_PATTERN);
  ...
  public List<WebAssemblyTestCase> discoverCrossImplementationTests() throws IOException {
    ...
    final List<WebAssemblyTestCase> tests = new ArrayList<>();
    final TestDiscoveryVisitor visitor =
        new TestDiscoveryVisitor(TestType.CROSS_IMPLEMENTATION, CROSS_IMPL_PATTERN);
