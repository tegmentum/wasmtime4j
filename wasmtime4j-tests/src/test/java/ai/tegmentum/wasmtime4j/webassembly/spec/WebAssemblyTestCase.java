...
/**
 * Represents a WebAssembly test case with comprehensive metadata and expectations.
 * Encapsulates all information needed to execute and validate a WebAssembly test.
 *
 * <p>This class provides comprehensive test case information including:
 * <ul>
 *   <li>Test identification and categorization</li>
 *   <li>WebAssembly module location and metadata</li>
 *   <li>Expected behavior and validation criteria</li>
 *   <li>Test execution parameters and configuration</li>
 * </ul>
 *
 * @since 1.0.0
 */
public final class WebAssemblyTestCase {
    ...
    private WebAssemblyTestCase(final Builder builder) {
        ...
        this.expectedBehavior = builder.expectedBehavior != null ?
            builder.expectedBehavior : ExpectedBehavior.defaultBehavior();
        this.expectedResults = Collections.unmodifiableList(
            builder.expectedResults != null ? builder.expectedResults : Collections.emptyList());
        this.metadata = builder.metadata != null ?
            builder.metadata : TestMetadata.empty();
    ...
    public static final class Builder {
        ...
        public Builder expectedResults(final List<ExpectedResult> expectedResults) {
            this.expectedResults = expectedResults != null ?
                List.copyOf(expectedResults) : null;
            return this;
        }
