...
public final class WasmTestCase {
     ...
     */
    public WasmTestCase(final String testName,
        ...
        this.expectedResults = Objects.requireNonNull(expectedResults, "expectedResults cannot be null");
    ...
    /**
     * Checks if this is a negative test case (expected to fail).
     * Determines this based on test name conventions and metadata.
     *
    ...
    public String toString() {
        return "WasmTestCase{" +
               ...
               ", hasExpectedResults=" + hasExpectedResults() +
