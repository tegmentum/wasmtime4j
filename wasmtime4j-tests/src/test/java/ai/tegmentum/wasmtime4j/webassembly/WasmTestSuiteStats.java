...
public final class WasmTestSuiteStats {
   ...
   */
  public void addSuiteStats(
      final WasmTestSuiteLoader.TestSuiteType suiteType, final int testCount) {
  ...
  public int getTotalTestCount() {
    return testCounts.values().stream().mapToInt(Integer::intValue).sum();
  }
  ...
  public String toString() {
    ...
    for (final Map.Entry<WasmTestSuiteLoader.TestSuiteType, Integer> entry :
        testCounts.entrySet()) {
      sb.append("  ")
