...
public final class RuntimeTestExecution {
    ...
    private RuntimeTestExecution(final RuntimeType runtimeType,
     ...
     */
    public static RuntimeTestExecution successful(final RuntimeType runtimeType,
                                                 final Object result,
                                                 final Duration duration) {
     ...
     * @return the execution result
     */
    public static RuntimeTestExecution failed(final RuntimeType runtimeType,
                                             final Exception exception,
                                             final Duration duration) {
     ...
     * @return the execution result
     */
    public static RuntimeTestExecution skipped(final RuntimeType runtimeType,
                                              final String skipReason) {
        return new RuntimeTestExecution(runtimeType, false, null, null, Duration.ZERO, true, skipReason);
    }
