...
/**
 * Integration tests for PanamaSimdOperations.
 *
 * <p>This class tests the pure Java SIMD implementation without requiring
 * native library calls.</p>
 */
@DisplayName("Panama SIMD Operations Integration Tests")
public class PanamaSimdOperationsIntegrationTest {

    private static final Logger LOGGER =
            Logger.getLogger(PanamaSimdOperationsIntegrationTest.class.getName());

    private PanamaSimdOperations simdOps;

    @BeforeEach
    void setUp() {
        simdOps = new PanamaSimdOperations();
        LOGGER.info("Created PanamaSimdOperations instance");
    }
    ...
    class BitwiseTests {
        ...
        void shouldPerformAndOperationCorrectly() throws Exception {
            ...
            assertNotNull(result, "Result should not be null");
            for (int i = 0; i < 16; i++) {
                assertEquals((byte) 0x0F, result.getDataInternal()[i],
                        "Byte " + i + " should be 0x0F");
            }
        ...
        void shouldPerformOrOperationCorrectly() throws Exception {
            ...
            assertNotNull(result, "Result should not be null");
            for (int i = 0; i < 16; i++) {
                assertEquals((byte) 0xFF, result.getDataInternal()[i],
        ...
        void shouldPerformXorOperationCorrectly() throws Exception {
            ...
            assertNotNull(result, "Result should not be null");
            for (int i = 0; i < 16; i++) {
                assertEquals((byte) 0x00, result.getDataInternal()[i],
                        "Byte " + i + " should be 0x00");
            }
    ...
    class MathOperationsTests {
        ...
        void shouldComputeFmaCorrectlyForF32x4() throws Exception {
            ...
            final ByteBuffer resBuf =
                    ByteBuffer.wrap(result.getDataInternal()).order(ByteOrder.LITTLE_ENDIAN);
            for (int i = 0; i < 4; i++) {
                assertEquals(7.0f, resBuf.getFloat(i * 4), 0.001f,
                        "2*3+1 should be 7 at lane " + i);
            }
    ...
    class CapabilityTests {
        ...
        void shouldReturnDetailedCapabilitiesString() {
            ...
            assertTrue(capabilities.contains("Arithmetic"),
                    "Should mention arithmetic operations");
            assertTrue(capabilities.contains("Bitwise"),
                    "Should mention bitwise operations");
    ...
    class ErrorHandlingTests {
        ...
        void shouldThrowOnNullVectorInAdd() {
            ...
            assertThrows(NullPointerException.class, () -> simdOps.add(null, a),
                    "Should throw on null first vector");
            assertThrows(NullPointerException.class, () -> simdOps.add(a, null),
        ...
        void shouldThrowOnLaneTypeMismatch() {
            ...
            assertThrows(IllegalArgumentException.class, () -> simdOps.add(i32Vector, f32Vector),
