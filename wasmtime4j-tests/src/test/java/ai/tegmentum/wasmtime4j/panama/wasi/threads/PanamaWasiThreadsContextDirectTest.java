 ...
 * instances that would invoke native calls.</p>
 */
...
public class PanamaWasiThreadsContextDirectTest {
    ...
    class StructureTests {
        ...
        void shouldImplementWasiThreadsContextInterface() {
            ...
            assertTrue(WasiThreadsContext.class.isAssignableFrom(PanamaWasiThreadsContext.class),
        ...
        void shouldHavePackagePrivateConstructor() throws Exception {
            ...
            final Constructor<?>[] constructors = PanamaWasiThreadsContext.class
    ...
    class InterfaceMethodTests {
            ...
            for (final Method method : PanamaWasiThreadsContext.class.getMethods()) {
                if (method.getName().equals("spawn")) {
                    ...
                    assertEquals(int.class, method.getReturnType(),
                            "spawn should return int thread ID");
        ...
        void shouldHaveGetThreadCountMethod() {
            ...
            for (final Method method : PanamaWasiThreadsContext.class.getMethods()) {
                if (method.getName().equals("getThreadCount")
                    ...
                    found = true;
                    assertEquals(int.class, method.getReturnType(),
                            "getThreadCount should return int");
        ...
        void shouldHaveGetMaxThreadIdMethod() {
            ...
            boolean found = false;
            for (final Method method : PanamaWasiThreadsContext.class.getMethods()) {
                if (method.getName().equals("getMaxThreadId")
                        && method.getParameterCount() == 0) {
                    found = true;
                    assertEquals(int.class, method.getReturnType(),
                            "getMaxThreadId should return int");
    ...
    class PanamaSpecificMethodTests {
        ...
        void shouldHaveGetNativeContextMethod() {
            ...
            boolean found = false;
            for (final Method method : PanamaWasiThreadsContext.class.getMethods()) {
                if (method.getName().equals("getNativeContext")
                        && method.getParameterCount() == 0) {
                    found = true;
                    assertEquals(MemorySegment.class, method.getReturnType(),
        ...
        void shouldHaveOnThreadCompletedMethod() throws Exception {
            ...
            final Method method = PanamaWasiThreadsContext.class
                    .getDeclaredMethod("onThreadCompleted", int.class);
            assertNotNull(method, "Should have onThreadCompleted method");
            assertEquals(void.class, method.getReturnType(),
                    "onThreadCompleted should return void");
    ...
    class FieldTests {
        ...
        void shouldHaveNativeContextField() throws Exception {
            ...
            final Field field = PanamaWasiThreadsContext.class
                    .getDeclaredField("nativeContext");
            assertNotNull(field, "Should have nativeContext field");
            assertEquals(MemorySegment.class, field.getType(),
                    "nativeContext should be MemorySegment");
        ...
        void shouldHaveThreadTrackingFields() throws Exception {
            ...
            final Field maxThreadId = PanamaWasiThreadsContext.class
                    .getDeclaredField("maxThreadId");
            assertNotNull(maxThreadId, "Should have maxThreadId field");

            final Field threadCount = PanamaWasiThreadsContext.class
                    .getDeclaredField("threadCount");
