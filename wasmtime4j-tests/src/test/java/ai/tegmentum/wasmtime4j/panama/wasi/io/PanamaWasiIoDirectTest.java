...
public class PanamaWasiIoDirectTest {
    ...
    class InputStreamTests {
        ...
        void shouldImplementAutoCloseable() {
            ...
            assertTrue(AutoCloseable.class.isAssignableFrom(PanamaWasiInputStream.class),
    ...
    class OutputStreamTests {
        ...
        void shouldImplementAutoCloseable() {
            ...
            assertTrue(AutoCloseable.class.isAssignableFrom(PanamaWasiOutputStream.class),
                    "Should implement AutoCloseable");
        }
    }
    ...
    class PollableTests {
        ...
        void shouldImplementAutoCloseable() {
            ...
            assertTrue(AutoCloseable.class.isAssignableFrom(PanamaWasiPollable.class),
                    "Should implement AutoCloseable");
        }
    }
    ...
    class IntegrationTests {
        ...
        void shouldVerifyConsistentTypePatternsAcrossIoClasses() {
            ...
            assertTrue(java.lang.reflect.Modifier.isFinal(PanamaWasiInputStream.class.getModifiers()),
                    "InputStream should be final");
            assertTrue(java.lang.reflect.Modifier.isFinal(PanamaWasiOutputStream.class.getModifiers()),
                    "OutputStream should be final");
            assertTrue(java.lang.reflect.Modifier.isFinal(PanamaWasiPollable.class.getModifiers()),
        ...
        void shouldVerifyAllIoClassesHaveCloseHandle() throws Exception {
            ...
            final Class<?>[] classes = {
                PanamaWasiInputStream.class,
                PanamaWasiOutputStream.class,
                PanamaWasiPollable.class
            };
            ...
            for (final Class<?> clazz : classes) {
                ...
                assertTrue(java.lang.reflect.Modifier.isStatic(closeHandle.getModifiers()),
