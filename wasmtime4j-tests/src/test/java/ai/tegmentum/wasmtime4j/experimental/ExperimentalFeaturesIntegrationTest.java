 ...
 *
 * <p>These tests validate the implementation of cutting-edge WebAssembly proposals
 * including stack switching, call/cc, extended constant expressions, and other
 * committee-stage features.
 *
 * <p><strong>WARNING:</strong> These tests are for experimental features that
 * may not be fully supported by the underlying Wasmtime runtime.
 */
@DisplayName("Experimental WebAssembly Features Integration Tests")
class ExperimentalFeaturesIntegrationTest {

    private static final Logger logger = Logger.getLogger(ExperimentalFeaturesIntegrationTest.class.getName());
    ...
    class WasmFeatureEnumTests {
        ...
        void testExperimentalFeaturesInEnum() {
            ...
            assertTrue(allFeatures.contains(WasmFeature.STACK_SWITCHING),
                    "WasmFeature should include STACK_SWITCHING");
            assertTrue(allFeatures.contains(WasmFeature.CALL_CC),
                    "WasmFeature should include CALL_CC");
            assertTrue(allFeatures.contains(WasmFeature.EXTENDED_CONST_EXPRESSIONS),
                    "WasmFeature should include EXTENDED_CONST_EXPRESSIONS");
            assertTrue(allFeatures.contains(WasmFeature.MEMORY64_EXTENDED),
                    "WasmFeature should include MEMORY64_EXTENDED");
            assertTrue(allFeatures.contains(WasmFeature.CUSTOM_PAGE_SIZES),
                    "WasmFeature should include CUSTOM_PAGE_SIZES");
            assertTrue(allFeatures.contains(WasmFeature.SHARED_EVERYTHING_THREADS),
                    "WasmFeature should include SHARED_EVERYTHING_THREADS");
            assertTrue(allFeatures.contains(WasmFeature.TYPE_IMPORTS),
                    "WasmFeature should include TYPE_IMPORTS");
            assertTrue(allFeatures.contains(WasmFeature.STRING_IMPORTS),
                    "WasmFeature should include STRING_IMPORTS");
            assertTrue(allFeatures.contains(WasmFeature.RESOURCE_TYPES),
                    "WasmFeature should include RESOURCE_TYPES");
            assertTrue(allFeatures.contains(WasmFeature.INTERFACE_TYPES),
                    "WasmFeature should include INTERFACE_TYPES");
            assertTrue(allFeatures.contains(WasmFeature.FLEXIBLE_VECTORS),
    ...
    class EngineConfigIntegrationTests {
        ...
        void testEngineConfigExperimentalFeatures() {
            ...
            assertTrue(features.contains(WasmFeature.STACK_SWITCHING),
                    "EngineConfig should contain STACK_SWITCHING feature");
            assertTrue(features.contains(WasmFeature.CALL_CC),
                    "EngineConfig should contain CALL_CC feature");
            assertTrue(features.contains(WasmFeature.EXTENDED_CONST_EXPRESSIONS),
        ...
        void testExperimentalConfigurationFactories() {
            assertDoesNotThrow(() -> {
                ...
                assertNotNull(experimentalConfig, "forExperimentalFeatures() should return non-null config");
            ...
            assertDoesNotThrow(() -> {
                ...
                assertNotNull(threadingConfig, "forExperimentalThreading() should return non-null config");
            ...
            assertDoesNotThrow(() -> {
                ...
                assertNotNull(componentsConfig, "forExperimentalComponents() should return non-null config");

                final Set<WasmFeature> features = componentsConfig.getWasmFeatures();
                assertTrue(features.contains(WasmFeature.COMPONENT_MODEL),
        ...
        void testExperimentalFeatureGetters() {
            ...
            assertDoesNotThrow(() -> {
                ...
                assertTrue(extendedConst, "Extended const expressions should be enabled in experimental config");
    ...
    class JniExperimentalFeaturesTests {
        ...
        void testJniExperimentalFeaturesCreation() {
            assertDoesNotThrow(() -> {
                try (final JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                    assertTrue(config.isValid(), "JNI experimental features configuration should be valid");
        ...
        void testJniAllExperimentalConfiguration() {
            assertDoesNotThrow(() -> {
                try (final JniExperimentalFeatures config = JniExperimentalFeatures.allExperimentalEnabled()) {
        ...
        void testJniStackSwitchingConfiguration() {
            assertDoesNotThrow(() -> {
                try (final JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                    ...
                    assertTrue(config.isValid(), "Configuration should remain valid after enabling stack switching");
        ...
        void testJniCallCcConfiguration() {
            assertDoesNotThrow(() -> {
                try (final JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                    ...
                    assertTrue(config.isValid(), "Configuration should remain valid after enabling call/cc");
        ...
        void testJniExtendedConstExpressionsConfiguration() {
            assertDoesNotThrow(() -> {
                try (final JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                    ...
                    assertTrue(config.isValid(), "Configuration should remain valid after enabling extended const expressions");
                    logger.info("Enabled extended constant expressions in JNI configuration successfully");
                }
        ...
        void testJniExperimentalFeatureSupport() {
            ...
            final Set<WasmFeature> supportedFeatures = JniExperimentalFeatures.getSupportedExperimentalFeatures();
            ...
            assertTrue(supportedFeatures.isEmpty() || supportedFeatures.size() >= 0,
    ...
    class PanamaExperimentalFeaturesTests {
        ...
        void testPanamaExperimentalFeaturesCreation() {
            assertDoesNotThrow(() -> {
                try (final PanamaExperimentalFeatures config = new PanamaExperimentalFeatures()) {
                    assertTrue(config.isValid(), "Panama experimental features configuration should be valid");
        ...
        void testPanamaAllExperimentalConfiguration() {
            assertDoesNotThrow(() -> {
                try (final PanamaExperimentalFeatures config = PanamaExperimentalFeatures.allExperimentalEnabled()) {
        ...
        void testPanamaExtendedConstExpressionsConfiguration() {
            assertDoesNotThrow(() -> {
                try (final PanamaExperimentalFeatures config = new PanamaExperimentalFeatures()) {
                    ...
                    assertTrue(config.isValid(), "Configuration should remain valid after enabling extended const expressions");
                    logger.info("Enabled extended constant expressions in Panama configuration successfully");
                }
        ...
        void testPanamaExperimentalFeatureSupport() {
            // Test static methods for feature support
            final boolean stackSwitchingSupported = PanamaExperimentalFeatures.isStackSwitchingSupported();
            final boolean callCcSupported = PanamaExperimentalFeatures.isCallCcSupported();
            final Set<WasmFeature> supportedFeatures = PanamaExperimentalFeatures.getSupportedExperimentalFeatures();
    ...
    class CrossRuntimeCompatibilityTests {
        ...
        void testCrossRuntimeConsistency() {
            ...
            assertEquals(jniStackSwitching, panamaStackSwitching,
            ...
            assertEquals(jniCallCc, panamaCallCc,
                    "JNI and Panama should report same call/cc support");
        ...
        void testUnifiedApiExperimentalFeatures() {
            assertDoesNotThrow(() -> {
                ...
                assertNotNull(runtime, "Should be able to create runtime with experimental features config");

                logger.info("Successfully created runtime with experimental features using unified API");
        ...
        void testMultipleConfigurations() {
            assertDoesNotThrow(() -> {
                ...
                try (final JniExperimentalFeatures config1 = new JniExperimentalFeatures();
                     final JniExperimentalFeatures config2 = JniExperimentalFeatures.allExperimentalEnabled()) {
                ...
                try (final PanamaExperimentalFeatures config1 = new PanamaExperimentalFeatures();
                     final PanamaExperimentalFeatures config2 = PanamaExperimentalFeatures.allExperimentalEnabled()) {
                    ...
                    // Configure them differently
                    config1.enableStackSwitching(32 * 1024, 50);
                    config2.enableCallCc(500, PanamaExperimentalFeatures.ContinuationStorageStrategy.STACK);
