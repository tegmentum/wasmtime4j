 ...
 *
 * <p><b>WARNING:</b> This test suite exercises highly experimental features that may be
 * unstable or change significantly. Tests may fail on different platforms or runtime versions.
 *
 * @since 1.0.0
 */
...
class ExperimentalFeaturesTest {
    ...
    void testExperimentalConfigCreation() {
        ...
        assertNotNull(experimentalConfig.getEnabledFeatures(), "Enabled features map should not be null");
        assertTrue(experimentalConfig.getEnabledFeatures().isEmpty(), "No features should be enabled by default");
    ...
    void testIndividualFeatureConfiguration() {
        ...
        assertTrue(experimentalConfig.isFeatureEnabled(ExperimentalFeature.STACK_SWITCHING),
        ...
        assertEquals(StackSwitchingStrategy.COOPERATIVE, experimentalConfig.getStackSwitchingStrategy());
    ...
    void testCallCcConfiguration() {
        ...
        assertTrue(experimentalConfig.isFeatureEnabled(ExperimentalFeature.CALL_CC),
    ...
    void testAllFeaturesEnabledConfiguration() {
        ...
        assertTrue(allEnabled.getEnabledFeatures().size() > 5,
    ...
    void testProposalResearchConfiguration() {
        final ExperimentalFeatureConfig proposalConfig = ExperimentalFeatureConfig.forProposalResearch();
    ...
    void testFeatureKeyLookup() {
        ...
        assertEquals(ExperimentalFeature.STACK_SWITCHING,
                    ExperimentalFeature.findByKey("stack-switching"));
        assertEquals(ExperimentalFeature.CALL_CC,
                    ExperimentalFeature.findByKey("call-cc"));
        assertEquals(ExperimentalFeature.ADVANCED_JIT_OPTIMIZATIONS,
    ...
    void testConfigurationValidation() {
        ...
        assertThrows(IllegalArgumentException.class, () ->
            experimentalConfig.configureStackSwitching(2048, 100, StackSwitchingStrategy.COOPERATIVE),
            "Should reject stack size less than 4KB");

        assertThrows(IllegalArgumentException.class, () ->
            experimentalConfig.configureStackSwitching(1024 * 1024, 0, StackSwitchingStrategy.COOPERATIVE),
    ...
    void testRuntimeIntegration() {
        try {
            ...
            LOGGER.warning("Runtime integration failed (expected if features not implemented): " + e.getMessage());
    ...
    void testThreadSafety() throws InterruptedException {
        ...
        for (int i = 0; i < numThreads; i++) {
            ...
            threads[i] = new Thread(() -> {
                try {
                    final ExperimentalFeature feature = ExperimentalFeature.values()[threadId % ExperimentalFeature.values().length];
