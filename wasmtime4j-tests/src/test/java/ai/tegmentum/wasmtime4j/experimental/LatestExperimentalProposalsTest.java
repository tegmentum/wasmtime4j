 ...
 *
 * <p>This test suite validates the implementation of cutting-edge WebAssembly
 * proposals that are currently in committee stage, including:
 * <ul>
    ...
    class JniImplementationTests {
        ...
        void shouldEnableFlexibleVectorsJni() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                JniExperimentalFeatures result = config.enableFlexibleVectors(
                    true,   // dynamic sizing
        ...
        void shouldEnableStringImportsJni() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                JniExperimentalFeatures result = config.enableStringImports(
        ...
        void shouldEnableResourceTypesJni() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                JniExperimentalFeatures result = config.enableResourceTypes(
        ...
        void shouldEnableTypeImportsJni() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                JniExperimentalFeatures result = config.enableTypeImports(
        ...
        void shouldEnableSharedEverythingThreadsJni() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                JniExperimentalFeatures result = config.enableSharedEverythingThreads(
                    2,      // min threads
                    8,      // max threads
        ...
        void shouldEnableCustomPageSizesJni() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                JniExperimentalFeatures result = config.enableCustomPageSizes(
                    8192,   // 8KB page size
        ...
        void shouldValidateExperimentalFeatureSupportDetection() {
            ...
            assertFalse(JniExperimentalFeatures.isExperimentalFeatureSupported(
        ...
        void shouldHandleInvalidArgumentsJni() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                assertThrows(IllegalArgumentException.class,
                    () -> config.enableCustomPageSizes(0,
                        JniExperimentalFeatures.PageSizeStrategy.CUSTOM, false),
        ...
        void shouldValidateTypeValidationStrategies() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                for (JniExperimentalFeatures.TypeValidationStrategy strategy :
                    ...
                    assertDoesNotThrow(() ->
                        config.enableTypeImports(strategy,
                            JniExperimentalFeatures.ImportResolutionMechanism.STATIC, true),
    ...
    class AdvancedConfigurationTests {
        ...
        void shouldCombineMultipleExperimentalFeatures() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                config.enableStackSwitching(1024 * 1024, 10)
        ...
        void shouldHandleEdgeCaseConfigurations() {
            try (JniExperimentalFeatures config = new JniExperimentalFeatures()) {
                ...
                for (int pageSize : validPageSizes) {
                    assertDoesNotThrow(() ->
                        config.enableCustomPageSizes(pageSize,
                            JniExperimentalFeatures.PageSizeStrategy.CUSTOM, false),
