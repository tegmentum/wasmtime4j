...
public final class TestUtils {
    ...
    public static int getTestTimeoutSeconds() {
        ...
        if (timeoutStr != null) {
            try {
                ...
                LOGGER.warning("Invalid timeout value: " + timeoutStr + ", using default: " + 
     ...
     * This creates a minimal WAT (WebAssembly Text format) module.
     *
    ...
    public static byte[] createMemoryImportWasmModule() {
        ...
        return new byte[] {
            ...
            0x02, 0x0c, 0x01, 0x03, 0x65, 0x6e, 0x76, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x02, 0x00, 0x01, // import section
            0x03, 0x02, 0x01, 0x00, // function section
            0x07, 0x08, 0x01, 0x04, 0x6c, 0x6f, 0x61, 0x64, 0x00, 0x00, // export section
            0x0a, 0x07, 0x01, 0x05, 0x00, 0x20, 0x00, 0x28, 0x02, 0x00, 0x0b // code section
        };
    }
    ...
    public static Properties loadProperties(final String propertiesFile) throws IOException {
        ...
        try (final InputStream input = TestUtils.class.getClassLoader().getResourceAsStream(propertiesFile)) {
            if (input == null) {
