...
public final class CrossRuntimeAnalysis {
    ...
    public CrossRuntimeAnalysis(final Map<TestRuntime, Integer> runtimeSuccessRates,
    ...
    public Map<TestRuntime, Integer> getRuntimeSuccessRates() { return runtimeSuccessRates; }
