...
public final class RegressionDetectionConfiguration {
    ...
    public Path getBaselineDirectory() { return baselineDirectory; }
    public double getPerformanceThresholdPercent() { return performanceThresholdPercent; }
    public boolean isFailOnRegression() { return failOnRegression; }
    public boolean isGenerateDiffReports() { return generateDiffReports; }
