...
public final class TestFilterConfiguration {
    ...
    public boolean matches(final WebAssemblyTestCase testCase) {
        ...
        if (!includedTags.isEmpty()) {
            final boolean hasIncludedTag = includedTags.stream()
                .anyMatch(testCase::hasTag);
            if (!hasIncludedTag) {
                return false;
            }
        }
        ...
        if (!testNamePatterns.isEmpty()) {
            final boolean matchesPattern = testNamePatterns.stream()
    ...
    // Getters
    public Set<TestCategory> getIncludedCategories() { return includedCategories; }
    public Set<TestCategory> getExcludedCategories() { return excludedCategories; }
    public List<String> getIncludedTags() { return includedTags; }
    public List<String> getExcludedTags() { return excludedTags; }
    public List<Pattern> getTestNamePatterns() { return testNamePatterns; }
    public List<Pattern> getExcludedNamePatterns() { return excludedNamePatterns; }
    public Set<TestComplexity> getAllowedComplexities() { return allowedComplexities; }
    public long getMaxExecutionTimeMs() { return maxExecutionTimeMs; }
    public boolean isSkipKnownFailures() { return skipKnownFailures; }
    public List<Predicate<WebAssemblyTestCase>> getCustomFilters() { return customFilters; }
    ...
    public static final class Builder {
        ...
        public Builder includedCategories(final Set<TestCategory> categories) {
            this.includedCategories = categories != null ? Set.copyOf(categories) : Collections.emptySet();
            return this;
        }

        public Builder excludedCategories(final Set<TestCategory> categories) {
            this.excludedCategories = categories != null ? Set.copyOf(categories) : Collections.emptySet();
            return this;
        }
        ...
        public Builder testNamePatterns(final List<String> patterns) {
            ...
            this.testNamePatterns = patterns.stream()
                .map(Pattern::compile)
                .toList();
            return this;
        }
        ...
        public Builder excludedNamePatterns(final List<String> patterns) {
            ...
            this.excludedNamePatterns = patterns.stream()
                .map(Pattern::compile)
                .toList();
            return this;
        }
        ...
        public Builder allowedComplexities(final Set<TestComplexity> complexities) {
            this.allowedComplexities = complexities != null ?
                Set.copyOf(complexities) : EnumSet.allOf(TestComplexity.class);
            return this;
        }
