...
public final class PerformanceAnalysis {
    ...
    public PerformanceAnalysis(final Map<TestRuntime, Double> averageExecutionTimes,
    ...
    public Map<TestRuntime, Double> getAverageExecutionTimes() { return averageExecutionTimes; }
