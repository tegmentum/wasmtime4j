...
public final class CoverageAnalysis {
  ...
  public CoverageAnalysis(
      final Map<TestCategory, Integer> testCountsByCategory, final List<String> coverageGaps) {
    this.testCountsByCategory = Map.copyOf(testCountsByCategory);
    this.coverageGaps = List.copyOf(coverageGaps);
  }

  public Map<TestCategory, Integer> getTestCountsByCategory() {
    return testCountsByCategory;
  }
