...
public enum TestCategory {
  ...
  SPEC_JS_API(
      "spec-js-api", "JavaScript API Specification", "Tests for JavaScript API integration"),
  SPEC_WEB_API("spec-web-api", "Web API Specification", "Tests for Web platform integration"),

  // WebAssembly proposals
  SPEC_BULK_MEMORY(
      "spec-bulk-memory", "Bulk Memory Operations", "Tests for bulk memory operations proposal"),
  SPEC_REFERENCE_TYPES(
      "spec-reference-types", "Reference Types", "Tests for reference types proposal"),
  ...
  SPEC_EXCEPTION_HANDLING(
      "spec-exception-handling", "Exception Handling", "Tests for exception handling proposal"),
  SPEC_GC("spec-gc", "Garbage Collection", "Tests for garbage collection proposal"),
  SPEC_COMPONENT_MODEL(
      "spec-component-model", "Component Model", "Tests for component model proposal"),

  // Wasmtime-specific tests
  WASMTIME_REGRESSION(
      "wasmtime-regression", "Wasmtime Regressions", "Regression tests for Wasmtime"),
  WASMTIME_PERFORMANCE(
      "wasmtime-performance", "Wasmtime Performance", "Performance tests for Wasmtime"),
