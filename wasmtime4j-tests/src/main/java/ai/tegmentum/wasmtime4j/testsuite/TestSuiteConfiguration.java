...
/**
 * Configuration for WebAssembly test suite execution.
 * Provides comprehensive configuration options for test discovery, execution, and reporting.
 */
public final class TestSuiteConfiguration {
    ...
    // Getters
    public boolean isOfficialTestsEnabled() { return officialTestsEnabled; }
    public boolean isWasmtimeTestsEnabled() { return wasmtimeTestsEnabled; }
    public boolean isCustomTestsEnabled() { return customTestsEnabled; }
    public Set<TestRuntime> getEnabledRuntimes() { return enabledRuntimes; }
    public int getMaxConcurrentTests() { return maxConcurrentTests; }
    public int getTestTimeoutMinutes() { return testTimeoutMinutes; }
    public boolean isCrossRuntimeComparisonEnabled() { return crossRuntimeComparisonEnabled; }
    public boolean isPerformanceAnalysisEnabled() { return performanceAnalysisEnabled; }
    public boolean isCoverageAnalysisEnabled() { return coverageAnalysisEnabled; }
    ...
    public boolean isJsonReportEnabled() { return jsonReportEnabled; }
    public boolean isXmlReportEnabled() { return xmlReportEnabled; }
    public Path getTestSuiteBaseDirectory() { return testSuiteBaseDirectory; }
    public Path getOutputDirectory() { return outputDirectory; }
    public TestFilterConfiguration getTestFilters() { return testFilters; }
    public RegressionDetectionConfiguration getRegressionConfig() { return regressionConfig; }
