...
/**
 * Tests for {@link PanamaWasiEnvironment} class.
 *
 * <p>PanamaWasiEnvironment provides Panama FFI access to WASI Preview 2 environment and
 * command-line operations.
 */
@DisplayName("PanamaWasiEnvironment Tests")
class PanamaWasiEnvironmentTest {
  ...
  private Class<?> loadClassWithoutInit() throws ClassNotFoundException {
    return Class.forName(
        "ai.tegmentum.wasmtime4j.panama.wasi.cli.PanamaWasiEnvironment",
        false,
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() throws ClassNotFoundException {
      ...
      assertTrue(Modifier.isFinal(clazz.getModifiers()), "PanamaWasiEnvironment should be final");
    }
    ...
    void shouldBePublic() throws ClassNotFoundException {
      final Class<?> clazz = loadClassWithoutInit();
      assertTrue(Modifier.isPublic(clazz.getModifiers()), "PanamaWasiEnvironment should be public");
    }
    ...
    void shouldImplementWasiEnvironmentInterface() throws ClassNotFoundException {
      ...
      assertTrue(
          ...
          "PanamaWasiEnvironment should implement WasiEnvironment");
    }
  }
