 ...
 *
 * <p>PanamaWasiWallClock provides Panama FFI access to WASI Preview 2 wall clock operations.
 */
...
class PanamaWasiWallClockTest {
  ...
  private Class<?> loadClassWithoutInit() throws ClassNotFoundException {
    return Class.forName(
        "ai.tegmentum.wasmtime4j.panama.wasi.clocks.PanamaWasiWallClock",
        false,
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() throws ClassNotFoundException {
      ...
      assertTrue(Modifier.isFinal(clazz.getModifiers()), "PanamaWasiWallClock should be final");
    }
    ...
    void shouldBePublic() throws ClassNotFoundException {
      final Class<?> clazz = loadClassWithoutInit();
      assertTrue(Modifier.isPublic(clazz.getModifiers()), "PanamaWasiWallClock should be public");
    }
