...
/**
 * Tests for the private {@code parseJsonStringArray} method in {@link PanamaComponentLinker}.
 *
 ...
 */
@DisplayName("PanamaComponentLinker parseJsonStringArray Tests")
class PanamaComponentLinkerParserTest {
  ...
  static void setUp() throws NoSuchMethodException {
    parseMethod =
        PanamaComponentLinker.class.getDeclaredMethod("parseJsonStringArray", String.class);
