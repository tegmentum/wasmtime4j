...
/**
 * Unit tests for PanamaWastRunner.
 *
 * <p>These tests verify that WAST (WebAssembly Test) execution works correctly using Wasmtime's
 * native WAST parser via the Panama FFI.
 */
public final class PanamaWastRunnerTest {
  ...
  public void testExecuteSimpleWastFile() throws URISyntaxException, IOException {
    ...
    // Execute WAST file
    final WastExecutionResult result = PanamaWastRunner.executeWastFile(wastPath.toString());
  ...
  public void testExecuteWastString() {
    ...
    final WastExecutionResult result =
        PanamaWastRunner.executeWastString("inline.wast", wastContent);
  ...
  public void testExecuteWastWithFailure() {
    ...
    // Execute WAST string
    final WastExecutionResult result =
        PanamaWastRunner.executeWastString("failing.wast", wastContent);
  ...
  public void testExecuteWastWithInvalidSyntax() {
    ...
    // Execute WAST string
    final WastExecutionResult result =
        PanamaWastRunner.executeWastString("invalid.wast", wastContent);
  ...
  public void testExecuteNonExistentFile() {
    ...
    final WastExecutionResult result = PanamaWastRunner.executeWastFile(nonExistentPath);
    ...
    assertTrue(
        result.getExecutionError().contains("not found")
            ...
            || result.getExecutionError().contains("File not found"),
        "Error message should indicate file not found, got: " + result.getExecutionError());
  }
  ...
  public void testExecuteWastBytes() {
    ...
    // Execute WAST bytes
    final WastExecutionResult result = PanamaWastRunner.executeWastBytes("bytes.wast", wastBytes);
  ...
  public void testExecuteWastStringOrThrowSuccess() {
    ...
    assertDoesNotThrow(
        () -> {
          PanamaWastRunner.executeWastStringOrThrow("success.wast", wastContent);
        },
  ...
  public void testNullOrEmptyArguments() {
    assertThrows(
        ...
        () -> {
          PanamaWastRunner.executeWastFile((String) null);
        },
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> {
          PanamaWastRunner.executeWastFile("");
        },
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> {
          PanamaWastRunner.executeWastString(null, "content");
        },
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> {
          PanamaWastRunner.executeWastString("file.wast", null);
        },
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> {
          PanamaWastRunner.executeWastBytes(null, new byte[0]);
        },
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> {
          PanamaWastRunner.executeWastBytes("file.wast", null);
        },
  ...
  public void testWastDirectiveResult() {
    ...
    final WastExecutionResult result =
        PanamaWastRunner.executeWastString("directive.wast", wastContent);
