...
class PanamaComponentImplTest {
  ...
  void setUp() throws WasmException {
    // Create Panama-based engine and store for testing
  ...
  @Test
  @DisplayName("PanamaComponentImpl should handle component creation with validation")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should reject null parameters")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should reject empty component bytes")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should provide component metadata")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should provide component type information")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should support component instantiation")
  ...
  @Test
  @DisplayName("PanamaComponentImpl instantiate should validate parameters")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should handle component serialization")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should support component validation")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should handle resource cleanup properly")
  void testComponentResourceCleanup() throws WasmException {
    final byte[] componentBytes = createMinimalComponent();
    Component component = new PanamaComponentImpl(engine, componentBytes, arena);
  ...
  @Test
  @DisplayName("PanamaComponentImpl should handle Arena lifecycle properly")
  void testComponentArenaLifecycle() throws WasmException {
    final byte[] componentBytes = createMinimalComponent();
    final Component component = new PanamaComponentImpl(engine, componentBytes, arena);
    ...
    // Component should detect arena closure and become invalid
    assertFalse(component.isValid());
  ...
  @Test
  @DisplayName("PanamaComponentImpl should handle engine lifecycle properly")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should provide zero-copy optimizations where possible")
  void testZeroCopyOptimizations() throws WasmException {
    final byte[] componentBytes = createMinimalComponent();
    final Component component = new PanamaComponentImpl(engine, componentBytes, arena);
  ...
  @Test
  @DisplayName("PanamaComponentImpl should handle concurrent access safely")
  ...
  @Test
  @DisplayName("PanamaComponentImpl should handle large component bytes with Arena")
  void testComponentWithLargeBytesAndArena() throws WasmException {
  ...
  @Test
  @DisplayName("PanamaComponentImpl should handle Arena scope correctly")
  void testComponentArenaScopeHandling() throws WasmException {
    final byte[] componentBytes = createMinimalComponent();

    // Test with a nested arena scope
    try (Arena nestedArena = Arena.ofConfined()) {
      final Component component = new PanamaComponentImpl(engine, componentBytes, nestedArena);
      assertNotNull(component);
      assertTrue(component.isValid());

      // Component should work within the arena scope
      final ComponentMetadata metadata = component.getMetadata();
      assertNotNull(metadata);
    }

    // After the nested arena is closed, component should be invalid
    // This tests that the component properly tracks arena lifecycle
  }
