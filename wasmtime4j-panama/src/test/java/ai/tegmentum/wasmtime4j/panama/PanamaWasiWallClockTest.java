...
/**
 * Tests for {@link PanamaWasiWallClock} class.
 *
 * <p>PanamaWasiWallClock provides wall clock functionality using Panama FFI.
 */
@DisplayName("PanamaWasiWallClock Tests")
class PanamaWasiWallClockTest {
  ...
  class ClassStructureTests {
    ...
    void shouldImplementWasiWallClockInterface() {
      assertTrue(
          WasiWallClock.class.isAssignableFrom(PanamaWasiWallClock.class),
          "PanamaWasiWallClock should implement WasiWallClock");
    }
  }
  ...
  class ClockMethodTests {
    ...
    void shouldHaveNowMethod() throws NoSuchMethodException {
      final Method method = PanamaWasiWallClock.class.getMethod("now");
      assertNotNull(method, "now method should exist");
      assertEquals(WasiWallClock.Datetime.class, method.getReturnType(), "Should return Datetime");
    }

    @Test
    @DisplayName("should have resolution method")
    void shouldHaveResolutionMethod() throws NoSuchMethodException {
      final Method method = PanamaWasiWallClock.class.getMethod("resolution");
  ...
  class ConstructorTests {
    ...
    void shouldHavePublicDefaultConstructor() throws NoSuchMethodException {
      var constructor = PanamaWasiWallClock.class.getConstructor();
