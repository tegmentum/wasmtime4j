...
/**
 * Tests for {@link PanamaExternFunc} class.
 *
 * <p>PanamaExternFunc is the Panama implementation of an extern function value.
 */
@DisplayName("PanamaExternFunc Tests")
class PanamaExternFuncTest {
  ...
  class ClassStructureTests {
    ...
    void shouldBePackagePrivateFinalClass() {
      ...
      assertTrue(
          !Modifier.isPublic(PanamaExternFunc.class.getModifiers()),
          "PanamaExternFunc should be package-private");
      assertTrue(
          Modifier.isFinal(PanamaExternFunc.class.getModifiers()),
          "PanamaExternFunc should be final");
    }
    ...
    void shouldImplementExternInterface() {
      assertTrue(
          ...
          "PanamaExternFunc should implement Extern");
    }
  }
  ...
  class ExternInterfaceMethodTests {
    ...
    void shouldHaveGetTypeMethod() throws NoSuchMethodException {
      final Method method = PanamaExternFunc.class.getMethod("getType");
    ...
    @Test
    @DisplayName("should have asFunction method")
    void shouldHaveAsFunctionMethod() throws NoSuchMethodException {
      final Method method = PanamaExternFunc.class.getMethod("asFunction");
  ...
  class InternalMethodTests {
    ...
    void shouldHaveGetNativeHandleMethod() throws NoSuchMethodException {
      final Method method = PanamaExternFunc.class.getDeclaredMethod("getNativeHandle");
  ...
  class ConstructorTests {
    ...
    void shouldHavePackagePrivateConstructor() {
      ...
      for (var constructor : PanamaExternFunc.class.getDeclaredConstructors()) {
