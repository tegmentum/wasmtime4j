 ...
 *
 * <p>PanamaWasiMonotonicClock provides Panama FFI access to WASI Preview 2 monotonic clock
 * operations.
 */
...
class PanamaWasiMonotonicClockTest {
  ...
  private Class<?> loadClassWithoutInit() throws ClassNotFoundException {
    return Class.forName(
        "ai.tegmentum.wasmtime4j.panama.wasi.clocks.PanamaWasiMonotonicClock",
        false,
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() throws ClassNotFoundException {
      ...
      assertTrue(
          Modifier.isFinal(clazz.getModifiers()), "PanamaWasiMonotonicClock should be final");
    }
    ...
    void shouldBePublic() throws ClassNotFoundException {
      final Class<?> clazz = loadClassWithoutInit();
      assertTrue(
          Modifier.isPublic(clazz.getModifiers()), "PanamaWasiMonotonicClock should be public");
    }
