 ...
 *
 * <p>These tests verify that globals can be shared between different WebAssembly modules
 * within the same store context, maintaining type safety and proper resource management.
 */
...
class PanamaGlobalSharingIT {
  ...
  void testGlobalCompatibilityChecking() throws Exception {
    ...
    try (PanamaModule module1 = new PanamaModule(engine, wasmBytes1);
         PanamaInstance instance1 = store.instantiateModule(module1);
         PanamaModule module2 = new PanamaModule(engine, wasmBytes2);
      ...
      PanamaGlobal immutableGlobal = PanamaTestUtils.getGlobalFromInstance(instance2, "test_global");
