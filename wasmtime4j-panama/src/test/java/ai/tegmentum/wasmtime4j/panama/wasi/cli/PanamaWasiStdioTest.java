...
/**
 * Tests for {@link PanamaWasiStdio} class.
 *
 * <p>PanamaWasiStdio provides Panama FFI access to WASI Preview 2 standard I/O streams.
 */
@DisplayName("PanamaWasiStdio Tests")
class PanamaWasiStdioTest {
  ...
  private Class<?> loadClassWithoutInit() throws ClassNotFoundException {
    return Class.forName(
        "ai.tegmentum.wasmtime4j.panama.wasi.cli.PanamaWasiStdio",
        false,
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() throws ClassNotFoundException {
      ...
      assertTrue(Modifier.isFinal(clazz.getModifiers()), "PanamaWasiStdio should be final");
    }
    ...
    void shouldBePublic() throws ClassNotFoundException {
      final Class<?> clazz = loadClassWithoutInit();
      assertTrue(Modifier.isPublic(clazz.getModifiers()), "PanamaWasiStdio should be public");
    }
    ...
    void shouldImplementWasiStdioInterface() throws ClassNotFoundException {
      final Class<?> clazz = loadClassWithoutInit();
      assertTrue(
          WasiStdio.class.isAssignableFrom(clazz), "PanamaWasiStdio should implement WasiStdio");
    }
  }
  ...
  class PanamaFfiHandleTests {
    ...
    void shouldHaveStaticMethodHandleFields() throws ClassNotFoundException {
      ...
      assertTrue(methodHandleCount >= 3, "Should have at least 3 MethodHandle fields for FFI");
    }
  }
}
