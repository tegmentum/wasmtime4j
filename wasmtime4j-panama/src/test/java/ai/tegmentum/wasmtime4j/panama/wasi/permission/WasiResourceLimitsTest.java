 ...
 * contexts in Panama FFI implementation including memory usage limits, file descriptor limits, disk
 * I/O limits, network connection limits, and execution time limits.
 */
