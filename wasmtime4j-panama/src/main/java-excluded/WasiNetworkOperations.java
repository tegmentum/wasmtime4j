...
/**
 * Panama implementation of WASI Preview 2 network operations.
 *
 ...
 * networking capabilities with proper resource management and error handling using Panama FFI.
 *
 * <p>Supported network operations:
 *
 * <ul>
 *   <li>TCP socket creation, binding, listening, accepting, connecting, and data transfer
...
public final class WasiNetworkOperations {
  ...
  /** Native linker for FFI calls. */
  private final Linker linker = Linker.nativeLinker();

  /** Memory arena for FFI operations. */
  ...
  public WasiNetworkOperations(final WasiContext wasiContext, final ExecutorService asyncExecutor) {
    ...
    LOGGER.info("Created Panama WASI network operations handler");
  }
  ...
  public long createTcpSocket(final int addressFamily) {
    ...
    try {
      ...
      final int result =
          callNativeCreateTcpSocket(wasiContext.getNativeHandle(), socketHandle, addressFamily);
  ...
  public void bindTcp(final long socketHandle, final String address, final int port) {
    PanamaValidation.requireNonEmpty(address, "address");
    ...
    try {
      final int result =
          callNativeBindTcp(wasiContext.getNativeHandle(), socketHandle, address, port);
  ...
  public void listenTcp(final long socketHandle, final int backlog) {
    ...
    try {
      final int result = callNativeListenTcp(wasiContext.getNativeHandle(), socketHandle, backlog);
  ...
  public long acceptTcp(final long socketHandle) {
    ...
    try {
      final TcpAcceptResult result =
          callNativeAcceptTcp(wasiContext.getNativeHandle(), socketHandle);
  ...
  public void connectTcp(final long socketHandle, final String address, final int port) {
    ...
    try {
      final int result =
          callNativeConnectTcp(wasiContext.getNativeHandle(), socketHandle, address, port);
  ...
  public int sendTcp(final long socketHandle, final ByteBuffer data) {
    ...
    try {
      ...
      final TcpSendResult result =
          callNativeSendTcp(wasiContext.getNativeHandle(), socketHandle, buffer, dataSize);
  ...
  public int receiveTcp(final long socketHandle, final ByteBuffer buffer) {
    ...
    try {
      ...
      final TcpReceiveResult result =
          callNativeReceiveTcp(wasiContext.getNativeHandle(), socketHandle, tempBuffer, maxSize);
  ...
  public long createUdpSocket(final int addressFamily) {
    ...
    try {
      ...
      final int result =
          callNativeCreateUdpSocket(wasiContext.getNativeHandle(), socketHandle, addressFamily);
  ...
  public UdpDatagram receiveUdp(final long socketHandle, final ByteBuffer buffer) {
    ...
    try {
      ...
      final UdpReceiveResult result =
          callNativeReceiveUdp(wasiContext.getNativeHandle(), socketHandle, tempBuffer, maxSize);
   ...
   */
  public WasiHttpResponse httpRequest(
      final String method,
      final String uri,
      final Map<String, String> headers,
      final ByteBuffer body) {
    PanamaValidation.requireNonEmpty(method, "method");
    PanamaValidation.requireNonEmpty(uri, "uri");
    PanamaValidation.requireNonNull(headers, "headers");
    ...
    try {
      ...
      final WasiHttpResponse httpResponse =
          new WasiHttpResponse(response.statusCode, responseHeaders, responseBody);
  ...
  public void closeSocket(final long socketHandle) {
    ...
    try {
      final int result = callNativeCloseSocket(wasiContext.getNativeHandle(), socketHandle);
  ...
  // Panama FFI native method implementations

  private int callNativeCreateTcpSocket(
      final long contextHandle, final long socketHandle, final int addressFamily) {
    try {
      final var createTcpSocketHandle =
          linker.downcallHandle(
              "network_tcp_create_socket",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
                  ValueLayout.JAVA_LONG,
                  ValueLayout.JAVA_LONG,
                  ValueLayout.JAVA_INT));
      return (int) createTcpSocketHandle.invokeExact(contextHandle, socketHandle, addressFamily);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_tcp_create_socket", e);
      return -1;
    }
  }

  private int callNativeBindTcp(
      final long contextHandle, final long socketHandle, final String address, final int port) {
    try {
      final var bindTcpHandle =
          linker.downcallHandle(
              "network_tcp_bind",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
      ...
      final MemorySegment addressSegment = arena.allocateUtf8String(address);
      return (int) bindTcpHandle.invokeExact(contextHandle, socketHandle, addressSegment, port);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_tcp_bind", e);
      return -1;
    }
  }

  private int callNativeListenTcp(
      final long contextHandle, final long socketHandle, final int backlog) {
    try {
      final var listenTcpHandle =
          linker.downcallHandle(
              "network_tcp_listen",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
                  ...
                  ValueLayout.JAVA_LONG,
                  ValueLayout.JAVA_INT));
      return (int) listenTcpHandle.invokeExact(contextHandle, socketHandle, backlog);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_tcp_listen", e);
      return -1;
    }
  }

  private TcpAcceptResult callNativeAcceptTcp(final long contextHandle, final long socketHandle) {
    try {
      final var acceptTcpHandle =
          linker.downcallHandle(
              "network_tcp_accept",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
      ...
      final MemorySegment addressBuffer = arena.allocate(256);
      final MemorySegment portBuffer = arena.allocate(ValueLayout.JAVA_INT);

      final int errorCode =
          (int) acceptTcpHandle.invokeExact(contextHandle, socketHandle, addressBuffer, portBuffer);

      final String remoteAddress = addressBuffer.getUtf8String(0);
      final int remotePort = portBuffer.get(ValueLayout.JAVA_INT, 0);

      return new TcpAcceptResult(errorCode, remoteAddress, remotePort);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_tcp_accept", e);
      return new TcpAcceptResult(-1, "", 0);
    }
  }

  private int callNativeConnectTcp(
      final long contextHandle, final long socketHandle, final String address, final int port) {
    try {
      final var connectTcpHandle =
          linker.downcallHandle(
              "network_tcp_connect",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
      ...
      final MemorySegment addressSegment = arena.allocateUtf8String(address);
      return (int) connectTcpHandle.invokeExact(contextHandle, socketHandle, addressSegment, port);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_tcp_connect", e);
      return -1;
    }
  }

  private TcpSendResult callNativeSendTcp(
      final long contextHandle, final long socketHandle, final byte[] data, final int dataSize) {
    try {
      final var sendTcpHandle =
          linker.downcallHandle(
              "network_tcp_send",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
      ...
      final MemorySegment dataSegment = arena.allocate(dataSize);
      dataSegment.copyFrom(MemorySegment.ofArray(data));
      final MemorySegment bytesSentBuffer = arena.allocate(ValueLayout.JAVA_INT);

      final int errorCode =
          (int)
              sendTcpHandle.invokeExact(
                  contextHandle, socketHandle, dataSegment, dataSize, bytesSentBuffer);
      final int bytesSent = bytesSentBuffer.get(ValueLayout.JAVA_INT, 0);

      return new TcpSendResult(errorCode, bytesSent);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_tcp_send", e);
      return new TcpSendResult(-1, 0);
    }
  }

  private TcpReceiveResult callNativeReceiveTcp(
      final long contextHandle,
      final long socketHandle,
      final byte[] buffer,
      final int bufferSize) {
    try {
      final var receiveTcpHandle =
          linker.downcallHandle(
              "network_tcp_receive",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
      ...
      final MemorySegment bufferSegment = arena.allocate(bufferSize);
      final MemorySegment bytesReceivedBuffer = arena.allocate(ValueLayout.JAVA_INT);

      final int errorCode =
          (int)
              receiveTcpHandle.invokeExact(
                  contextHandle, socketHandle, bufferSegment, bufferSize, bytesReceivedBuffer);
      final int bytesReceived = bytesReceivedBuffer.get(ValueLayout.JAVA_INT, 0);

      if (errorCode == 0 && bytesReceived > 0) {
        bufferSegment.copyFrom(MemorySegment.ofArray(buffer));
      }

      return new TcpReceiveResult(errorCode, bytesReceived);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_tcp_receive", e);
      return new TcpReceiveResult(-1, 0);
    }
  }

  private int callNativeCreateUdpSocket(
      final long contextHandle, final long socketHandle, final int addressFamily) {
    try {
      final var createUdpSocketHandle =
          linker.downcallHandle(
              "network_udp_create_socket",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
                  ValueLayout.JAVA_LONG,
                  ValueLayout.JAVA_LONG,
                  ValueLayout.JAVA_INT));
      return (int) createUdpSocketHandle.invokeExact(contextHandle, socketHandle, addressFamily);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_udp_create_socket", e);
      return -1;
    }
  }

  private int callNativeSendUdp(
      final long contextHandle,
      final long socketHandle,
      final byte[] data,
      final int dataSize,
    ...
    try {
      ...
      return (int)
          sendUdpHandle.invokeExact(
              contextHandle, socketHandle, dataSegment, dataSize, addressSegment, port);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_udp_send", e);
      return -1;
    }
  }

  private UdpReceiveResult callNativeReceiveUdp(
      final long contextHandle,
      final long socketHandle,
      final byte[] buffer,
      final int bufferSize) {
    try {
      final var receiveUdpHandle =
          linker.downcallHandle(
              "network_udp_receive",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT,
      ...
      final int bytesReceived = bytesReceivedBuffer.get(ValueLayout.JAVA_INT, 0);
      final String sourceAddress = addressBuffer.getUtf8String(0);
      final int sourcePort = portBuffer.get(ValueLayout.JAVA_INT, 0);

      if (errorCode == 0 && bytesReceived > 0) {
        bufferSegment.copyFrom(MemorySegment.ofArray(buffer));
      }

      return new UdpReceiveResult(errorCode, bytesReceived, sourceAddress, sourcePort);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_udp_receive", e);
      return new UdpReceiveResult(-1, 0, "", 0);
    }
  }

  private HttpResponse callNativeHttpRequest(
      final long contextHandle,
      final String method,
      final String uri,
    ...
    try {
      ...
      final MemorySegment methodSegment = arena.allocateUtf8String(method);
      final MemorySegment uriSegment = arena.allocateUtf8String(uri);

      // Allocate headers
      final MemorySegment headersSegment = arena.allocate(ValueLayout.ADDRESS, headers.length);
      for (int i = 0; i < headers.length; i++) {
        final MemorySegment headerSegment = arena.allocateUtf8String(headers[i]);
        headersSegment.setAtIndex(ValueLayout.ADDRESS, i, headerSegment);
      }

      // Allocate body
      MemorySegment bodySegment = MemorySegment.NULL;
      if (body != null && bodySize > 0) {
        bodySegment = arena.allocate(bodySize);
        bodySegment.copyFrom(MemorySegment.ofArray(body));
      }

      // Output parameters
      final MemorySegment statusCodeBuffer = arena.allocate(ValueLayout.JAVA_INT);
      final MemorySegment responseHeadersBuffer = arena.allocate(ValueLayout.ADDRESS);
      final MemorySegment responseBodyBuffer = arena.allocate(ValueLayout.ADDRESS);

      final int errorCode =
          (int)
              httpRequestHandle.invokeExact(
                  contextHandle,
                  methodSegment,
                  uriSegment,
                  headersSegment,
                  ...
                  bodySize,
                  statusCodeBuffer,
                  responseHeadersBuffer,
                  responseBodyBuffer);

      final int statusCode = statusCodeBuffer.get(ValueLayout.JAVA_INT, 0);
      // Note: Proper handling of response headers and body would need more complex FFI

      return new HttpResponse(errorCode, statusCode, new String[0], new byte[0]);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_http_request", e);
      return new HttpResponse(-1, 0, new String[0], new byte[0]);
    }
  }

  private int callNativeCloseSocket(final long contextHandle, final long socketHandle) {
    try {
      final var closeSocketHandle =
          linker.downcallHandle(
              "network_close_socket",
              FunctionDescriptor.of(
                  ValueLayout.JAVA_INT, ValueLayout.JAVA_LONG, ValueLayout.JAVA_LONG));
      return (int) closeSocketHandle.invokeExact(contextHandle, socketHandle);
    } catch (final Throwable e) {
      LOGGER.log(Level.WARNING, "FFI call failed: network_close_socket", e);
      return -1;
    }
  }
