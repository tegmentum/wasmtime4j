 ...
 * without JNI overhead. It supports both WASI Preview 1 and Preview 2 features including
 * async I/O operations, component model integration, and enhanced security.
 *
 * <p>Key async I/O features:
 * <ul>
 *   <li>Non-blocking async operations with CompletableFuture support</li>
 *   <li>Proper cancellation and timeout handling</li>
 *   <li>Resource management through Arena-based cleanup</li>
 *   <li>Integration with Java's async patterns</li>
 * </ul>
 *
 * @since 1.0.0
 */
public final class PanamaWasiContextImpl extends PanamaResource implements WasiContext {
    ...
    public WasiContext setArgv(String[] argv) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_set_argv(
                tempArena, getNativeHandle(), argv
            );
            if (result != 0) {
    ...
    public WasiContext setEnv(String key, String value) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_set_env(
                tempArena, getNativeHandle(), key, value
            );
            if (result != 0) {
    ...
    public WasiContext inheritEnv() {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_inherit_env(
                tempArena, getNativeHandle()
            );
            if (result != 0) {
    ...
    public WasiContext inheritStdio() {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_inherit_stdio(
                tempArena, getNativeHandle()
            );
            if (result != 0) {
    ...
    public WasiContext setStdin(Path path) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_set_stdin(
                tempArena, getNativeHandle(), path.toString()
            );
            if (result != 0) {
    ...
    public WasiContext setStdout(Path path) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_set_stdout(
                tempArena, getNativeHandle(), path.toString()
            );
            if (result != 0) {
    ...
    public WasiContext setStderr(Path path) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_set_stderr(
                tempArena, getNativeHandle(), path.toString()
            );
            if (result != 0) {
    ...
    public WasiContext preopenedDir(Path hostPath, String guestPath) throws WasmException {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_preopened_dir(
    ...
    public WasiContext preopenedDirReadOnly(Path hostPath, String guestPath) throws WasmException {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_preopened_dir_readonly(
                tempArena, getNativeHandle(), hostPath.toString(), guestPath
            );
            if (result != 0) {
    ...
    public WasiContext setWorkingDirectory(String workingDir) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_set_working_directory(
    ...
    public WasiContext setNetworkEnabled(boolean enabled) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_set_network_enabled(
    ...
    public WasiContext setMaxOpenFiles(int maxFds) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_context_set_max_open_files(
                tempArena, getNativeHandle(), maxFds
            );
            if (result != 0) {
    ...
    public WasiContext setAsyncIoEnabled(boolean enabled) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_preview2_set_async_io_enabled(
                tempArena, getNativeHandle(), enabled
            );
            if (result != 0) {
    ...
    public WasiContext setMaxAsyncOperations(int maxOps) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_preview2_set_max_async_operations(
    ...
    public WasiContext setAsyncTimeout(long timeoutMs) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_preview2_set_async_timeout(
                tempArena, getNativeHandle(), timeoutMs
            );
            if (result != 0) {
    ...
    public WasiContext setComponentModelEnabled(boolean enabled) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_preview2_set_component_model_enabled(
                tempArena, getNativeHandle(), enabled
            );
            if (result != 0) {
    ...
    public WasiContext setProcessEnabled(boolean enabled) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_preview2_set_process_enabled(
                tempArena, getNativeHandle(), enabled
            );
            if (result != 0) {
    ...
    public WasiContext setFilesystemWorkingDir(Path workingDir) {
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_preview2_set_filesystem_working_dir(
    ...
    @Override
    public WasiContext preopenedDirWithPermissions(Path hostPath, String guestPath, WasiDirectoryPermissions permissions) throws WasmException {
        Objects.requireNonNull(hostPath, "Host path cannot be null");
        Objects.requireNonNull(guestPath, "Guest path cannot be null");
        ...
        try (Arena tempArena = Arena.ofConfined()) {
            var result = WasmtimeBindings.wasi_preview2_preopened_dir_with_permissions(
                tempArena, getNativeHandle(), hostPath.toString(), guestPath,
                permissions.canRead(), permissions.canWrite(), permissions.canCreate(),
                permissions.canDelete(), permissions.canList(), permissions.canTraverse(),
    ...
    public CompletableFuture<Integer> asyncRead(int streamId, byte[] buffer, long timeoutMs) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try (Arena tempArena = Arena.ofConfined()) {
                var operationId = WasmtimeBindings.wasi_preview2_stream_read_async(
    ...
    public CompletableFuture<Integer> asyncWrite(int streamId, byte[] buffer, long timeoutMs) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try (Arena tempArena = Arena.ofConfined()) {
                var operationId = WasmtimeBindings.wasi_preview2_stream_write_async(
                    tempArena, getNativeHandle(), streamId, buffer, buffer.length
                );
    ...
    private int waitForAsyncOperation(long operationId, long timeoutMs) throws WasmException {
        try (Arena tempArena = Arena.ofConfined()) {
            ...
            while (true) {
                var status = WasmtimeBindings.wasi_preview2_get_operation_status(
