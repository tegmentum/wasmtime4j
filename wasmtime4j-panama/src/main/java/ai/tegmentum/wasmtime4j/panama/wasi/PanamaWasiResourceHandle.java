...
/**
 * Panama implementation of WasiResourceHandle.
 *
 * <p>This class provides a handle to a WASI resource that can be passed between components.
 *
 * @since 1.0.0
 */
public final class PanamaWasiResourceHandle implements WasiResourceHandle {
   ...
   */
  public PanamaWasiResourceHandle(final WasiResource resource) {
   ...
   */
  public PanamaWasiResourceHandle(
  ...
  public String toString() {
    return "PanamaWasiResourceHandle{"
        + "resourceId="
        + resourceId
        + ", resourceType='"
        + resourceType
