 ...
 *
 * <p>This class provides a thread-safe cache for MethodHandle instances to optimize
 * repeated FFI calls. It handles function lookup, caching, and invalidation while
 * providing comprehensive statistics and monitoring capabilities.
 *
 * <p>The cache is designed to minimize overhead for frequent FFI operations by
 * eliminating repeated symbol lookup and method handle creation costs.
 */
public final class MethodHandleCache {
    ...
    public MethodHandleCache(final int maxCacheSize, final boolean statisticsEnabled) {
        ...
        LOGGER.fine("Initialized MethodHandleCache with max size: " + maxCacheSize + 
     ...
     */
    public Optional<MethodHandle> getOrCreate(final String functionName,
        ...
        try {
            ...
            if (methodHandle.isPresent()) {
                ...
                CachedMethodHandle cachedHandle = new CachedMethodHandle(methodHandle.get(), 
                                                                        symbol, descriptor);
     ...
     */
    public Optional<MethodHandle> get(final String functionName, final FunctionDescriptor descriptor) {
        Objects.requireNonNull(functionName, "Function name cannot be null");
        Objects.requireNonNull(descriptor, "Function descriptor cannot be null");
    ...
    public Optional<CacheStatistics> getStatistics() {
        ...
        return Optional.of(new CacheStatistics(
            hitCount.get(),
            missCount.get(),
            evictionCount.get(),
            loadTime.get(),
     ...
     * @return optional containing the method handle, or empty if creation failed
     */
    private Optional<MethodHandle> createMethodHandle(final MemorySegment symbol, 
                                                     final FunctionDescriptor descriptor) {
        try {
    ...
    private static final class CachedMethodHandle {
        ...
        CachedMethodHandle(final MethodHandle methodHandle, 
                          final MemorySegment symbol,
                          final FunctionDescriptor descriptor) {
    ...
    public static final class CacheStatistics {
        ...
        CacheStatistics(final long hitCount, 
        ...
        public String toString() {
            return String.format(
                ...
                hitCount, missCount, evictionCount, totalLoadTime, currentSize,
                getHitRate(), getAverageLoadTime()
            );
        }
    }
}