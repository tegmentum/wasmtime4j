...
public final class PanamaDebugger implements Debugger {
    ...
    static {
        try {
            ...
            // Advanced debugging function handles
            GET_DWARF_INFO = nativeLib.find("wasmtime4j_debug_get_dwarf_info")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_get_dwarf_info"));

            CREATE_SOURCE_MAP_INTEGRATION = nativeLib.find("wasmtime4j_debug_create_source_map_integration")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_create_source_map_integration"));

            CREATE_EXECUTION_TRACER = nativeLib.find("wasmtime4j_debug_create_execution_tracer")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_create_execution_tracer"));

            START_PROFILING = nativeLib.find("wasmtime4j_debug_start_profiling")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
            ...
            STOP_PROFILING = nativeLib.find("wasmtime4j_debug_stop_profiling")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.ofVoid(ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_stop_profiling"));

            GET_PROFILING_DATA = nativeLib.find("wasmtime4j_debug_get_profiling_data")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_get_profiling_data"));

            SET_BREAKPOINT_AT_ADDRESS = nativeLib.find("wasmtime4j_debug_set_breakpoint_at_address")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(JAVA_LONG, ADDRESS, ADDRESS, JAVA_INT)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_set_breakpoint_at_address"));

            SET_BREAKPOINT_AT_FUNCTION = nativeLib.find("wasmtime4j_debug_set_breakpoint_at_function")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(JAVA_LONG, ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_set_breakpoint_at_function"));

            SET_BREAKPOINT_AT_LINE = nativeLib.find("wasmtime4j_debug_set_breakpoint_at_line")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(JAVA_LONG, ADDRESS, ADDRESS, ADDRESS, JAVA_INT)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_set_breakpoint_at_line"));

            REMOVE_BREAKPOINT = nativeLib.find("wasmtime4j_debug_remove_breakpoint")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
            ...
            GET_CALL_STACK = nativeLib.find("wasmtime4j_debug_get_call_stack")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_get_call_stack"));

            GET_LOCAL_VARIABLES = nativeLib.find("wasmtime4j_debug_get_local_variables")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
            ...
            EVALUATE_EXPRESSION = nativeLib.find("wasmtime4j_debug_evaluate_expression")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_evaluate_expression"));

            INSPECT_MEMORY = nativeLib.find("wasmtime4j_debug_inspect_memory")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
            ...
            STEP_INTO = nativeLib.find("wasmtime4j_debug_step_into")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_step_into"));

            STEP_OVER = nativeLib.find("wasmtime4j_debug_step_over")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_step_over"));

            STEP_OUT = nativeLib.find("wasmtime4j_debug_step_out")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_step_out"));

            CONTINUE_EXECUTION = nativeLib.find("wasmtime4j_debug_continue")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_continue"));

            ENABLE_DWARF = nativeLib.find("wasmtime4j_debug_enable_dwarf")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.ofVoid(ADDRESS, JAVA_BOOLEAN)))
                    .orElseThrow(() -> new UnsatisfiedLinkError("wasmtime4j_debug_enable_dwarf"));

            IS_DWARF_ENABLED = nativeLib.find("wasmtime4j_debug_is_dwarf_enabled")
                    .map(addr -> Linker.nativeLinker().downcallHandle(addr,
                            FunctionDescriptor.of(JAVA_BOOLEAN, ADDRESS)))
    ...
    public Optional<DwarfDebugInfo> getDwarfInfo(final Module module) {
        ...
        try {
            ...
            final MemorySegment dwarfInfoPtr = (MemorySegment) GET_DWARF_INFO.invokeExact(nativeHandle, moduleHandle);
     ...
     */
    public SourceMapIntegration createSourceMapIntegration(final String sourceMapData) throws WasmException {
        ...
        try {
            ...
            final MemorySegment integrationPtr = (MemorySegment) CREATE_SOURCE_MAP_INTEGRATION.invokeExact(nativeHandle, sourceMapStr);
    ...
    public ExecutionTracer createExecutionTracer(final Instance instance) throws WasmException {
        ...
        try {
            final MemorySegment instanceHandle = extractInstanceHandle(instance);
            final MemorySegment tracerPtr = (MemorySegment) CREATE_EXECUTION_TRACER.invokeExact(nativeHandle, instanceHandle);
     ...
     */
    public void startProfiling(final boolean cpuProfiling, final boolean memoryProfiling) throws WasmException {
        validateNotClosed();

        try {
            START_PROFILING.invokeExact(nativeHandle, cpuProfiling, memoryProfiling);
            profilingEnabled = true;
            LOGGER.log(Level.FINE, "Started profiling (CPU: {0}, Memory: {1})",
     ...
     */
    public long setBreakpointAtAddress(final Instance instance, final int address) throws WasmException {
        Objects.requireNonNull(instance, "instance cannot be null");
        validateNotClosed();
     ...
     * @throws WasmException if breakpoint cannot be set
     */
    public long setBreakpointAtFunction(final Instance instance, final String functionName) throws WasmException {
        Objects.requireNonNull(instance, "instance cannot be null");
        ...
        try {
            ...
            return (long) SET_BREAKPOINT_AT_FUNCTION.invokeExact(nativeHandle, instanceHandle, functionNameStr);
        } catch (final Throwable e) {
     ...
     * @throws WasmException if breakpoint cannot be set
     */
    public long setBreakpointAtLine(final Instance instance, final String fileName, final int lineNumber)
        ...
        try {
            ...
            return (long) SET_BREAKPOINT_AT_LINE.invokeExact(nativeHandle, instanceHandle, fileNameStr, lineNumber);
        } catch (final Throwable e) {
    ...
    public List<StackFrame> getCallStack(final Instance instance) throws WasmException {
        ...
        try {
            final MemorySegment instanceHandle = extractInstanceHandle(instance);
            final MemorySegment stackPtr = (MemorySegment) GET_CALL_STACK.invokeExact(nativeHandle, instanceHandle);
     ...
     */
    public List<Variable> getLocalVariables(final Instance instance, final int frameIndex) throws WasmException {
        Objects.requireNonNull(instance, "instance cannot be null");
        validateNotClosed();

        try {
            final MemorySegment instanceHandle = extractInstanceHandle(instance);
            final MemorySegment variablesPtr = (MemorySegment) GET_LOCAL_VARIABLES.invokeExact(nativeHandle, instanceHandle, frameIndex);
     ...
     */
    public VariableValue evaluateExpression(final Instance instance, final String expression) throws WasmException {
        Objects.requireNonNull(instance, "instance cannot be null");
        ...
        try {
            ...
            final MemorySegment resultPtr = (MemorySegment) EVALUATE_EXPRESSION.invokeExact(nativeHandle, instanceHandle, expressionStr);
    ...
    public MemoryInfo inspectMemory(final Instance instance, final int address, final int length)
        ...
        try {
            final MemorySegment instanceHandle = extractInstanceHandle(instance);
            final MemorySegment memoryPtr = (MemorySegment) INSPECT_MEMORY.invokeExact(nativeHandle, instanceHandle, address, length);
    ...
    public ExecutionResult stepInto(final Instance instance) throws WasmException {
        ...
        try {
            final MemorySegment instanceHandle = extractInstanceHandle(instance);
            final MemorySegment resultPtr = (MemorySegment) STEP_INTO.invokeExact(nativeHandle, instanceHandle);
    ...
    public ExecutionResult stepOver(final Instance instance) throws WasmException {
        ...
        try {
            final MemorySegment instanceHandle = extractInstanceHandle(instance);
            final MemorySegment resultPtr = (MemorySegment) STEP_OVER.invokeExact(nativeHandle, instanceHandle);
            return deserializeExecutionResult(resultPtr);
        } catch (final Throwable e) {
    ...
    public ExecutionResult stepOut(final Instance instance) throws WasmException {
        ...
        try {
            final MemorySegment instanceHandle = extractInstanceHandle(instance);
            final MemorySegment resultPtr = (MemorySegment) STEP_OUT.invokeExact(nativeHandle, instanceHandle);
            return deserializeExecutionResult(resultPtr);
        } catch (final Throwable e) {
    ...
    public ExecutionResult continueExecution(final Instance instance) throws WasmException {
        ...
        try {
            final MemorySegment instanceHandle = extractInstanceHandle(instance);
            final MemorySegment resultPtr = (MemorySegment) CONTINUE_EXECUTION.invokeExact(nativeHandle, instanceHandle);
            return deserializeExecutionResult(resultPtr);
        } catch (final Throwable e) {
    ...
    private DwarfDebugInfo deserializeDwarfInfo(final MemorySegment ptr) {
        // For now, create a simple DWARF info - real implementation would deserialize from native structure
        try {
    ...
    private SourceMapIntegration deserializeSourceMapIntegration(final MemorySegment ptr) {
        ...
        return new SourceMapIntegration() {
            ...
            @Override
            public Optional<Integer> mapSourcePosition(final String fileName, final int line, final int column) {
                return Optional.empty();
            }
