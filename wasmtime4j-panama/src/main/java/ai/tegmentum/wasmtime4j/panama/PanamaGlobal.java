 ...
 * 
 * <p>WebAssembly globals provide mutable or immutable values that can be accessed
 * by both WebAssembly code and host code. This implementation uses Panama FFI with
 * Stream 1 & 2 infrastructure for direct memory access to global values with
 * zero-copy operations and comprehensive type safety.</p>
 * 
 * <p>Global value access includes type validation, mutability checking, and
 * automatic conversion between Java and WebAssembly value types. All operations
...
public final class PanamaGlobal implements Global, AutoCloseable {
     ...
     */
    public PanamaGlobal(final MemorySegment globalPtr,
        ...
        try {
            ...
            this.globalResource = resourceManager.manageNativeResource(
                globalPtr,
                () -> destroyNativeGlobalInternal(globalPtr),
                "Wasmtime Global"
            );
    ...
    public Object getValue() throws WasmException {
        ...
        try {
            ...
            MethodHandle globalGet = nativeFunctions.getFunction(
                "wasmtime_global_get",
            ...
            String detailedMessage = PanamaErrorHandler.createDetailedErrorMessage(
                "Global value get", 
                "global=" + globalResource.getNativePointer(), 
                e.getMessage()
            );
    ...
    public void setValue(final Object value) throws WasmException {
        ...
        try {
            ...
            MethodHandle globalSet = nativeFunctions.getFunction(
                "wasmtime_global_set",
                FunctionDescriptor.ofVoid(
                    ValueLayout.ADDRESS, // global
    ...
    private void initializeGlobalType() throws WasmException {
        try {
            ...
            LOGGER.fine("Initialized global type: type=" + MemoryLayouts.valkindToString(valueType) + 
                       ", mutable=" + mutable);
    ...
    private MemorySegment getGlobalType() throws Exception {
        ...
        MethodHandle globalType = nativeFunctions.getFunction(
     ...
     */
    private void marshalValue(final Object javaValue, final int wasmType, final MemorySegment valueSlot) {
