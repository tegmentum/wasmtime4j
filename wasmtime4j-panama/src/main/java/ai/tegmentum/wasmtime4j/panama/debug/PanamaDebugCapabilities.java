...
/**
 * Panama implementation of debug capabilities.
 *
 ...
 * @since 1.0.0
 */
public final class PanamaDebugCapabilities implements DebugCapabilities {
  ...
  private PanamaDebugCapabilities(final Builder builder) {
   ...
   */
  public static PanamaDebugCapabilities getDefault() {
  ...
  public String toString() {
    return "PanamaDebugCapabilities{"
        + "breakpoints="
  ...
  public static final class Builder {
     ...
     */
    public PanamaDebugCapabilities build() {
      return new PanamaDebugCapabilities(this);
    }
  }
}
