 ...
 *
 * <p>This class provides automatic resource cleanup and lifecycle management for native
 * resources using Arena-based memory allocation. It ensures proper cleanup of native
 * resources to prevent memory leaks and provides comprehensive tracking capabilities.
 *
 * <p>The resource manager uses Java's Cleaner API as a safety net for resources that
 * are not properly closed, while encouraging explicit resource management through
...
public final class ArenaResourceManager implements AutoCloseable {
    ...
    public ManagedMemorySegment allocate(final long size, final long alignment) {
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Failed to allocate memory: size=" + size + 
     ...
     * @throws IllegalStateException if the manager is closed
     */
    public ManagedNativeResource manageNativeResource(final MemorySegment nativePointer,
        ...
        if (trackingEnabled) {
            ...
            ManagedResource managedResource = new ManagedResource(resourceId, description, 
    ...
    public String getResourceTrackingInfo() {
        ...
        resources.forEach((id, resource) -> {
            ...
            sb.append("  - ID ").append(id)
              .append(": ").append(resource.getDescription())
    ...
    public void close() {
        ...
        try {
            ...
            if (trackingEnabled && !resources.isEmpty()) {
                LOGGER.warning("Closing resource manager with " + resources.size() + 
     ...
     * @return managed memory segment
     */
    private ManagedMemorySegment createManagedSegment(final MemorySegment segment, 
                                                     final String description) {
    ...
    public static final class ManagedMemorySegment {
        ...
        public String toString() {
            return "ManagedMemorySegment{description='" + description + "', size=" + 
                   segment.byteSize() + "}";
        }
    }
    ...
    public static final class ManagedNativeResource implements AutoCloseable {
        ...
        private ManagedNativeResource(final MemorySegment nativePointer,
                                     final Runnable cleanup,
                                     final String description) {
