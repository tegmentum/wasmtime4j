...
/**
 * Panama implementation of complete WASI Preview 1 operations.
 *
 ...
 * WebAssembly modules to interact with system resources through the WASI runtime using Panama FFI.
 *
...
public final class WasiPreview1Operations {
  ...
  public WasiPreview1Operations(final WasiContext wasiContext) {
    ...
    LOGGER.info("Created Panama WASI Preview 1 operations handler");
  }
  ...
  public int fdRead(final int fd, final List<ByteBuffer> iovs) {
    PanamaValidation.requireNonNull(iovs, "iovs");
    ...
    try {
      ...
      throw new WasiException("fd_read failed: " + e.getMessage());
    }
  }
  ...
  public int fdWrite(final int fd, final List<ByteBuffer> iovs) {
    ...
    try {
      ...
      throw new WasiException("fd_write failed: " + e.getMessage());
    }
  }
  ...
  public long fdSeek(final int fd, final long offset, final int whence) {
    ...
    try {
      ...
      throw new WasiException("fd_seek failed: " + e.getMessage());
    }
  }
  ...
  public void fdClose(final int fd) {
    ...
    try {
      ...
      throw new WasiException("fd_close failed: " + e.getMessage());
    }
  }
  ...
  public int pathOpen(
    ...
    try {
      ...
      throw new WasiException("path_open failed: " + e.getMessage());
    }
  }
  ...
  public void pathCreateDirectory(final int dirfd, final String path) {
    ...
    try {
      ...
      throw new WasiException("path_create_directory failed: " + e.getMessage());
    }
  }
  ...
  public int environGet(final ByteBuffer environ, final ByteBuffer environBuf) {
    PanamaValidation.requireNonNull(environ, "environ");
    PanamaValidation.requireNonNull(environBuf, "environBuf");
  ...
  public int[] environSizesGet() {
    ...
    try {
      ...
      throw new WasiException("environ_sizes_get failed: " + e.getMessage());
    }
  }
  ...
  public int argsGet(final ByteBuffer argv, final ByteBuffer argvBuf) {
    PanamaValidation.requireNonNull(argv, "argv");
    PanamaValidation.requireNonNull(argvBuf, "argvBuf");
  ...
  public int[] argsSizesGet() {
    ...
    try {
      ...
      throw new WasiException("args_sizes_get failed: " + e.getMessage());
    }
  }
  ...
  public long clockTimeGet(final int clockId, final long precision) {
    ...
    try {
      ...
      throw new WasiException("clock_time_get failed: " + e.getMessage());
    }
  }
  ...
  public long clockResGet(final int clockId) {
    ...
    try {
      ...
      throw new WasiException("clock_res_get failed: " + e.getMessage());
    }
  }
  ...
  public void randomGet(final ByteBuffer buffer) {
    ...
    try {
      ...
      throw new WasiException("random_get failed: " + e.getMessage());
    }
  }
  ...
  private void validateFileDescriptor(final int fd) {
    if (fd < 0) {
      throw new WasiException("Invalid file descriptor: " + fd);
    }
  }
  ...
  private void validateWhence(final int whence) {
    if (whence < 0 || whence > 2) {
      throw new WasiException("Invalid whence value: " + whence);
    }
  }
