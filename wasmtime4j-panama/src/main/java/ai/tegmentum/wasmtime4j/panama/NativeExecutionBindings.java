 ...
 * collector, pooling allocator, trap introspection, serializer, async runtime, coredump, WASI
...
public final class NativeExecutionBindings extends NativeBindingsBase {
  ...
  private void initializeBindings() {
    ...
    addFunctionBinding(
        "wasmtime4j_async_runtime_init",
        FunctionDescriptor.of(ValueLayout.JAVA_INT)); // return code

    addFunctionBinding(
        "wasmtime4j_async_runtime_info",
        FunctionDescriptor.of(ValueLayout.ADDRESS)); // returns info string*

    addFunctionBinding(
        "wasmtime4j_async_runtime_shutdown",
        FunctionDescriptor.of(ValueLayout.JAVA_INT)); // return code

    addFunctionBinding(
        "wasmtime4j_func_call_async",
        FunctionDescriptor.of(
            ValueLayout.JAVA_INT, // operation ID or error
            ValueLayout.ADDRESS, // instance_ptr
            ValueLayout.ADDRESS, // function_name (C string)
            ValueLayout.ADDRESS, // args_ptr
            ValueLayout.JAVA_INT, // args_len
            ValueLayout.JAVA_LONG, // timeout_ms
