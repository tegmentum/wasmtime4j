 ...
 * 
 * <p>This class tracks native resources and their associated Java objects
 * to ensure proper cleanup and prevent resource leaks. It uses weak references
 * to avoid preventing garbage collection of tracked objects.</p>
 * 
 * <p>The tracker helps identify resource leaks during development and provides
 * statistics about resource usage patterns.</p>
 * 
 * @since 1.0.0
 */
public final class PanamaResourceTracker {
    ...
    public void trackResource(final Object resource, final MemorySegment handle) {
        ...
        logger.fine("Tracking resource: " + resource.getClass().getSimpleName() + 
     ...
     * 
     * <p>This method should be called periodically to clean up tracking
     * information for objects that have been garbage collected but were
     * not properly untracked.</p>
     * 
     ...
     * 
     * <p>This method should be called when shutting down the runtime
     * to ensure all resources are properly cleaned up.</p>
     */
    public void cleanup() {
     ...
     * 
     * <p>This is the difference between total tracked and total cleaned resources.</p>
     * 
