 ...
 * All layouts are designed for direct memory access through MemorySegment operations and
 * provide type-safe access to native structure fields.
 *
 * <p>Layout definitions follow Wasmtime C API structure alignment and padding requirements
 * to ensure binary compatibility across all supported platforms.
 */
public final class MemoryLayouts {
     ...
     * </pre>
     */
    public static final StructLayout WASMTIME_ERROR = MemoryLayout.structLayout(
    ...
    public static final VarHandle WASMTIME_ERROR_CODE = WASMTIME_ERROR.varHandle(
        MemoryLayout.PathElement.groupElement("code"));
    public static final VarHandle WASMTIME_ERROR_MESSAGE = WASMTIME_ERROR.varHandle(
        MemoryLayout.PathElement.groupElement("message"));
    public static final VarHandle WASMTIME_ERROR_MESSAGE_LEN = WASMTIME_ERROR.varHandle(
        MemoryLayout.PathElement.groupElement("message_len"));
     ...
     * </pre>
     */
    public static final UnionLayout WASM_VAL_VALUE = MemoryLayout.unionLayout(
     ...
     * </pre>
     */
    public static final StructLayout WASM_VAL = MemoryLayout.structLayout(
    ...
    public static final VarHandle WASM_VAL_KIND = WASM_VAL.varHandle(
        MemoryLayout.PathElement.groupElement("kind"));
    public static final VarHandle WASM_VAL_I32 = WASM_VAL.varHandle(
        MemoryLayout.PathElement.groupElement("of"),
        MemoryLayout.PathElement.groupElement("i32"));
    public static final VarHandle WASM_VAL_I64 = WASM_VAL.varHandle(
        MemoryLayout.PathElement.groupElement("of"),
        MemoryLayout.PathElement.groupElement("i64"));
    public static final VarHandle WASM_VAL_F32 = WASM_VAL.varHandle(
        MemoryLayout.PathElement.groupElement("of"),
        MemoryLayout.PathElement.groupElement("f32"));
    public static final VarHandle WASM_VAL_F64 = WASM_VAL.varHandle(
        MemoryLayout.PathElement.groupElement("of"),
        MemoryLayout.PathElement.groupElement("f64"));
    public static final VarHandle WASM_VAL_REF = WASM_VAL.varHandle(
        MemoryLayout.PathElement.groupElement("of"),
     ...
     * </pre>
     */
    public static final StructLayout WASM_BYTE_VEC = MemoryLayout.structLayout(
        C_SIZE_T.withName("size"),
        C_POINTER.withName("data")
    ).withName("wasm_byte_vec_t");

    // VarHandles for WASM_BYTE_VEC
    public static final VarHandle WASM_BYTE_VEC_SIZE = WASM_BYTE_VEC.varHandle(
        MemoryLayout.PathElement.groupElement("size"));
    public static final VarHandle WASM_BYTE_VEC_DATA = WASM_BYTE_VEC.varHandle(
     ...
     * </pre>
     */
    public static final StructLayout WASM_VAL_VEC = MemoryLayout.structLayout(
        C_SIZE_T.withName("size"),
        C_POINTER.withName("data")
    ).withName("wasm_val_vec_t");

    // VarHandles for WASM_VAL_VEC
    public static final VarHandle WASM_VAL_VEC_SIZE = WASM_VAL_VEC.varHandle(
        MemoryLayout.PathElement.groupElement("size"));
    public static final VarHandle WASM_VAL_VEC_DATA = WASM_VAL_VEC.varHandle(
        MemoryLayout.PathElement.groupElement("data"));
     ...
     * </pre>
     */
    public static final StructLayout WASM_FUNCTYPE = MemoryLayout.structLayout(
        WASM_VAL_VEC.withName("params"),
        WASM_VAL_VEC.withName("results")
    ).withName("wasm_functype_t");

    // VarHandles for WASM_FUNCTYPE
    public static final VarHandle WASM_FUNCTYPE_PARAMS = WASM_FUNCTYPE.varHandle(
        MemoryLayout.PathElement.groupElement("params"));
    public static final VarHandle WASM_FUNCTYPE_RESULTS = WASM_FUNCTYPE.varHandle(
     ...
     * </pre>
     */
    public static final StructLayout WASM_GLOBALTYPE = MemoryLayout.structLayout(
        WASM_VALKIND.withName("content"),
        ValueLayout.JAVA_INT.withName("mutability")
    ).withName("wasm_globaltype_t");

    // VarHandles for WASM_GLOBALTYPE
    public static final VarHandle WASM_GLOBALTYPE_CONTENT = WASM_GLOBALTYPE.varHandle(
        MemoryLayout.PathElement.groupElement("content"));
    public static final VarHandle WASM_GLOBALTYPE_MUTABILITY = WASM_GLOBALTYPE.varHandle(
        MemoryLayout.PathElement.groupElement("mutability"));
     ...
     * </pre>
     */
    public static final StructLayout WASM_LIMITS = MemoryLayout.structLayout(
    ...
    public static final VarHandle WASM_LIMITS_MIN = WASM_LIMITS.varHandle(
        MemoryLayout.PathElement.groupElement("min"));
    public static final VarHandle WASM_LIMITS_MAX = WASM_LIMITS.varHandle(
        MemoryLayout.PathElement.groupElement("max"));
    public static final VarHandle WASM_LIMITS_HAS_MAX = WASM_LIMITS.varHandle(
        MemoryLayout.PathElement.groupElement("has_max"));
     ...
     * </pre>
     */
    public static final StructLayout WASM_MEMORYTYPE = MemoryLayout.structLayout(
        WASM_LIMITS.withName("limits")
    ).withName("wasm_memorytype_t");

    // VarHandles for WASM_MEMORYTYPE
    public static final VarHandle WASM_MEMORYTYPE_LIMITS = WASM_MEMORYTYPE.varHandle(
     ...
     * </pre>
     */
    public static final StructLayout WASM_TABLETYPE = MemoryLayout.structLayout(
    ...
    public static final VarHandle WASM_TABLETYPE_ELEMENT = WASM_TABLETYPE.varHandle(
        MemoryLayout.PathElement.groupElement("element"));
    public static final VarHandle WASM_TABLETYPE_LIMITS = WASM_TABLETYPE.varHandle(
        MemoryLayout.PathElement.groupElement("limits"));
     ...
     * </pre>
     */
    public static final StructLayout WASM_IMPORTTYPE = MemoryLayout.structLayout(
    ...
    public static final VarHandle WASM_IMPORTTYPE_MODULE = WASM_IMPORTTYPE.varHandle(
        MemoryLayout.PathElement.groupElement("module"));
    public static final VarHandle WASM_IMPORTTYPE_NAME = WASM_IMPORTTYPE.varHandle(
        MemoryLayout.PathElement.groupElement("name"));
    public static final VarHandle WASM_IMPORTTYPE_TYPE = WASM_IMPORTTYPE.varHandle(
     ...
     * </pre>
     */
    public static final StructLayout WASM_EXPORTTYPE = MemoryLayout.structLayout(
        WASM_BYTE_VEC.withName("name"),
        C_POINTER.withName("type")
    ).withName("wasm_exporttype_t");

    // VarHandles for WASM_EXPORTTYPE
    public static final VarHandle WASM_EXPORTTYPE_NAME = WASM_EXPORTTYPE.varHandle(
        MemoryLayout.PathElement.groupElement("name"));
    public static final VarHandle WASM_EXPORTTYPE_TYPE = WASM_EXPORTTYPE.varHandle(
        MemoryLayout.PathElement.groupElement("type"));
     ...
     * </pre>
     */
    public static final StructLayout WASMTIME_CONFIG = MemoryLayout.structLayout(
    ...
    public static final VarHandle WASMTIME_CONFIG_DEBUG_INFO = WASMTIME_CONFIG.varHandle(
        MemoryLayout.PathElement.groupElement("debug_info"));
    public static final VarHandle WASMTIME_CONFIG_CONSUME_FUEL = WASMTIME_CONFIG.varHandle(
        MemoryLayout.PathElement.groupElement("consume_fuel"));
    public static final VarHandle WASMTIME_CONFIG_EPOCH_INTERRUPTION = WASMTIME_CONFIG.varHandle(
        MemoryLayout.PathElement.groupElement("epoch_interruption"));
    public static final VarHandle WASMTIME_CONFIG_MAX_WASM_STACK = WASMTIME_CONFIG.varHandle(
        MemoryLayout.PathElement.groupElement("max_wasm_stack"));
    public static final VarHandle WASMTIME_CONFIG_PARALLEL_COMPILATION = WASMTIME_CONFIG.varHandle(
        MemoryLayout.PathElement.groupElement("parallel_compilation"));
