...
/**
 * Panama implementation of {@link WasiHttpConfig}.
 *
 * <p>This class provides an immutable configuration for WASI HTTP contexts. Instances are created
 * via the {@link PanamaWasiHttpConfigBuilder}.
 */
public final class PanamaWasiHttpConfig implements WasiHttpConfig {
  ...
  /**
   * Creates a new PanamaWasiHttpConfig with the specified settings.
   *
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof PanamaWasiHttpConfig)) {
      return false;
    }
    final PanamaWasiHttpConfig that = (PanamaWasiHttpConfig) o;
