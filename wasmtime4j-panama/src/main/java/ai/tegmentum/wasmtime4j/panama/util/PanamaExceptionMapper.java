 ...
 * 
 * <p>This class maps native errors and Java exceptions to the appropriate
 * WebAssembly exception hierarchy. It provides centralized exception handling
 * and ensures consistent error reporting across the Panama implementation.</p>
 * 
 * <p>The mapper handles both exceptions thrown by FFI operations and native
 * error codes returned by Wasmtime functions.</p>
 * 
 * @since 1.0.0
 */
public final class PanamaExceptionMapper {
     ...
     * 
     * <p>This method interprets Wasmtime error codes and creates appropriate
     * WebAssembly exceptions. Error codes are typically returned by native
     * Wasmtime functions to indicate various failure conditions.</p>
     * 
     ...
     * 
     * <p>Many Wasmtime functions return error pointers instead of error codes.
     * This method extracts error information from such pointers and creates
     * appropriate exceptions.</p>
     * 
     ...
     */
    public CompilationException createCompilationException(final String message, final Throwable cause) {
     ...
     */
    public ValidationException createValidationException(final String message, final Throwable cause) {
     ...
     * 
     * <p>Some errors may be recoverable or represent expected failure
     * conditions (e.g., function not found). This method helps identify
     * such cases.</p>
     * 
