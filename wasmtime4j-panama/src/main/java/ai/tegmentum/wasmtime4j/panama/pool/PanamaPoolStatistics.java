...
public final class PanamaPoolStatistics extends AbstractPoolStatistics {
  ...
  /**
   * Creates a new PanamaPoolStatistics from a metrics array returned by native code.
   *
   * @param metrics the 12-element metrics array from the Panama native call
   */
  public PanamaPoolStatistics(final long[] metrics) {
    super(metrics);
  }
