...
/**
 * Directory entry information for WASI directory listing operations in Panama FFI context.
 *
...
public final class WasiDirectoryEntry {
  ...
  public WasiDirectoryEntry(
    ...
    PanamaValidation.requireNonNull(lastModifiedTime, "lastModifiedTime");
