 ...
 * 
 * <p>This class provides type-safe function descriptors for all Wasmtime C API
 * functions used by the Panama implementation. Function descriptors define the
 * parameter types, return types, and calling conventions for native functions.</p>
 * 
 * <p>Descriptors are cached for performance and reuse across multiple FFI calls.</p>
 * 
 * @since 1.0.0
 */
public final class FunctionDescriptors {
     ...
     * 
     * <p>Signature: {@code wasmtime_engine_t* wasmtime_engine_new(void)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeEngineNew() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_engine_new", 
            key -> FunctionDescriptor.of(ValueLayout.ADDRESS));
    }

    /**
     * Function descriptor for wasmtime_engine_delete().
     * 
     * <p>Signature: {@code void wasmtime_engine_delete(wasmtime_engine_t* engine)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeEngineDelete() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_engine_delete", 
            key -> FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
    }
     ...
     * 
     * <p>Signature: {@code wasmtime_module_t* wasmtime_module_new(wasmtime_engine_t* engine, 
     * const uint8_t* wasm, size_t wasm_len)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeModuleNew() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_module_new", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code void wasmtime_module_delete(wasmtime_module_t* module)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeModuleDelete() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_module_delete", 
            key -> FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
    }
     ...
     * 
     * <p>Signature: {@code size_t wasmtime_module_serialize(wasmtime_module_t* module, 
     * uint8_t* buffer, size_t buffer_len)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeModuleSerialize() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_module_serialize", 
            key -> FunctionDescriptor.of(
     ...
     * const wasmtime_extern_t* imports, size_t imports_len)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeInstanceNew() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_instance_new", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code void wasmtime_instance_delete(wasmtime_instance_t* instance)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeInstanceDelete() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_instance_delete", 
            key -> FunctionDescriptor.ofVoid(ValueLayout.ADDRESS));
    }
     ...
     * 
     * <p>Signature: {@code bool wasmtime_instance_export_get(wasmtime_instance_t* instance, 
     * const char* name, wasmtime_extern_t* out)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeInstanceExportGet() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_instance_export_get", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code wasmtime_memory_t* wasmtime_memory_new(uint32_t initial, uint32_t maximum)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeMemoryNew() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_memory_new", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code uint32_t wasmtime_memory_size(wasmtime_memory_t* memory)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeMemorySize() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_memory_size", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code bool wasmtime_memory_grow(wasmtime_memory_t* memory, uint32_t pages)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeMemoryGrow() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_memory_grow", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code uint8_t* wasmtime_memory_data(wasmtime_memory_t* memory)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeMemoryData() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_memory_data", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code wasmtime_error_t* wasmtime_func_call(wasmtime_func_t* func, 
     * const wasmtime_val_t* args, size_t args_len, wasmtime_val_t* results, size_t results_len)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeFuncCall() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_func_call", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code void wasmtime_global_get(wasmtime_global_t* global, wasmtime_val_t* out)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeGlobalGet() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_global_get", 
            key -> FunctionDescriptor.ofVoid(
     ...
     * 
     * <p>Signature: {@code void wasmtime_global_set(wasmtime_global_t* global, const wasmtime_val_t* val)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeGlobalSet() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_global_set", 
            key -> FunctionDescriptor.ofVoid(
                ValueLayout.ADDRESS, // global pointer
     ...
     * 
     * <p>Signature: {@code uint32_t wasmtime_table_size(wasmtime_table_t* table)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeTableSize() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_table_size", 
            key -> FunctionDescriptor.of(
     ...
     * 
     * <p>Signature: {@code bool wasmtime_table_get(wasmtime_table_t* table, uint32_t index, wasmtime_val_t* out)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeTableGet() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_table_get", 
            key -> FunctionDescriptor.of(
                ValueLayout.JAVA_BOOLEAN, // return: success
                ValueLayout.ADDRESS,      // table pointer
     ...
     * 
     * <p>Signature: {@code bool wasmtime_table_set(wasmtime_table_t* table, uint32_t index, const wasmtime_val_t* val)}</p>
     * 
     * @return the function descriptor
     */
    public static FunctionDescriptor wasmtimeTableSet() {
        return DESCRIPTOR_CACHE.computeIfAbsent("wasmtime_table_set", 
            key -> FunctionDescriptor.of(
                ValueLayout.JAVA_BOOLEAN, // return: success
                ValueLayout.ADDRESS,      // table pointer
                ValueLayout.JAVA_INT,     // index
