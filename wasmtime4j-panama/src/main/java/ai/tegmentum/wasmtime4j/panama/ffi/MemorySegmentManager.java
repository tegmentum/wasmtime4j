 ...
 * 
 * <p>This class provides convenient methods for creating, manipulating, and
 * converting between different memory representations used in WebAssembly
 * operations. It handles the complexity of Panama FFI memory management
 * while ensuring proper resource cleanup.</p>
 * 
 * <p>All memory segments created by this class are associated with the
 * provided Arena for automatic cleanup when the arena is closed.</p>
 * 
 * @since 1.0.0
 */
public final class MemorySegmentManager {
     ...
     * 
     * <p>The returned segment is a copy of the input data and is managed by
     * the arena for automatic cleanup.</p>
     * 
     ...
     * 
     * <p>For direct ByteBuffers, this attempts to create a segment that
     * references the same memory. For heap ByteBuffers, the data is copied.</p>
     * 
     ...
     * 
     * <p>This creates a copy of the memory segment data as a Java byte array.</p>
     * 
     ...
     * 
     * <p>The returned ByteBuffer provides a view of the memory segment data.
     * Changes to the ByteBuffer will be reflected in the memory segment and
     * vice versa.</p>
     * 
