...
/**
 * Panama Foreign Function Interface implementation of hot reload manager for dynamic
 * WebAssembly module updates (Java 23+).
 *
 * <p>This class provides comprehensive hot-reload capabilities using the Panama FFI,
 * offering better performance and type safety compared to JNI for Java 23+:
 * <ul>
...
public final class PanamaHotReloadManager implements AutoCloseable {
    ...
    private static final MemoryLayout SWAP_STATUS_LAYOUT = MemoryLayout.structLayout(
    ...
    private static final MemoryLayout METRICS_LAYOUT = MemoryLayout.structLayout(
    ...
    static {
        try {
            ...
            createHotReloadManager = linker.downcallHandle(
            ...
            destroyHotReloadManager = linker.downcallHandle(
                lookup.find("panama_destroy_hot_reload_manager").orElseThrow(),
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS)
            );

            startHotSwap = linker.downcallHandle(
            ...
            getSwapStatus = linker.downcallHandle(
            ...
            cancelHotSwap = linker.downcallHandle(
            ...
            loadComponentAsync = linker.downcallHandle(
            ...
            getHotReloadMetrics = linker.downcallHandle(
            ...
            freeSwapStatus = linker.downcallHandle(
    ...
    public PanamaHotReloadManager(final PanamaEngine engine, final HotReloadConfig config) {
        ...
        try {
            this.nativeHandle = (MemorySegment) createHotReloadManager.invoke(
    ...
    public String startHotSwap(final String componentName, final String targetVersion,
        ...
        try (final Arena localArena = Arena.ofConfined()) {
            ...
            final int result = (int) startHotSwap.invoke(
                nativeHandle,
                nameSegment,
                versionSegment,
    ...
    public HotSwapStatus getSwapStatus(final String operationId) {
        ...
        try (final Arena localArena = Arena.ofConfined()) {
            ...
            final int result = (int) getSwapStatus.invoke(
                nativeHandle,
                operationIdSegment,
                statusSegment
            );
            ...
            final MemorySegment fromVersionPtr = statusSegment.get(ValueLayout.ADDRESS, ValueLayout.ADDRESS.byteSize());
            final MemorySegment toVersionPtr = statusSegment.get(ValueLayout.ADDRESS, ValueLayout.ADDRESS.byteSize() * 2);
            ...
            final int status = statusSegment.get(ValueLayout.JAVA_INT, ValueLayout.ADDRESS.byteSize() * 3);
            final float progress = statusSegment.get(ValueLayout.JAVA_FLOAT, ValueLayout.ADDRESS.byteSize() * 3 + ValueLayout.JAVA_INT.byteSize());

            final HotSwapStatus hotSwapStatus = new HotSwapStatus(operationId, componentName, fromVersion, toVersion, status, progress);
    ...
    public boolean cancelHotSwap(final String operationId) {
        ...
        try (final Arena localArena = Arena.ofConfined()) {
            ...
            final int result = (int) cancelHotSwap.invoke(
                nativeHandle,
                operationIdSegment
            );
    ...
    public CompletableFuture<String> loadComponentAsync(final LoadRequest request) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                try (final Arena localArena = Arena.ofConfined()) {
                    final MemorySegment nameSegment = localArena.allocateUtf8String(request.getComponentName());
                    final MemorySegment pathSegment = localArena.allocateUtf8String(request.getComponentPath());
                    final MemorySegment versionSegment = localArena.allocateUtf8String(request.getVersion());
                    final MemorySegment requestIdPtr = localArena.allocate(ValueLayout.ADDRESS);

                    final int result = (int) loadComponentAsync.invoke(
                        nativeHandle,
                        nameSegment,
                        pathSegment,
                        versionSegment,
    ...
    public HotReloadMetrics getMetrics() {
        ...
        try (final Arena localArena = Arena.ofConfined()) {
            ...
            final int result = (int) getHotReloadMetrics.invoke(
                nativeHandle,
                metricsSegment
            );
    ...
    public static final class HotReloadConfig {
        ...
        public static HotReloadConfig getDefault() { return builder().build(); }
        ...
        public static final class Builder {
            ...
            public Builder validationEnabled(final boolean enabled) { this.validationEnabled = enabled; return this; }
            public Builder statePreservationEnabled(final boolean enabled) { this.statePreservationEnabled = enabled; return this; }
            public Builder debounceDelayMs(final long delayMs) { this.debounceDelayMs = delayMs; return this; }
            public Builder precompilationEnabled(final boolean enabled) { this.precompilationEnabled = enabled; return this; }
            public Builder maxReloadAttempts(final int attempts) { this.maxReloadAttempts = attempts; return this; }
            public Builder healthCheckIntervalSecs(final long intervalSecs) { this.healthCheckIntervalSecs = intervalSecs; return this; }
            public Builder loaderThreadCount(final int threadCount) { this.loaderThreadCount = threadCount; return this; }
            public Builder cacheSize(final int size) { this.cacheSize = size; return this; }

            public HotReloadConfig build() { return new HotReloadConfig(this); }
        }
    }
    ...
    public static abstract class SwapStrategy {
        ...
        public static SwapStrategy immediate() { return new SwapStrategy(0, 0, 0, 0.0) {}; }
        public static SwapStrategy canary(final float initialPercentage, final float incrementPercentage, final float successThreshold) {
            return new SwapStrategy(1, (long)(initialPercentage * 100), (long)(incrementPercentage * 100), successThreshold) {};
        }
        public static SwapStrategy blueGreen() { return new SwapStrategy(2, 0, 0, 0.0) {}; }
        ...
        public static SwapStrategy getDefault() { return canary(10.0f, 25.0f, 0.99f); }
    }
    ...
    public enum SwapStatus {
        PENDING, PRE_LOADING, VALIDATING, STARTING, TRAFFIC_SHIFTING, MONITORING,
        COMPLETED, FAILED, ROLLING_BACK, ROLLBACK_COMPLETED;
    ...
    public enum LoadPriority { LOW, NORMAL, HIGH, CRITICAL }
    ...
    public static final class ValidationConfig {
        ...
        public ValidationConfig(final boolean validateInterfaces, final boolean validateDependencies,
                              final boolean validateSecurity, final boolean validatePerformance, final long timeoutSecs) {
        ...
        public static ValidationConfig getDefault() { return new ValidationConfig(true, true, true, false, 30); }
