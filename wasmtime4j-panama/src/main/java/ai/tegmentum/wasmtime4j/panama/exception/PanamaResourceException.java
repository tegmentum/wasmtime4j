...
public final class PanamaResourceException extends PanamaException {
   ...
   *
   * @param message the error message
   * @param nativeErrorCode the native error code (included in message)
   */
  public PanamaResourceException(final String message, final int nativeErrorCode) {
    super(message + " (native error code: " + nativeErrorCode + ")");
  }

  /**
   * Creates a new Panama resource exception with the specified message, cause, and native error
   * code.
   *
   * @param message the error message
   * @param cause the underlying cause
  ...
  public PanamaResourceException(
    ...
    super(message + " (native error code: " + nativeErrorCode + ")", cause);
  }
}
