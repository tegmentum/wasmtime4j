...
/**
 * WebSocket handler for real-time collaboration between developers. Manages WebSocket connections
 * and message routing for collaborative debugging.
 */
@WebSocket
public final class CollaborationWebSocketHandler extends WebSocketAdapter {

  private static final Logger LOGGER =
      Logger.getLogger(CollaborationWebSocketHandler.class.getName());
  ...
  public void onWebSocketConnect(final Session session) {
    ...
    final CollaborationMessage welcome =
  ...
  public void onWebSocketClose(final int statusCode, final String reason) {
    ...
    if (session != null) {
      ...
      if (connection != null
          ...
          && connection.getDeveloperId() != null) {
  ...
  private void handleDeveloperJoined(
      ...
      final DeveloperConnection connection,
    ...
    if (sessionId != null && developerId != null && developerName != null) {
      ...
      // Send confirmation
      final CollaborationMessage response =
          new CollaborationMessage(
  ...
  private void handleDeveloperLeft(
      final Session session,
      final DeveloperConnection connection,
      final CollaborationMessage message) {
    if (connection.getSessionId() != null && connection.getDeveloperId() != null) {
      ...
      final CollaborationMessage response =
          new CollaborationMessage(
              CollaborationMessage.Type.DEVELOPER_LEFT, "system", Map.of("status", "left"));
  ...
  private void handleCursorMoved(
      final DeveloperConnection connection, final CollaborationMessage message) {
  ...
  private void handleDebugSessionStarted(
      final DeveloperConnection connection, final CollaborationMessage message) {
    if (connection.getSessionId() != null) {
  ...
  private void handleDebugControlChanged(
      final DeveloperConnection connection, final CollaborationMessage message) {
    if (connection.getSessionId() != null) {
      final CollaborationServer.CollaborationSession session =
          collaborationServer.getSessions().get(connection.getSessionId());
  ...
  private void handleAnalysisResultShared(
      final DeveloperConnection connection, final CollaborationMessage message) {
    if (connection.getSessionId() != null) {
