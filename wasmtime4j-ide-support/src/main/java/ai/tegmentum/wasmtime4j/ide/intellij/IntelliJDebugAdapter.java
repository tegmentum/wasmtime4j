 ...
 *
 * <p>This class provides integration with IntelliJ IDEA's debugging infrastructure, enabling
 * WebAssembly debugging through the IDE's native debugging interface. It bridges wasmtime4j
 * debugging capabilities with IntelliJ's debugging protocol.
 *
 * <p>Key features:
 *
 * <ul>
 *   <li>JDI (Java Debug Interface) integration for IntelliJ compatibility
 *   <li>WebAssembly source mapping to Java debugging constructs
 *   <li>Breakpoint synchronization with IntelliJ UI
 *   <li>Variable inspection through IntelliJ's variable explorer
 *   <li>Step debugging with IntelliJ's step controls
 *   <li>Memory and performance monitoring integration
 * </ul>
 *
 * <p>Example usage:
 *
...
public final class IntelliJDebugAdapter implements DebugEventListener, AutoCloseable {
   ...
   */
  public IntelliJBreakpoint setBreakpoint(
      final String sourceFile, final int line, final String condition) throws WasmException {
    ...
    final IntelliJBreakpoint intellijBreakpoint =
        new IntelliJBreakpoint(
            wasmBreakpoint.getId(), sourceFile, line, condition, functionName, true);
  ...
  public List<IntelliJStackFrame> getStackTrace() throws WasmException {
    ...
    for (int i = 0; i < wasmFrames.size(); i++) {
      ...
      final IntelliJStackFrame intellijFrame =
          new IntelliJStackFrame(
              i,
  ...
  public static final class IntelliJBreakpoint {
    ...
    public IntelliJBreakpoint(
        final long wasmBreakpointId,
    ...
    public long getWasmBreakpointId() {
      return wasmBreakpointId;
    }
    ...
    public String toString() {
      return String.format(
          "IntelliJBreakpoint{id='%s', file='%s', line=%d, function='%s', enabled=%s}",
  ...
  public static final class IntelliJStackFrame {
    ...
    public String toString() {
      return String.format(
          "IntelliJStackFrame{id=%d, function='%s', file='%s', line=%d}",
  ...
  public static final class IntelliJVariable {
    ...
    public IntelliJVariable(
        final String name, final String type, final String value, final boolean mutable) {
      this.name = name;
      this.type = type;
      this.value = value;
    ...
    public String toString() {
      return String.format(
          "IntelliJVariable{name='%s', type='%s', value='%s', mutable=%s}",
  ...
  public static final class IntelliJEvaluationResult {
    ...
    public IntelliJEvaluationResult(
    ...
    public String toString() {
      return String.format(
          "IntelliJEvaluationResult{expression='%s', success=%s, value='%s', error='%s'}",
