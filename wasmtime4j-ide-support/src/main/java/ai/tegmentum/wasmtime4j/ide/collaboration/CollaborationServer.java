...
public final class CollaborationServer {
     ...
     */
    public CollaborationSession joinSession(final String sessionId,
        ...
        final CollaborationSession session = sessions.computeIfAbsent(sessionId,
            id -> new CollaborationSession(id, this));
    ...
    public static final class Developer {
        ...
        public void setCurrentFile(final String currentFile) { this.currentFile = currentFile; }
        public int getCursorLine() { return cursorLine; }
        public void setCursorLine(final int cursorLine) { this.cursorLine = cursorLine; }
        public int getCursorColumn() { return cursorColumn; }
        public void setCursorColumn(final int cursorColumn) { this.cursorColumn = cursorColumn; }
    ...
    public static final class CollaborationSession {
        ...
        public void addDeveloper(final Developer developer) {
            if (!isClosed && !developers.contains(developer)) {
                ...
                final CollaborationMessage message = new CollaborationMessage(
        ...
        public List<Developer> getDevelopers() { return Collections.unmodifiableList(developers); }
        public Map<String, SharedDocument> getSharedDocuments() { return Collections.unmodifiableMap(sharedDocuments); }
        public CollaborativeDebugger getDebugger() { return debugger; }
    ...
    public static final class SharedDocument {
        ...
        public List<DocumentChange> getChangeHistory() { return Collections.unmodifiableList(changeHistory); }
    }
    ...
    public static final class DocumentChange {
        ...
        public DocumentChange(final String developerId, final int version,
                            final int start, final int end, final String newText) {
    ...
    public static final class CollaborativeDebugger {
        ...
        public void releaseDebugControl(final String developerId) {
            if (developerId.equals(activeDebugger)) {
                ...
                final CollaborationMessage message = new CollaborationMessage(
                    CollaborationMessage.Type.DEBUG_CONTROL_RELEASED,
                    developerId,
                    Map.of()
                );
                session.broadcast(message);
        ...
        // Getters
        public String getActiveDebugger() { return activeDebugger; }
        public Map<String, DebugSession> getDebugSessions() { return Collections.unmodifiableMap(debugSessions); }
    }
    ...
    public static final class DebugSession {
        ...
        public void setActive(final boolean active) { isActive = active; }
    }
}