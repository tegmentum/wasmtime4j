...
/**
 * Provides comprehensive inspection capabilities for WebAssembly modules.
 * This class analyzes module structure, validates integrity, and provides
 * detailed information for IDE tooling and development support.
 */
public final class ModuleInspector {
    ...
    private void validateFunctionSignatures(final List<ValidationIssue> issues) {
        for (final Function function : functions) {
            ...
            if (function.getParameterTypes().contains(null)) {
                issues.add(new ValidationIssue(
                    IssueSeverity.HIGH,
                    "Function has null parameter type",
                    function.getIndex(),
                    0
                ));
            }
    ...
    private void validateImportsExports(final List<ValidationIssue> issues) {
        ...
        for (final Import imp : imports) {
            if (imp.getModuleName() == null || imp.getModuleName().trim().isEmpty()) {
                issues.add(new ValidationIssue(
                    IssueSeverity.HIGH,
                    "Import has no module name: " + imp.getName(),
                    0,
                    0
                ));
            }
        ...
        for (final Export export : exports) {
            if (exportMap.containsKey(export.getName())) {
                issues.add(new ValidationIssue(
                    ...
                    "Duplicate export name: " + export.getName(),
                    0,
                    0
                ));
            }
    ...
    private void validateMemoryTables(final List<ValidationIssue> issues) {
        ...
        for (final Memory memory : memories) {
            ...
            if (memory.getMaxPages() != null && memory.getMaxPages() < memory.getMinPages()) {
                issues.add(new ValidationIssue(
                    IssueSeverity.HIGH,
                    "Memory maximum pages less than minimum",
                    0,
                    0
                ));
            }
        ...
        for (final Table table : tables) {
            ...
            if (table.getMaxSize() != null && table.getMaxSize() < table.getMinSize()) {
                issues.add(new ValidationIssue(
                    IssueSeverity.HIGH,
                    "Table maximum size less than minimum",
                    0,
                    0
                ));
            }
    ...
    private void validateGlobals(final List<ValidationIssue> issues) {
        for (final Global global : globals) {
            if (global.getType() == null) {
                issues.add(new ValidationIssue(
                    IssueSeverity.HIGH,
                    "Global has null type: " + global.getName(),
                    0,
                    0
                ));
            }
    ...
    private void validateModuleStructure(final List<ValidationIssue> issues) {
        ...
        if (functions.isEmpty() && exports.isEmpty()) {
            issues.add(new ValidationIssue(
                IssueSeverity.LOW,
                "Module has no functions or exports",
                0,
                0
            ));
        }
    ...
    public static final class ModuleMetadata {
        ...
        public ModuleMetadata(final String name, final String version, final Map<String, String> customSections) {
            this.name = name;
        ...
        public Map<String, String> getCustomSections() { return customSections; }
    }
    ...
    public static final class Function {
        ...
        public Function(final int index, final String name, final List<WasmValue.Type> parameterTypes,
                       final List<WasmValue.Type> returnTypes, final boolean isImported) {
            this.index = index;
            this.name = name;
        ...
        public String getName() { return name; }
        public List<WasmValue.Type> getParameterTypes() { return parameterTypes; }
        public List<WasmValue.Type> getReturnTypes() { return returnTypes; }
    ...
    public static final class Import {
        ...
        public Import(final String moduleName, final String name, final ImportType type, final int index) {
    ...
    public static final class Global {
        ...
        public Global(final int index, final String name, final WasmValue.Type type,
                     final boolean isMutable, final boolean isImported) {
            this.index = index;
            this.name = name;
            this.type = type;
        ...
        public int getIndex() { return index; }
        public String getName() { return name; }
        public WasmValue.Type getType() { return type; }
    ...
    public static final class Memory {
        ...
        public Memory(final int index, final int minPages, final Integer maxPages,
                     final boolean isShared, final boolean isImported) {
            this.index = index;
    ...
    public static final class Table {
        ...
        public Table(final int index, final WasmValue.Type elementType, final int minSize,
                    final Integer maxSize, final boolean isImported) {
            this.index = index;
        ...
        public int getIndex() { return index; }
        public WasmValue.Type getElementType() { return elementType; }
    ...
    public static final class ValidationIssue {
        ...
        public ValidationIssue(final IssueSeverity severity, final String message,
    ...
    public static final class ModuleMetrics {
        ...
        public ModuleMetrics(final int functionCount, final int exportCount, final int importCount,
                            final int globalCount, final int memoryCount, final int tableCount,
