...
/**
 * Provides comprehensive debugging capabilities for WebAssembly modules during execution.
 * This class supports breakpoints, step-through debugging, variable inspection,
 * and runtime state analysis for IDE integration.
 */
public final class DebuggingSession implements AutoCloseable {
     ...
     */
    public DebuggingSession(final Engine engine, final Store store, final Module module,
                           final Instance instance, final DebuggerConfig config) {
    ...
    public int setBreakpoint(final int instructionOffset, final String condition) {
        ...
        final DebugEvent event = new DebugEvent(
    ...
    public static final class Breakpoint {
        ...
        public Breakpoint(final int id, final int instructionOffset, final String condition,
                         final boolean enabled, final int hitCount) {
            this.id = id;
    ...
    public static final class StepResult {
        ...
        public StepResult(final long instructionNumber, final String instruction,
        ...
        public long getInstructionNumber() { return instructionNumber; }
    ...
    public static final class StackFrame {
        ...
        public StackFrame(final String functionName, final int instructionOffset,
    ...
    public static final class ExecutionSnapshot {
        ...
        public ExecutionSnapshot(final long instructionNumber, final String currentInstruction,
                                final Map<String, Object> variables, final List<StackFrame> stack,
    ...
    public static final class DebugEvent {
        ...
        public DebugEvent(final DebugEventType type, final long timestamp,
                         final String message, final ExecutionSnapshot snapshot) {
            this.type = type;
            this.timestamp = timestamp;
    ...
    public static final class DebuggerConfig {
        ...
        public DebuggerConfig(final boolean enableInstructionTracing, final boolean enableMemoryWatching,
                             final boolean enablePerformanceMetrics, final int maxEventHistory) {
        ...
        public boolean isEnableInstructionTracing() { return enableInstructionTracing; }
        public boolean isEnableMemoryWatching() { return enableMemoryWatching; }
