 ...
 *
 * <p>This interface provides access to instruction metadata including opcode,
 * operands, and execution characteristics. It is used by optimization systems
 * and analysis tools.
 *
 * @since 1.1.0
 */
public interface WasmInstruction {
     ...
     */
    static WasmInstruction create(final int opcode,
     ...
     */
    private static StackEffect createStackEffect(final int opcode, final String mnemonic) {
        ...
        return new StackEffect() {
            ...
            public int getPops() {
                ...
                switch (opcode) {
                    ...
                    default:
                        if (mnemonic.startsWith("i32.") || mnemonic.startsWith("i64.") ||
                            mnemonic.startsWith("f32.") || mnemonic.startsWith("f64.")) {
                            if (mnemonic.contains("const")) return 0;
                            if (mnemonic.contains("load")) return 1;
                            if (mnemonic.contains("store")) return 2;
            ...
            public int getPushes() {
                ...
                switch (opcode) {
                    ...
                    case 0x0D: // br_if
                        return 0;
                    default:
                        if (mnemonic.contains("const") || mnemonic.contains("load")) return 1;
                        if (mnemonic.contains("store")) return 0;
                        if (mnemonic.startsWith("i32.") || mnemonic.startsWith("i64.") ||
                            mnemonic.startsWith("f32.") || mnemonic.startsWith("f64.")) {
    ...
    private static WasmValueType inferTypeFromMnemonic(final String mnemonic) {
        if (mnemonic.startsWith("i32.")) return WasmValueType.I32;
        if (mnemonic.startsWith("i64.")) return WasmValueType.I64;
        if (mnemonic.startsWith("f32.")) return WasmValueType.F32;
        if (mnemonic.startsWith("f64.")) return WasmValueType.F64;
