...
/**
 * Default pure Java implementation of SIMD operations.
 *
 ...
 *
 * <p>This class is shared between JNI and Panama runtimes as a fallback when native SIMD operations
 * are not available.
 *
 * @since 1.0.0
 */
public final class DefaultSimdOperations implements SimdOperations {
  private static final int V128_SIZE = 16; // 128 bits = 16 bytes

  /** Creates a default SIMD operations instance. */
  public DefaultSimdOperations() {}
  ...
  public String getSimdCapabilities() {
    return "Default SIMD: Arithmetic (add, subtract, multiply, divide, addSaturated), Bitwise (and,"
