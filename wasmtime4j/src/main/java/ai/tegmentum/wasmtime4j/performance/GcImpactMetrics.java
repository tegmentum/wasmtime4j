...
public final class GcImpactMetrics {
  ...
  public static final class Snapshot {
     ...
     * @param totalGcTime the total GC time
     * @param totalCollections the total number of collections
     * @param heapMemoryUsed the heap memory used
     * @param nonHeapMemoryUsed the non-heap memory used
     * @param maxHeapMemory the maximum heap memory
     * @param collectorSnapshots the collector snapshots
     */
    public Snapshot(
  ...
  public static final class GcCollectorSnapshot {
    ...
    /**
     * Creates a new GcCollectorSnapshot.
     *
     ...
     * @param memoryPoolNames the memory pool names
     */
  ...
  public static final class GcCollectorMetrics {
    ...
    /**
     * Creates a new GcCollectorMetrics.
     *
     * @param collectorName the collector name
     * @param collections the number of collections
