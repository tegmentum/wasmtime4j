 ...
 *
 * <p>This interface provides strategies for recovering from errors during WebAssembly
 * execution, including retry policies, fallback mechanisms, and graceful degradation.
 *
 * @since 1.0.0
 */
