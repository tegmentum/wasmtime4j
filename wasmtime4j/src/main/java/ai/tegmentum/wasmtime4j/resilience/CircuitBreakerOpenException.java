 ...
 *
 * <p>This exception is thrown when an operation is attempted through a circuit breaker
 * that is currently in the open state, preventing execution to avoid cascading failures.
 *
 * @since 1.0.0
 */
public class CircuitBreakerOpenException extends RuntimeException {
     ...
     */
    public CircuitBreakerOpenException(final String circuitBreakerName,
