 ...
 *
 * <p>The function context provides information about a function's execution
 * environment, including stack frame details, parameter and return types,
...
public interface FunctionContext {
     ...
     */
    static FunctionContext create(final String functionName,
    ...
    static FunctionContext create(final String functionName,
        ...
        return new FunctionContext() {
            ...
            public int getLocalCount() {
                ...
                return functionType.getParameterTypes().length + 2;
            }

            @Override
            public WasmValueType[] getLocalTypes() {
                // Simplified: return parameter types + two i32 locals
                final WasmValueType[] paramTypes = functionType.getParameterTypes();
    ...
    class FunctionOptimizationImpl implements FunctionOptimization {
        @Override public boolean isJitCompiled() { return false; }
        @Override public boolean isInlined() { return false; }
        @Override public boolean hasTailCallOptimization() { return true; }
        @Override public boolean hasFramePointerElimination() { return false; }
        @Override public WasmExecutionContext.OptimizationLevel getOptimizationLevel() {
            return WasmExecutionContext.OptimizationLevel.BASIC;
        }
        @Override public int getCompilationCost() { return 100; }
        @Override public double getPerformanceGain() { return 1.2; }
    }
    ...
    class FunctionMetricsImpl implements FunctionMetrics {
        ...
        @Override public long getCallCount() { return callCount; }
        @Override public long getTotalExecutionTime() { return totalExecutionTime; }
        @Override public double getAverageExecutionTime() {
            return callCount > 0 ? (double) totalExecutionTime / callCount : 0.0;
        }
        @Override public long getPeakMemoryUsage() { return peakMemoryUsage; }
        @Override public long getTailCallCount() { return tailCallCount; }
        @Override public long getOptimizedTailCallCount() { return optimizedTailCallCount; }
        @Override public long getStackSpaceSaved() { return stackSpaceSaved; }
