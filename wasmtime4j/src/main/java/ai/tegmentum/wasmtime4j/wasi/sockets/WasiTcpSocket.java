 ...
 *   <li>Bound (not listening)</li>
 *   <li>Listen-in-progress</li>
 *   <li>Listening</li>
 *   <li>Connect-in-progress</li>
 *   <li>Connected</li>
 *   <li>Closed</li>
 * </ul>
 */
public interface WasiTcpSocket {
    ...
    final class ConnectionStreams {
         ...
         */
        public ConnectionStreams(final WasiInputStream inputStream, final WasiOutputStream outputStream) {
            if (inputStream == null) {
