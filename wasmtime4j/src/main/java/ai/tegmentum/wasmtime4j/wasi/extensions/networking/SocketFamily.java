 ...
 *
 * <p>Socket families define the address format and protocol family used for
 * network communication. Each family corresponds to different addressing
...
public enum SocketFamily {
   ...
   *
   * <p>Uses 32-bit IPv4 addresses in dotted decimal notation (e.g., 192.168.1.1).
   * This is the most common address family for internet communications.
   */
  INET(2),
   ...
   *
   * <p>Uses 128-bit IPv6 addresses in hexadecimal notation (e.g., 2001:db8::1).
   * Provides expanded address space and improved protocol features compared to IPv4.
   */
  INET6(10),
   ...
   *
   * <p>Uses filesystem paths for local inter-process communication.
   * Provides efficient communication between processes on the same machine
