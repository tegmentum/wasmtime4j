 ...
 *
 * <p>Contains the UTC offset, timezone name abbreviation, and daylight saving time status
 * for displaying time information to users.
 *
...
public final class TimezoneDisplay {
     ...
     */
    public TimezoneDisplay(final int utcOffsetSeconds, final String name,
                           final boolean inDaylightSavingTime) {
     ...
     *
     * <p>This is the number of seconds to add to UTC to get local time.
     ...
     *
     * <p>This is typically a short abbreviation like "PST", "UTC", "EST", etc.
     * The exact format may vary by region and implementation.
     *
    ...
    public String toString() {
        return "TimezoneDisplay{"
                ...
                + ", name='" + name + '\''
                + ", inDaylightSavingTime=" + inDaylightSavingTime
                + '}';
    }
}
