 ...
 *
 * <p>This is used by the wall clock interface to report the current date and time.
 * The wall clock is not monotonic and may be reset, so successive calls to {@code now()}
 * may return non-increasing values.
 *
