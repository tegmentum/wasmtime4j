...
/**
 * Shared base class for {@link WasiHttpConfig} implementations.
 *
 * <p>This class holds all immutable fields, provides the complete getter implementations,
 * validation, equals/hashCode, and a toString that uses {@code getClass().getSimpleName()}.
 * Subclasses need only provide a constructor delegating to {@code super()} and implement {@link
 * #createBuilder()}.
 *
 * @since 1.0.0
 */
public abstract class AbstractWasiHttpConfig implements WasiHttpConfig {
  ...
  /**
   * Creates a new AbstractWasiHttpConfig with the specified settings.
   *
  ...
  /**
   * Creates a new builder for the runtime-specific config type.
   *
   * @return a new WasiHttpConfigBuilder instance
   */
  protected abstract WasiHttpConfigBuilder createBuilder();
  ...
  public WasiHttpConfigBuilder toBuilder() {
    final WasiHttpConfigBuilder builder = createBuilder();
  ...
  public boolean equals(final Object o) {
    ...
    if (!(o instanceof AbstractWasiHttpConfig)) {
      return false;
    }
    final AbstractWasiHttpConfig that = (AbstractWasiHttpConfig) o;
