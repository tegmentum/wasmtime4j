 ...
 * spawned threads.
 *
 * <p><strong>Important:</strong> This is an experimental feature with the following limitation:
 * A trap or WASI exit in one thread will exit the entire process. This makes it unsuitable for
...
public interface WasiThreadsContext extends Closeable {
     ...
     *
     * <p>Thread IDs are assigned sequentially starting from 1. This method returns the highest
     * thread ID that has been assigned, which may be useful for debugging or monitoring.
     *
     ...
     *
     * <p>After calling this method, the context becomes invalid and should not be used.
     * Any spawned threads should complete or be terminated before closing.
     */
    @Override
    void close();
}
