...
/**
 * Shared base class for WASI configuration builder implementations.
 *
 * <p>This class provides all builder method implementations. Subclasses only need to implement
 * {@link #build()} to construct the runtime-specific {@link WasiConfig}.
 *
 * @since 1.0.0
 */
public abstract class AbstractWasiConfigBuilder implements WasiConfigBuilder {
  ...
  protected final Map<String, Path> preopenDirectories = new HashMap<>();

  /** Working directory. */
  protected String workingDirectory;

  /** Whether to inherit host environment. */
  protected boolean inheritEnvironment;

  /** Execution timeout. */
  protected Duration executionTimeout;
  ...
  /** WASI version. */
  protected WasiVersion wasiVersion = WasiVersion.PREVIEW_1;

  /** Whether async operations are enabled. */
  protected boolean asyncOperations;

  /** Maximum concurrent async operations. */
  protected Integer maxAsyncOperations;

  /** Timeout for async operations. */
  protected Duration asyncOperationTimeout;

  /** Creates a new WASI configuration builder. */
  protected AbstractWasiConfigBuilder() {}
