 ...
 *
 * <p>This factory uses the Java ServiceLoader mechanism to discover and instantiate the
 * appropriate WASI-Threads implementation based on the runtime environment (JNI or Panama).
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public final class WasiThreadsFactory {
     ...
     *
     * <p>This is a convenience method that creates a builder, configures it, and builds the
     * context in one call.
     *
     ...
     *
     * <p>This method registers the {@code wasi::thread-spawn} import function in the linker,
     * which WebAssembly modules call to spawn new threads.
     *
     ...
     * @throws UnsupportedOperationException if WASI-Threads is not supported
     */
    public static void addToLinker(
            final Linker<?> linker, final Store store, final Module module) throws WasmException {
        if (PROVIDER == null) {
            throw new UnsupportedOperationException(
                    "WASI-Threads is not supported in this runtime environment");
        }
