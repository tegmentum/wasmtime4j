...
/**
 * Default implementation of WASI configuration.
 *
 * <p>This is the sole concrete implementation of {@link AbstractWasiConfig}, used by both JNI and
 * Panama runtimes since WASI configuration is a pure data object with no runtime-specific behavior.
 *
 * @since 1.0.0
 */
public final class DefaultWasiConfig extends AbstractWasiConfig {
  ...
  protected AbstractWasiConfigBuilder createBuilder() {
    return new DefaultWasiConfigBuilder();
  }
}
