...
/**
 * WASI security validation with comprehensive protection against common attacks.
 *
...
public final class WasiSecurityValidator {
  ...
  private WasiSecurityValidator(final Builder builder) {
    ...
    this.forbiddenPathComponents =
        Collections.unmodifiableSet(new HashSet<>(builder.forbiddenPathComponents));
    this.allowedEnvironmentPatterns =
        Collections.unmodifiableSet(new HashSet<>(builder.allowedEnvironmentPatterns));
    this.forbiddenEnvironmentNames =
        Collections.unmodifiableSet(new HashSet<>(builder.forbiddenEnvironmentNames));
  ...
  public static final class Builder {
    ...
    public Builder withMaxPathLength(final int maxPathLength) {
      Validation.requirePositive(maxPathLength, "maxPathLength");
    ...
    public Builder withForbiddenPathComponent(final String component) {
      Validation.requireNonEmpty(component, "component");
    ...
    public Builder withAllowedEnvironmentPattern(final Pattern pattern) {
      Validation.requireNonNull(pattern, "pattern");
