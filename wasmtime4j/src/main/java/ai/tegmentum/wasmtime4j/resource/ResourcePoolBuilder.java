 ...
 *
 * <p>ResourcePoolBuilder provides a fluent API for configuring and creating
 * resource pools with specific requirements and policies.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public final class ResourcePoolBuilder {
    ...
    public ResourcePoolBuilder withMaxPoolSize(final int maxPoolSize) {
        this.configuration = configuration.toBuilder()
    ...
    public ResourcePool build() throws WasmException {
        try {
            ...
            throw new WasmException("ResourcePool implementation not yet available - " +
