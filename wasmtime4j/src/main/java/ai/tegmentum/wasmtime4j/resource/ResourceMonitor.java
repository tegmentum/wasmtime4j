 ...
 *
 * <p>ResourceMonitor provides comprehensive monitoring capabilities for tracking resource usage,
 * performance metrics, health status, and operational patterns. It supports configurable monitoring
 * intervals, alerting thresholds, and historical data collection.
 *
 * <p>Key features: - Real-time resource usage monitoring and metrics collection - Configurable
 * alert thresholds and notification mechanisms - Historical data collection and trend analysis -
 * Health checks and status monitoring - Performance metrics and bottleneck identification -
 * Integration with external monitoring systems - Thread-safe concurrent monitoring operations
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public interface ResourceMonitor extends AutoCloseable {
   ...
   *
   * <p>This method begins periodic collection of resource metrics and health status information.
   * Monitoring continues until explicitly stopped or the monitor is closed.
   *
   ...
   *
   * <p>This method stops periodic metric collection but retains historical data according to the
   * retention policy.
   *
   ...
   */
  ResourceMetrics getAggregatedMetrics(
      final Instant startTime, final Instant endTime, final MetricsAggregationType aggregationType)
      throws WasmException;
   ...
   * @throws IllegalArgumentException if startTime or endTime is null, or startTime is after endTime
   */
  List<ResourceAlert> getAlertHistory(final Instant startTime, final Instant endTime)
      throws WasmException;
  ...
  String exportMonitoringData(
      final ExportFormat format, final Instant startTime, final Instant endTime)
      throws WasmException;
   ...
   *
   * <p>Configuration changes take effect immediately and may trigger restart of monitoring
   ...
   *
   * <p>This method will stop monitoring, save any pending data, and clean up resources.
   *
