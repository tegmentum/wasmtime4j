 ...
 *
 * <p>CacheEntryMetadata provides detailed information about cached entries
 * including timestamps, access patterns, and resource characteristics.
 *
 * @since 1.0.0
 */
public final class CacheEntryMetadata {
    ...
    public String toString() {
        return String.format(
                ...
                key, resourceType, priority, accessCount, estimatedSize,
                getAge(), getIdleTime(), getRemainingTtl(), isExpired);
    }
}