 ...
 *
 * <p>ResourceMetrics provides detailed information about resource usage,
 * performance characteristics, and operational metrics for monitoring
...
public final class ResourceMetrics {
    ...
    public String toString() {
        return String.format(
                ...
                timestamp, totalMemoryUsage, totalResourceCount, activeResourceCount,
                getMemoryUtilization() * 100, getResourceUtilization() * 100,
                cpuUsage * 100, threadCount, systemLoadAverage);
    }
}