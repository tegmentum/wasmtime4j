 ...
 *
 * <p>ResourceCacheBuilder provides a fluent API for configuring and creating
 * resource caches with specific requirements and policies.
 *
 * @since 1.0.0
 */
public final class ResourceCacheBuilder {
    ...
    public ResourceCache build() throws WasmException {
        try {
            ...
            throw new WasmException("ResourceCache implementation not yet available - " +
