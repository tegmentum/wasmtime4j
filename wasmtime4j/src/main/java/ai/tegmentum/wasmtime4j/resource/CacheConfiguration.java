 ...
 *
 * <p>CacheConfiguration defines the operational parameters for resource caches including size
 * limits, eviction policies, and performance settings.
 *
 * @since 1.0.0
 */
public final class CacheConfiguration {
   ...
   *
   * <p>When cache utilization exceeds this threshold, aggressive eviction is triggered.
   *
