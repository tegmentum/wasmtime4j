 ...
 *
 * <p>ResourceType provides categorization of resources to enable type-specific
 * management policies, monitoring, and cleanup strategies.
 *
 * @since 1.0.0
 */
public enum ResourceType {
     ...
     *
     * <p>Engines are typically long-lived resources that manage compilation
     * settings and shared state across multiple modules.
     */
     ...
     *
     * <p>Modules contain compiled WebAssembly code and can be instantiated
     * multiple times to create instances.
     */
     ...
     *
     * <p>Instances are runtime representations of modules with their own
     * memory, globals, and execution state.
     */
     ...
     *
     * <p>Memory objects represent the linear memory space accessible to
     * WebAssembly code.
     */
     ...
     *
     * <p>Globals are variables that can be shared between instances and
     ...
     *
     * <p>Tables contain references to functions or other objects that can
     * be indirectly called or accessed.
     */
     ...
     *
     * <p>WASI resources provide system interface capabilities like filesystem
     ...
     *
     * <p>Components are higher-level abstractions that can contain multiple
     * modules and provide component-level interfaces.
     */
     ...
     *
     * <p>Component instances are runtime representations of components with
     * their own isolated state and interfaces.
     */
    COMPONENT_INSTANCE("ComponentInstance", "Component model instances", false, 16L * 1024 * 1024), // 16MB

    /**
     * Linker objects for module linking.
     *
     * <p>Linkers manage the binding of imports and exports between modules
     ...
     *
     * <p>Stores manage the lifetime of WebAssembly objects and provide
     ...
     *
     * <p>Native handles represent underlying native resources that require
     ...
     *
     * <p>Cached resources are temporary objects stored for performance
     * optimization and can be evicted when memory pressure occurs.
     */
     ...
     *
     * <p>Thread resources manage concurrent execution and should be carefully
     * managed to prevent thread leaks.
     */
    THREAD_RESOURCE("ThreadResource", "Thread pool and executor resources", false, 512L * 1024), // 512KB

    /**
     * Generic managed resources.
     *
     * <p>Generic resources are catch-all category for custom resource types
    ...
    ResourceType(final String name, final String description, final boolean cacheable,
     ...
     *
     * <p>Heavy-weight resources typically require more careful management
     * and may have stricter limits on concurrent instances.
     *
     ...
     *
     * <p>Thread-safe resources can be safely accessed from multiple threads
    ...
    public boolean isThreadSafe() {
        ...
        return this == ENGINE || this == MODULE || this == FUNCTION ||
               this == COMPONENT || this == LINKER || this == CACHED_OBJECT;
    }

    /**
     * Gets the default cleanup priority for resources of this type.
     *
     * <p>Higher values indicate higher priority for cleanup when resource
     * limits are exceeded.
     *
