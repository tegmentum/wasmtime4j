 ...
 *
 * <p>CachePolicy defines the behavior and characteristics of cached resources including expiration,
 * priority, and eviction settings.
 *
 * <p>Example usage:
 *
 * <pre>{@code
...
public final class CachePolicy {
   ...
   *
   * <p>Higher weights make entries more likely to be evicted. Lower weights make entries less
