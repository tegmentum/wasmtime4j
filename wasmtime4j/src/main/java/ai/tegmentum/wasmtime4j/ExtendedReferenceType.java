 ...
 *
 * <p>This class defines extended reference types beyond the basic funcref and externref, including:
 *
 * <ul>
 ...
 * @since 1.1.0
 */
public interface ExtendedReferenceType {

  /**
   * Gets the base WasmValueType for this extended reference.
   *
  ...
  static ExtendedReferenceType create(
      final WasmValueType baseType, final boolean nullable, final HeapType heapType) {
    ...
    return new ExtendedReferenceType() {
      ...
      public boolean isSubtypeOf(final ExtendedReferenceType other) {
        ...
        // Base type subtyping - simple equality check for now
        // More sophisticated subtyping can be implemented when FunctionTypeValidator is available
        return baseType.equals(other.getBaseType());
      }
      ...
      public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ExtendedReferenceType)) {
          return false;
        }
