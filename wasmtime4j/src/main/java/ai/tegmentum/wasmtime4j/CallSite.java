 ...
 *
 * <p>Call sites provide information about function invocations including
 * their position in the code, calling context, and optimization potential.
 * This is particularly important for tail call optimization analysis.
 *
 * @since 1.1.0
 */
public interface CallSite {
     ...
     *
     * <p>A call is in tail position if its result is immediately returned
     ...
     */
    static CallSite create(final long instructionOffset,
    ...
    class CallFrequencyImpl implements CallFrequency {
        ...
        @Override public double getExecutionTimePercentage() { return 0.0; } // Would be calculated
        @Override public boolean isRecursive() { return recursive; }
        @Override public double getAverageRecursionDepth() { return recursive ? 3.0 : 0.0; }
    ...
    class CallSiteOptimizationImpl implements CallSiteOptimization {
        ...
        @Override public boolean hasTailCallOptimization() { return false; }
        @Override public boolean isInliningCandidate() { return true; }
        @Override public boolean isTailCallCandidate() { return true; }
        @Override public int getCallCost() { return 10; }
        @Override public double getOptimizationBenefit() { return 1.1; }
        @Override public String getOptimizationReason() { return "Candidate for optimization"; }
    }
}