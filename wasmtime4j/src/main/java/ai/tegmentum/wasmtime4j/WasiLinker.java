...
public final class WasiLinker {
     ...
     * @since 1.0.0
     */
    public static void addPreview2ToLinker(Linker<WasiContext> linker, WasiContext context) throws WasmException {
        if (linker == null) {
            throw new IllegalArgumentException("Linker cannot be null");
        }
        if (context == null) {
     ...
     *
     * <p>This is a convenience method that creates a default WASI context with
     * Preview 2 capabilities enabled, including async I/O and component model support.
     *
     * @param linker the linker to add WASI Preview 2 imports to
     * @throws WasmException if adding WASI Preview 2 imports fails
     * @throws IllegalArgumentException if linker is null
    ...
    public static void addPreview2ToLinker(Linker<WasiContext> linker) throws WasmException {
        WasiContext preview2Context = WasiContext.create()
            .inheritStdio()
     ...
     *
     * <p>This is a convenience method that creates a new linker and adds all
     * WASI Preview 2 imports using the provided context.
     *
     * @param engine the engine to create the linker for
     * @param context the WASI context containing configuration
     ...
     * @since 1.0.0
     */
    public static Linker<WasiContext> createPreview2Linker(Engine engine, WasiContext context) throws WasmException {
        if (engine == null) {
            throw new IllegalArgumentException("Engine cannot be null");
        }
        if (context == null) {
     ...
     *
     * <p>This is a convenience method that creates a comprehensive linker with full
     * WASI Preview 2 and Component Model capabilities.
     *
     * @param engine the engine to create the linker for
     * @param context the WASI context containing configuration
     ...
     * @since 1.0.0
     */
    public static Linker<WasiContext> createFullLinker(Engine engine, WasiContext context) throws WasmException {
        if (engine == null) {
            throw new IllegalArgumentException("Engine cannot be null");
        }
        if (context == null) {
    ...
    /**
     * Creates a new linker with both WASI Preview 2 and Component Model imports using default context.
     *
     * @param engine the engine to create the linker for
     * @return a new linker with complete WASI Preview 2 and Component Model imports
     * @throws WasmException if creating the linker or adding imports fails
     ...
     *
     * <p>This method checks for the presence of common WASI Preview 2 imports to determine
     * if WASI Preview 2 functionality has been added to the linker.
     *
     * @param linker the linker to check
     ...
     *
     * <p>This method checks for the presence of Component Model imports to determine
     * if Component Model functionality has been added to the linker.
     *
     * @param linker the linker to check
