 ...
 * resource restrictions, and security auditing capabilities. Implements defense-in-depth approach
 * to WebAssembly security.
 *
 * <p>Security policies are enforced at multiple layers:
 *
 * <ul>
 *   <li>Module compilation and loading
 *   <li>Instance creation and execution
 *   <li>Host function calls and system interactions
 *   <li>Memory and resource access
 * </ul>
 *
 * @since 1.0.0
 */
public interface SecurityPolicy {
   ...
   *
   * <p><strong>WARNING:</strong> This policy grants broad permissions and should never be used in
   * production environments.
   *
   * @return permissive security policy
   */
  static SecurityPolicy permissive() {
    return builder().withPermissiveMode(true).withAuditingEnabled(false).build();
  }

  /**
   * Creates a restrictive security policy suitable for production environments.
   *
   * <p>This policy enforces strict capability-based access control with minimal permissions and
   ...
   *
   * <p>This policy provides maximum isolation with strict resource limits, no host access, and
   ...
   *
   * <ul>
   *   <li>Capability consistency checks
   *   <li>Resource limit validation
   *   <li>Security context verification
   *   <li>Policy rule conflict detection
   * </ul>
   *
   ...
   *
   * <p>The derived policy will have all the restrictions of this policy plus any additional
   * restrictions specified in the modifier.
   *
