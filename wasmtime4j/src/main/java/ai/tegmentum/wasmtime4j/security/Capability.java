 ...
 *
 * <p>Capabilities define specific permissions that can be granted or denied
 * in a capability-based security model. Each capability represents a distinct
 * operation or resource access that requires explicit authorization.
 *
 * @since 1.0.0
 */
public enum Capability {
     ...
     *
     * <p>Some capabilities include others. For example, SECURITY_BYPASS
     * implies most other capabilities.
     *
    ...
    public boolean implies(final Capability other) {
        ...
        switch (this) {
            ...
            case RESOURCE_UNLIMITED_MEMORY:
                ...
                return other == MEMORY_READ || other == MEMORY_WRITE ||
                       other == MEMORY_GROW || other == MEMORY_UNSAFE_ACCESS;
