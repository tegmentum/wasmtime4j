 ...
 *
 * <p>Provides comprehensive audit trail functionality including event logging,
 * filtering, analysis, and reporting capabilities for security monitoring.
 *
 * @since 1.0.0
 */
public interface SecurityAuditLog {
    ...
    static SecurityAuditLog create(final SecurityAuditConfig config) {
        ...
        try {
            ...
            return (SecurityAuditLog) logClass.getDeclaredConstructor(SecurityAuditConfig.class)
                                              .newInstance(config);
     ...
     */
    void logEvent(final SecurityEventType eventType, final String message,
     ...
     * @param context additional context information
     */
    void logEvent(final SecurityEventType eventType, final SecuritySeverity severity,
     ...
     */
    SecurityComplianceReport generateComplianceReport(final ComplianceReportType reportType,
                                                     final Instant since, final Instant until);
    ...
    enum ComplianceReportType {
        SOX, HIPAA, GDPR, PCI_DSS, SOC2, ISO27001, CUSTOM
    }
}