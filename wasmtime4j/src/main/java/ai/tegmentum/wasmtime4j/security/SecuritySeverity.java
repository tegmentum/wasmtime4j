...
public enum SecuritySeverity {
  ...
  /**
   * Informational events that provide context but indicate no security concern. Examples:
   * successful authentication, normal operations.
   */
  INFO(0, "Informational"),

  /**
   * Low severity events that may be of interest but pose minimal risk. Examples: failed login
   * attempts, minor configuration changes.
   */
  LOW(1, "Low"),

  /**
   * Medium severity events that indicate potential security concerns. Examples: authorization
   * denials, resource limit warnings.
   */
  MEDIUM(2, "Medium"),

  /**
   * High severity events that indicate significant security issues. Examples: policy violations,
   * suspicious activity, access denials.
   */
  HIGH(3, "High"),

  /**
   * Critical severity events that indicate immediate security threats. Examples: intrusion
   * attempts, sandbox breaches, attack patterns.
   */
  CRITICAL(4, "Critical");
