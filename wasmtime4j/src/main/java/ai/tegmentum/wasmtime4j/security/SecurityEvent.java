 ...
 *
 * <p>Security events capture important security-related activities, violations,
 * and state changes for audit, monitoring, and analysis purposes.
 *
 * @since 1.0.0
 */
public final class SecurityEvent {
     ...
     */
    public static SecurityEvent critical(final SecurityEventType type, final String message,
                                        final Map<String, Object> context) {
    ...
    public Optional<String> getSourceModule() { return sourceModule; }
    public Optional<String> getSourceInstance() { return sourceInstance; }
    ...
    public Optional<String> getRemediationAction() { return remediationAction; }
