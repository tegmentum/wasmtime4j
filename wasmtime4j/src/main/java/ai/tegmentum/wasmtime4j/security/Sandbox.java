 ...
 * capability-based security, and comprehensive monitoring. Designed for executing
 * untrusted or potentially malicious WebAssembly modules safely.
 *
 * <p>Key security features:
 * <ul>
 *   <li>Process-level isolation (optional)</li>
 *   <li>Memory isolation and bounds checking</li>
 *   <li>Execution time limits with preemption</li>
 *   <li>Instruction count limits</li>
 *   <li>Network and filesystem isolation</li>
 *   <li>Capability-based access control</li>
 *   <li>Real-time monitoring and intrusion detection</li>
 * </ul>
 *
 * @since 1.0.0
 */
public interface Sandbox extends Closeable {
     ...
     *
     * <p>Provides maximum isolation and security for executing completely
     * untrusted WebAssembly modules.
     *
     ...
     *
     * <p>The module is validated against the security policy before loading.
     * Only modules that pass all security checks are allowed.
     *
     ...
     */
    SandboxExecutionResult execute(final SandboxInstance instance,
                                  final String functionName,
                                  final Object[] parameters,
                                  final Duration timeout) throws SandboxException;
     ...
     */
    CompletableFuture<SandboxExecutionResult> executeAsync(final SandboxInstance instance,
                                                          final String functionName,
                                                          final Object[] parameters,
     ...
     *
     * <p>This is a forceful operation that stops all running instances
     ...
     *
     * <p>Clears all loaded modules, instances, and resets resource counters.
     * Security policy and configuration remain unchanged.
     *
     ...
     * <ul>
     *   <li>Resource limit compliance</li>
     *   <li>Security policy enforcement</li>
     *   <li>Memory integrity checks</li>
     *   <li>Process isolation validation</li>
     * </ul>
     *
     ...
     *
     * <p>After closing, the sandbox cannot be used for further operations.
     * All running instances are terminated gracefully.
     */
    @Override
    void close();
}