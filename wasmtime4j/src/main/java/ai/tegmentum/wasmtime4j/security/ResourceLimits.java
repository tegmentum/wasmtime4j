 ...
 *
 * <p>Defines comprehensive resource constraints including memory, execution time, instruction
 * counts, and system resource usage limits.
 *
 * @since 1.0.0
 */
  ...
  public ResourceLimits restrictTo(final ResourceLimits other) {
    return builder()
        ...
        .withMaxExecutionTime(
            this.maxExecutionTime.compareTo(other.maxExecutionTime) < 0
        ...
        .withMaxNetworkConnections(
            Math.min(this.maxNetworkConnections, other.maxNetworkConnections))
