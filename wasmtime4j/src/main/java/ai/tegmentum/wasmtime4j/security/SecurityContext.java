...
public final class SecurityContext {
  ...
  public static SecurityContext defaultContext() {
    return builder().withPrincipalId("anonymous").withSecurityLevel(SecurityLevel.LOW).build();
  }
  ...
  public static SecurityContext systemContext() {
    return builder().withPrincipalId("system").withSecurityLevel(SecurityLevel.SYSTEM).build();
  }
  ...
  public Optional<Instant> getAuthenticatedAt() {
