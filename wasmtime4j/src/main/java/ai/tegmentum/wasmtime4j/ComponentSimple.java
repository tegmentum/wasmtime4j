...
/**
 * Core WebAssembly Component Model component interface with essential functionality.
 *
 ...
 * @since 1.0.0
 */
public interface ComponentSimple extends AutoCloseable {
   ...
   */
  Set<ComponentSimple> resolveDependencies(ComponentRegistry registry) throws WasmException;
   ...
   */
  ComponentCompatibility checkCompatibility(ComponentSimple other) throws WasmException;
   ...
   * @throws WasmException if compatibility check fails
   */
  WitCompatibilityResult checkWitCompatibility(ComponentSimple other) throws WasmException;
