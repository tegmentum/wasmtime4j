 ...
 * 
 * <p>A Module is the result of compiling WebAssembly bytecode and contains all the
 * information needed to create instances. Modules are immutable after compilation
 * and can be instantiated multiple times to create separate execution contexts.
 * 
 * <p>Modules contain metadata about exports, imports, and the compiled code that
 * can be queried for introspection purposes.
 * 
 * @since 1.0.0
 */
public interface Module extends Closeable {
     ...
     * 
     * <p>Each instance represents a separate execution context with its own
     * linear memory, globals, and runtime state.
     * 
     ...
     * 
     * <p>Exports represent functions, globals, memories, and tables that this
     * module makes available to the host environment.
     * 
     ...
     * 
     * <p>Imports represent functions, globals, memories, and tables that this
     * module expects to be provided by the host environment.
     * 
