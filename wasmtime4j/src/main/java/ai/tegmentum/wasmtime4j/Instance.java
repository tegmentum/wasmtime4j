 ...
 * 
 * <p>An Instance is a running instance of a WebAssembly module with its own
 * execution state, including linear memory, globals, and function contexts.
 * Instances provide access to exported functions that can be called from Java.
 * 
 * <p>Each instance maintains separate state even when created from the same module,
 * allowing for isolated execution contexts.
 * 
 * @since 1.0.0
 */
public interface Instance extends Closeable {
     ...
     * 
     * <p>Returns a function that can be called from Java code. The function
     * maintains a reference to this instance's execution context.
     * 
     ...
     * 
     * <p>This is a convenience method that returns the first exported memory,
     * which is typically named "memory" in WebAssembly modules.
     * 
