 ...
 *
 * <p>Function type metadata provides extended information about function
 * signatures that goes beyond basic parameter and return types, including:
 *
 * <ul>
...
public interface FunctionTypeMetadata {
    ...
    class MetadataType<T> {
        ...
        public static final MetadataType<String> VERSION =
            new MetadataType<>("version", String.class);
