...
/**
 * Default implementation of {@link CoreDumpMemory}.
 *
 * @since 1.0.0
 */
public final class DefaultCoreDumpMemory implements CoreDumpMemory {
  ...
  private DefaultCoreDumpMemory(final Builder builder) {
  ...
  /** Default implementation of {@link MemorySegment}. */
  public static final class DefaultMemorySegment implements MemorySegment {
     ...
     */
    public DefaultMemorySegment(final long offset, final byte[] data) {
      if (offset < 0) {
    ...
    public boolean equals(final Object o) {
      ...
      final DefaultMemorySegment that = (DefaultMemorySegment) o;
  ...
  /** Builder for constructing {@link DefaultCoreDumpMemory} instances. */
  public static final class Builder {
    ...
    public DefaultCoreDumpMemory build() {
      return new DefaultCoreDumpMemory(this);
    }
  }
}
