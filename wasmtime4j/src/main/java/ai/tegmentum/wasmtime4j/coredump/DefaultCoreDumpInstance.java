...
/**
 * Default implementation of {@link CoreDumpInstance}.
 *
 * @since 1.0.0
 */
public final class DefaultCoreDumpInstance implements CoreDumpInstance {
  ...
  private DefaultCoreDumpInstance(final Builder builder) {
  ...
  /** Builder for constructing {@link DefaultCoreDumpInstance} instances. */
  public static final class Builder {
    ...
    public DefaultCoreDumpInstance build() {
      return new DefaultCoreDumpInstance(this);
    }
  }
}
