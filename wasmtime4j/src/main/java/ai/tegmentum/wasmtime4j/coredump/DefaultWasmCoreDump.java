...
/**
 * Default implementation of {@link WasmCoreDump}.
 *
 ...
 * @since 1.0.0
 */
public final class DefaultWasmCoreDump implements WasmCoreDump {
  ...
  private DefaultWasmCoreDump(final Builder builder) {
  ...
  /** Builder for constructing {@link DefaultWasmCoreDump} instances. */
  public static final class Builder {
     ...
     */
    public DefaultWasmCoreDump build() {
      return new DefaultWasmCoreDump(this);
    }
  }
}
