 ...
 *
 * <p>This type carries precise function signature information as part of the
 * typed function references proposal. Unlike basic funcref, this type preserves
 * the exact parameter and return types, enabling compile-time type checking.
 *
 * @since 1.1.0
 */
public class TypedFunctionReferenceType implements WasmValueType {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof TypedFunctionReferenceType)) return false;
