 ...
 *
 * <p>This class provides comprehensive configuration options for all aspects of the component mesh,
 * including service discovery, load balancing, security, streaming, CDN, analytics, and federation
 * settings.
 *
 * @since 1.0.0
 */
public final class MeshConfig {
  ...
  private MeshConfig(final Builder builder) {
    this.serviceDiscovery =
        builder.serviceDiscovery != null
            ? builder.serviceDiscovery
            : ServiceDiscoveryConfig.defaultConfig();
    this.loadBalancing =
        builder.loadBalancing != null ? builder.loadBalancing : LoadBalancingConfig.defaultConfig();
    this.security = builder.security != null ? builder.security : SecurityConfig.defaultConfig();
    this.streaming =
        builder.streaming != null ? builder.streaming : StreamingConfig.defaultConfig();
    this.cdn = builder.cdn != null ? builder.cdn : CdnConfig.defaultConfig();
    this.analytics =
        builder.analytics != null ? builder.analytics : AnalyticsConfig.defaultConfig();
    this.federation =
        builder.federation != null ? builder.federation : FederationConfig.defaultConfig();
    this.monitoring =
        builder.monitoring != null ? builder.monitoring : MonitoringConfig.defaultConfig();
  }
  ...
  public static final class ServiceDiscoveryConfig {
    ...
    private ServiceDiscoveryConfig(
        final List<String> discoveryProtocols,
    ...
    /**
     * Creates a default service discovery configuration.
     *
     * @return default service discovery configuration
     */
  ...
  public static final class LoadBalancingConfig {
    ...
    /**
     * Creates a default load balancing configuration.
     *
     * @return default load balancing configuration
     */
  ...
  public static final class SecurityConfig {
    ...
    private SecurityConfig(
        ...
        final boolean accessControlEnabled,
        final boolean auditLoggingEnabled,
        final boolean threatDetectionEnabled,
    ...
    public static SecurityConfig defaultConfig() {
      return new SecurityConfig(true, "AES_256_GCM", true, true, true, List.of());
    }
    ...
    public boolean isThreatDetectionEnabled() {
  ...
  public static final class StreamingConfig {
    ...
    public static StreamingConfig defaultConfig() {
      return new StreamingConfig(true, 10, 1000, Duration.ofMinutes(1), true);
    }
  ...
  public static final class CdnConfig {
    ...
    /**
     * Creates a default CDN configuration.
     *
     * @return default CDN configuration
     */
  ...
  public static final class AnalyticsConfig {
    ...
    public static AnalyticsConfig defaultConfig() {
      return new AnalyticsConfig(
          true, Duration.ofMinutes(1), true, true, List.of("performance", "usage", "errors"));
    }
  ...
  public static final class FederationConfig {
    ...
    public static FederationConfig defaultConfig() {
      return new FederationConfig(
          false, "eventual", "full", Duration.ofSeconds(30), "last_write_wins");
    }
  ...
  public static final class MonitoringConfig {
    ...
    private MonitoringConfig(
        ...
        final boolean metricsExportEnabled,
