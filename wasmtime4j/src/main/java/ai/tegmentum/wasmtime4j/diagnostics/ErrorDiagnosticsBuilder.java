 ...
 *
 * <p>This builder provides a fluent API for creating comprehensive diagnostic information for
 * WebAssembly errors with detailed analysis and suggestions.
 *
 * @since 1.0.0
 */
public final class ErrorDiagnosticsBuilder {
  ...
  private static final class ErrorDiagnosticsImpl implements ErrorDiagnostics {
    ...
    private ErrorDiagnosticsImpl(
        ...
        final List<KnownIssue> similarIssues,
        final DebugInfo debugInfo,
        final RuntimeMetrics runtimeMetrics,
