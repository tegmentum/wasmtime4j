 ...
 *
 * <p>This interface provides metrics and analysis about how an error affects
 * system performance, resource usage, and execution characteristics.
 *
 * @since 1.0.0
 */
public interface PerformanceImpact {
     ...
     */
    static PerformanceImpact of(final Severity severity, final Category category, final String analysis) {
        return builder()
            .severity(severity)
            .category(category)
            .analysis(analysis)
