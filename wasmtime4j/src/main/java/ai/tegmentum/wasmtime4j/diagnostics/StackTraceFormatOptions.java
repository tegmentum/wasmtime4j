 ...
 *
 * <p>This interface provides configuration options for controlling how stack traces are formatted
 * and displayed, including verbosity levels and filtering options.
 *
 * @since 1.0.0
 */
