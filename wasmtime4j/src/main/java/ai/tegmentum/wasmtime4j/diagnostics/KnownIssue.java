 ...
 *
 * <p>This interface provides information about previously documented issues
 * that share similarities with the current error, including resolutions and workarounds.
 *
 * @since 1.0.0
 */
public interface KnownIssue {
     ...
     */
    static KnownIssue of(final String issueId, final String title, final Status status,
