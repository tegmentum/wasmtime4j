 ...
 *
 * <p>This builder provides a fluent API for creating comprehensive WebAssembly error objects with
 * detailed diagnostics, context, and recovery information.
 *
 * @since 1.0.0
 */
