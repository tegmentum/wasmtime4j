 ...
 *
 * <p>This interface provides detailed information about validation problems
 * found in WebAssembly modules, including location, severity, and suggested fixes.
 *
 * @since 1.0.0
 */
public interface ValidationIssue {
     ...
     */
    static ValidationIssue of(final String issueId, final String message,
