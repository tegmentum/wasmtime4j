 ...
 *
 * <p>This interface provides comprehensive information about the runtime environment when an error
 * occurred, including JVM, OS, and WebAssembly runtime details.
 *
 * @since 1.0.0
 */
public interface RuntimeEnvironment {
  ...
  static RuntimeEnvironment snapshot() {
    return new RuntimeEnvironmentImpl(
        JvmInfo.current(), OsInfo.current(), WasmRuntimeInfo.current(), System.currentTimeMillis());
  }
  ...
  final class WasmRuntimeInfoImpl implements WasmRuntimeInfo {
    ...
    public WasmRuntimeInfoImpl(
        final String runtimeType,
        final String version,
        final boolean jniEnabled,
        final boolean panamaEnabled) {
