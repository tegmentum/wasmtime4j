 ...
 *
 * <p>This interface provides comprehensive runtime metrics that help diagnose performance issues,
 * resource usage, and execution characteristics when errors occur.
 *
 * @since 1.0.0
 */
public interface RuntimeMetrics {
  ...
  static RuntimeMetrics snapshot() {
    return builder().collectionTimestamp(System.currentTimeMillis()).build();
  }
}
