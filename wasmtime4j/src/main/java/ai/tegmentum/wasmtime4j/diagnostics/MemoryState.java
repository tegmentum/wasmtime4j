 ...
 *
 * <p>This interface provides detailed information about memory usage and state at the time an error
 * occurred during WebAssembly execution.
 *
 * @since 1.0.0
 */
public interface MemoryState {
  ...
  final class MemoryStateImpl implements MemoryState {
    ...
    public MemoryStateImpl(
        final long totalHeapMemory,
        final long usedHeapMemory,
        final long freeHeapMemory,
