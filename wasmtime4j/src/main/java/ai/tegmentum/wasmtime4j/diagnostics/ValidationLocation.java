 ...
 *
 * <p>This interface provides precise location information for where validation
 * issues were detected within WebAssembly bytecode or module structure.
 *
 * @since 1.0.0
 */
public interface ValidationLocation {
     ...
     * @return the validation location
     */
    static ValidationLocation of(final int functionIndex, final long instructionOffset, final String context) {
    ...
    final class ValidationLocationImpl implements ValidationLocation {
        ...
        public ValidationLocationImpl(final String context, final Integer functionIndex,
                                     final Long instructionOffset, final Long bytecodeOffset,
