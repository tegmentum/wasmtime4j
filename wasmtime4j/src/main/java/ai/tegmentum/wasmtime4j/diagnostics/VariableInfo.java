 ...
 *
 * <p>This interface provides debugging information about variables in WebAssembly
 * functions, including their names, types, and current values.
 *
 * @since 1.0.0
 */
public interface VariableInfo {
     ...
     */
    static VariableInfo of(final String name, final int index, final VariableType type, final String valueType) {
        return builder()
            .name(name)
            .index(index)
            .variableType(type)
