...
/**
 * Tests for {@link Profiler} interface.
 *
 * <p>Profiler provides performance profiling for WebAssembly execution.
 */
@DisplayName("Profiler Interface Tests")
class ProfilerInterfaceTest {
  ...
  class InterfaceStructureTests {
    ...
    void shouldHaveStartProfilingMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("startProfiling");
    ...
    void shouldHaveStopProfilingMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("stopProfiling");
    ...
    void shouldHaveIsProfilingMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("isProfiling");
    ...
    void shouldHaveRecordFunctionExecutionMethod() throws NoSuchMethodException {
      ...
      assertEquals(void.class, method.getReturnType(), "Should return void");
      assertArrayEquals(
          new Class<?>[] {String.class, Duration.class, long.class},
    ...
    void shouldHaveGetModulesCompiledMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getModulesCompiled");
    ...
    void shouldHaveGetTotalCompilationTimeMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getTotalCompilationTime");
    ...
    void shouldHaveGetAverageCompilationTimeMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getAverageCompilationTime");
    ...
    void shouldHaveGetBytesCompiledMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getBytesCompiled");
    ...
    void shouldHaveGetCacheHitsMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getCacheHits");
    ...
    void shouldHaveGetCacheMissesMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getCacheMisses");
    ...
    void shouldHaveGetOptimizedModulesMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getOptimizedModules");
    ...
    void shouldHaveGetCurrentMemoryBytesMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getCurrentMemoryBytes");
    ...
    void shouldHaveGetPeakMemoryBytesMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getPeakMemoryBytes");
    ...
    void shouldHaveGetUptimeMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getUptime");
    ...
    void shouldHaveGetFunctionCallsPerSecondMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getFunctionCallsPerSecond");
    ...
    void shouldHaveGetTotalFunctionCallsMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getTotalFunctionCalls");
    ...
    void shouldHaveGetTotalExecutionTimeMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("getTotalExecutionTime");
    ...
    void shouldHaveResetMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("reset");
    ...
    void shouldHaveCloseMethod() throws NoSuchMethodException {
      final Method method = Profiler.class.getMethod("close");
