...
class WasmThreadStatisticsTest {
  ...
  class ConstructorTests {
    ...
    void shouldClampNegativeFunctionsExecutedToZero() {
      ...
      assertEquals(
          0L, stats.getFunctionsExecuted(), "Negative functionsExecuted should be clamped to 0");
    }
    ...
    void shouldClampNegativeTotalExecutionTimeToZero() {
      ...
      assertEquals(
          0L, stats.getTotalExecutionTime(), "Negative totalExecutionTime should be clamped to 0");
    }
    ...
    void shouldClampNegativeAtomicOperationsToZero() {
      ...
      assertEquals(
          0L, stats.getAtomicOperations(), "Negative atomicOperations should be clamped to 0");
    }
    ...
    void shouldClampNegativeMemoryAccessesToZero() {
      ...
      assertEquals(0L, stats.getMemoryAccesses(), "Negative memoryAccesses should be clamped to 0");
    }
    ...
    void shouldClampNegativePeakMemoryUsageToZero() {
      ...
      assertEquals(
          0L, stats.getPeakMemoryUsage(), "Negative peakMemoryUsage should be clamped to 0");
    }

    @Test
    @DisplayName("should clamp all negative values simultaneously")
    void shouldClampAllNegativeValuesSimultaneously() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(-1L, -2L, -3L, -4L, -5L, -6L);
      ...
      assertEquals(
          0L, stats.getWaitNotifyOperations(), "waitNotifyOperations should be clamped to 0");
  ...
  class DerivedMetricTests {
    ...
    void getTotalExecutionTimeMillisShouldConvertNsToMs() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(0L, 5_000_000L, 0L, 0L, 0L, 0L);

      assertEquals(5L, stats.getTotalExecutionTimeMillis(), "5,000,000 ns should convert to 5 ms");
    }
    ...
    void getTotalExecutionTimeMillisShouldTruncateSubMillisecond() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(0L, 1_500_000L, 0L, 0L, 0L, 0L);

      assertEquals(1L, stats.getTotalExecutionTimeMillis(), "1,500,000 ns should truncate to 1 ms");
    }
    ...
    void getAverageExecutionTimeShouldComputeCorrectAverage() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(10L, 1000L, 0L, 0L, 0L, 0L);
    ...
    void getAverageExecutionTimeShouldReturnZeroWhenNoFunctions() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(0L, 5000L, 0L, 0L, 0L, 0L);
    ...
    void getPeakMemoryUsageKbShouldConvertBytesToKb() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(0L, 0L, 0L, 0L, 0L, 10240L);

      assertEquals(10L, stats.getPeakMemoryUsageKB(), "10240 bytes should convert to 10 KB");
    }

    @Test
    @DisplayName("getPeakMemoryUsageMB should convert bytes to megabytes")
    void getPeakMemoryUsageMbShouldConvertBytesToMb() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(0L, 0L, 0L, 0L, 0L, 10_485_760L);

      assertEquals(10L, stats.getPeakMemoryUsageMB(), "10,485,760 bytes should convert to 10 MB");
    }
    ...
    void getOperationsPerSecondShouldReturnZeroWhenNoExecutionTime() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(100L, 0L, 50L, 0L, 20L, 0L);
    ...
    void getMemoryAccessRateShouldReturnZeroWhenNoExecutionTime() {
      final WasmThreadStatistics stats = new WasmThreadStatistics(0L, 0L, 0L, 5000L, 0L, 0L);
  ...
  class CombineTests {
    ...
    void combineShouldSumAllFieldsExceptPeakMemory() {
      ...
      assertEquals(
          30L, combined.getFunctionsExecuted(), "Combined functions executed should be 30");
      assertEquals(
          3000L, combined.getTotalExecutionTime(), "Combined total execution time should be 3000");
      assertEquals(15L, combined.getAtomicOperations(), "Combined atomic operations should be 15");
      assertEquals(300L, combined.getMemoryAccesses(), "Combined memory accesses should be 300");
      assertEquals(
          5L, combined.getWaitNotifyOperations(), "Combined wait/notify operations should be 5");
    }
    ...
    void combineWithEmptyShouldReturnEquivalentStatistics() {
      ...
      assertEquals(stats, combined, "Combining with empty should produce equivalent statistics");
    }
  ...
  class EqualsAndHashCodeTests {
    ...
    void equalsShouldReturnFalseForDifferentValues() {
      ...
      final WasmThreadStatistics stats2 =
          new WasmThreadStatistics(20L, 2000L, 10L, 200L, 4L, 1024L);
  ...
  class ToStringTests {
    ...
    void toStringShouldContainPrefix() {
      ...
      assertTrue(
          stats.toString().startsWith("WasmThreadStatistics{"),
