...
/** Comprehensive tests for {@link DefaultPoolStatistics}. */
@DisplayName("DefaultPoolStatistics Tests")
class DefaultPoolStatisticsTest {
  ...
  class ClassStructureTests {
    ...
    @Test
    @DisplayName("DefaultPoolStatistics should be final class")
    void shouldBeFinalClass() {
      assertTrue(
          java.lang.reflect.Modifier.isFinal(DefaultPoolStatistics.class.getModifiers()),
          "DefaultPoolStatistics should be final");
    }

    @Test
    @DisplayName("DefaultPoolStatistics should implement PoolStatistics")
    void shouldImplementPoolStatistics() {
      assertTrue(
          PoolStatistics.class.isAssignableFrom(DefaultPoolStatistics.class),
          "DefaultPoolStatistics should implement PoolStatistics");
    }
  }
  ...
  class DefaultConstructorTests {
    ...
    void defaultConstructorShouldCreateStatisticsWithZeroValues() {
      final DefaultPoolStatistics stats = new DefaultPoolStatistics();
  ...
  class ArrayConstructorTests {
    ...
    void arrayConstructorShouldSetAllValuesCorrectly() {
      ...
      final DefaultPoolStatistics stats = new DefaultPoolStatistics(metrics);
    ...
    void arrayConstructorShouldRejectNullArray() {
      assertThrows(
          ...
          () -> new DefaultPoolStatistics(null),
    ...
    void arrayConstructorShouldRejectWrongSizeArray() {
      assertThrows(
          IllegalArgumentException.class,
          () -> new DefaultPoolStatistics(new long[10]),
  ...
  class ToStringTests {
    ...
    void toStringShouldIncludeAllFieldNames() {
      ...
      assertTrue(str.startsWith("DefaultPoolStatistics{"), "Should start with class name");
    }
  }
  ...
  class EdgeCaseTests {
    ...
    void shouldHandleZeroValuesInAllFields() {
      final DefaultPoolStatistics stats = new DefaultPoolStatistics(new long[12]);
