...
class LinkerAdvancedResolutionTest {
    ...
    class ImportCheckingTests {
        ...
        void testHasImportReturnsTrueAfterDefiningHostFunction() throws WasmException {
            final FunctionType funcType = FunctionType.create(
    ...
    class DependencyResolutionTests {
        ...
        void testResolveDependenciesWithSingleModule() throws WasmException {
            ...
            final byte[] wasmBytecode = new byte[]{
    ...
    class ImportValidationTests {
        ...
        void testValidateImportsResults() throws WasmException {
            ...
            final List<ImportIssue> criticalIssues = validation.getIssuesBySeverity(ImportIssue.Severity.CRITICAL);
            assertNotNull(criticalIssues);

            final List<ImportIssue> errorIssues = validation.getIssuesBySeverity(ImportIssue.Severity.ERROR);
    ...
    class ErrorHandlingTests {
        ...
        void testNullParameterHandling() {
            ...
            assertThrows(IllegalArgumentException.class, () -> linker.createInstantiationPlan((Module[]) null));
        }
    ...
    class DataStructureTests {
        ...
        void testDependencyEdge() throws WasmException {
            ...
            final DependencyEdge edge = new DependencyEdge(
                module1, module2, "env", "test_function",
        ...
        void testImportIssue() {
            final ImportIssue issue = new ImportIssue(
