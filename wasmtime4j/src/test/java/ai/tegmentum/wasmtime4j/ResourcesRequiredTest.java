...
class ResourcesRequiredTest {
  ...
  class ConstructorTests {
    ...
    void shouldAcceptZeroValuesForAllParameters() {
      ...
      assertEquals(0L, resources.getMinimumMemoryBytes(),
          "Minimum memory bytes should be 0");
      assertEquals(0L, resources.getMaximumMemoryBytes(),
          "Maximum memory bytes should be 0");
      assertEquals(0, resources.getMinimumTableElements(),
          "Minimum table elements should be 0");
      assertEquals(0, resources.getMaximumTableElements(),
          "Maximum table elements should be 0");
    ...
    void shouldAcceptLargeValuesForLongParameters() {
      ...
      assertEquals(Long.MAX_VALUE, resources.getMinimumMemoryBytes(),
          "Should handle Long.MAX_VALUE for minimumMemoryBytes");
      assertEquals(Long.MAX_VALUE, resources.getMaximumMemoryBytes(),
    ...
    void shouldAcceptNegativeValuesWithoutValidation() {
      final ResourcesRequired resources =
          new ResourcesRequired(-1L, -1L, -1, -1, -1, -1, -1, -1);

      assertEquals(-1L, resources.getMinimumMemoryBytes(),
          "Constructor does not validate; -1 for unlimited memory");
      assertEquals(-1L, resources.getMaximumMemoryBytes(),
          "Constructor does not validate; -1 for unlimited max memory");
      assertEquals(-1, resources.getMinimumTableElements(),
  ...
  class GetterTests {
    ...
    void getMinimumMemoryBytesShouldReturnConstructorValue() {
      final ResourcesRequired resources =
          new ResourcesRequired(65536L, 0L, 0, 0, 0, 0, 0, 0);

      assertEquals(65536L, resources.getMinimumMemoryBytes(),
          "Minimum memory bytes should be 65536");
    }
    ...
    void getMaximumMemoryBytesShouldReturnConstructorValue() {
      final ResourcesRequired resources =
          new ResourcesRequired(0L, 1048576L, 0, 0, 0, 0, 0, 0);

      assertEquals(1048576L, resources.getMaximumMemoryBytes(),
          "Maximum memory bytes should be 1048576");
    }
    ...
    void getMinimumTableElementsShouldReturnConstructorValue() {
      final ResourcesRequired resources =
          new ResourcesRequired(0L, 0L, 10, 0, 0, 0, 0, 0);

      assertEquals(10, resources.getMinimumTableElements(),
          "Minimum table elements should be 10");
    }
    ...
    void getMaximumTableElementsShouldReturnConstructorValue() {
      final ResourcesRequired resources =
          new ResourcesRequired(0L, 0L, 0, 100, 0, 0, 0, 0);

      assertEquals(100, resources.getMaximumTableElements(),
          "Maximum table elements should be 100");
    }
    ...
    void getNumMemoriesShouldReturnConstructorValue() {
      final ResourcesRequired resources =
          new ResourcesRequired(0L, 0L, 0, 0, 3, 0, 0, 0);
    ...
    void getNumTablesShouldReturnConstructorValue() {
      final ResourcesRequired resources =
          new ResourcesRequired(0L, 0L, 0, 0, 0, 4, 0, 0);
    ...
    void getNumGlobalsShouldReturnConstructorValue() {
      final ResourcesRequired resources =
          new ResourcesRequired(0L, 0L, 0, 0, 0, 0, 7, 0);
    ...
    void getNumFunctionsShouldReturnConstructorValue() {
      final ResourcesRequired resources =
          new ResourcesRequired(0L, 0L, 0, 0, 0, 0, 0, 42);
  ...
  class EmptyFactoryTests {
    ...
    void emptyShouldCreateInstanceWithAllZeros() {
      ...
      assertEquals(0L, resources.getMinimumMemoryBytes(),
          "Empty minimum memory bytes should be 0");
      assertEquals(0L, resources.getMaximumMemoryBytes(),
          "Empty maximum memory bytes should be 0");
      assertEquals(0, resources.getMinimumTableElements(),
          "Empty minimum table elements should be 0");
      assertEquals(0, resources.getMaximumTableElements(),
          "Empty maximum table elements should be 0");
    ...
    void emptyShouldBeEquivalentToAllZeroConstructor() {
      ...
      assertEquals(empty.getMinimumMemoryBytes(), allZeros.getMinimumMemoryBytes(),
          "Empty and all-zeros should have same minimumMemoryBytes");
      assertEquals(empty.getMaximumMemoryBytes(), allZeros.getMaximumMemoryBytes(),
          "Empty and all-zeros should have same maximumMemoryBytes");
      assertEquals(empty.getMinimumTableElements(), allZeros.getMinimumTableElements(),
          "Empty and all-zeros should have same minimumTableElements");
      assertEquals(empty.getMaximumTableElements(), allZeros.getMaximumTableElements(),
          "Empty and all-zeros should have same maximumTableElements");
      assertEquals(empty.getNumMemories(), allZeros.getNumMemories(),
          "Empty and all-zeros should have same numMemories");
      assertEquals(empty.getNumTables(), allZeros.getNumTables(),
          "Empty and all-zeros should have same numTables");
      assertEquals(empty.getNumGlobals(), allZeros.getNumGlobals(),
          "Empty and all-zeros should have same numGlobals");
      assertEquals(empty.getNumFunctions(), allZeros.getNumFunctions(),
  ...
  class ToStringTests {
    ...
    void toStringShouldContainPrefix() {
      ...
      assertTrue(resources.toString().startsWith("ResourcesRequired{"),
    ...
    void toStringShouldContainAllFieldNames() {
      ...
      assertTrue(str.contains("minimumMemoryBytes"),
          "toString should contain 'minimumMemoryBytes'");
      assertTrue(str.contains("maximumMemoryBytes"),
          "toString should contain 'maximumMemoryBytes'");
      assertTrue(str.contains("minimumTableElements"),
          "toString should contain 'minimumTableElements'");
      assertTrue(str.contains("maximumTableElements"),
          "toString should contain 'maximumTableElements'");
