...
class WitU16Test {
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() {
      assertTrue(Modifier.isFinal(WitU16.class.getModifiers()), "WitU16 should be final");
    }
  ...
  class FactoryMethodTests {
    ...
    void shouldHaveOfFactoryMethod() throws NoSuchMethodException {
      final Method method = WitU16.class.getMethod("of", short.class);
      assertNotNull(method, "Should have of(short) method");
      assertEquals(WitU16.class, method.getReturnType(), "Should return WitU16");
    }

    @Test
    @DisplayName("should have ofUnsigned factory method")
    void shouldHaveOfUnsignedFactoryMethod() throws NoSuchMethodException {
      final Method method = WitU16.class.getMethod("ofUnsigned", int.class);
