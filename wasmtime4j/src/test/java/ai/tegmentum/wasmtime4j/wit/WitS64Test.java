...
class WitS64Test {
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() {
      assertTrue(Modifier.isFinal(WitS64.class.getModifiers()), "WitS64 should be final");
    }
  ...
  class FactoryMethodTests {
    ...
    void shouldHaveOfFactoryMethod() throws NoSuchMethodException {
      final Method method = WitS64.class.getMethod("of", long.class);
      assertNotNull(method, "Should have of(long) method");
      assertEquals(WitS64.class, method.getReturnType(), "Should return WitS64");
    }
