...
class WitStringTest {
  ...
  class FactoryMethodTests {
    ...
    void shouldCreateFromValidString() throws WitMarshallingException {
    ...
    void shouldCreateFromEmptyString() throws WitMarshallingException {
    ...
    void shouldCreateFromUnicodeString() throws WitMarshallingException {
    ...
    void shouldThrowOnNullValue() {
      assertThrows(
          ...
          () -> WitString.of(null),
          "Should throw WitMarshallingException for null");
    }
  }
  ...
  class ValueAccessTests {
    ...
    void getValueShouldReturnCorrectValue() throws WitMarshallingException {
    ...
    void toJavaShouldReturnSameString() throws WitMarshallingException {
      final WitString witString = WitString.of("test");
  ...
  class EqualityTests {
    ...
    void sameStringValueShouldBeEqual() throws WitMarshallingException {
    ...
    void differentStringValuesShouldNotBeEqual() throws WitMarshallingException {
      final WitString str1 = WitString.of("hello");
    ...
    void shouldNotEqualNull() throws WitMarshallingException {
      final WitString witString = WitString.of("test");
    ...
    void shouldNotEqualDifferentType() throws WitMarshallingException {
      final WitString witString = WitString.of("test");
  ...
  class HashCodeTests {
    ...
    void sameStringValueShouldHaveSameHashCode() throws WitMarshallingException {
      final WitString str1 = WitString.of("hello");
      final WitString str2 = WitString.of("hello");
  ...
  class ToStringTests {
    ...
    void toStringShouldContainValue() throws WitMarshallingException {
      final WitString witString = WitString.of("hello");
  ...
  class TypeTests {
    ...
    void shouldHaveWitType() throws WitMarshallingException {
      final WitString witString = WitString.of("test");
