...
final class BenchmarkRunnerTest {
    ...
    void testBenchmarkCategoryValues() {
        ...
        assertThat(BenchmarkRunner.BenchmarkCategory.values()).containsExactly(
    ...
    void testBenchmarkCategoryPatterns() {
        ...
        assertThat(BenchmarkRunner.BenchmarkCategory.ALL.getPattern())
                .isEqualTo(".*");
    }
    ...
    void testBenchmarkCategoryDescriptions() {
        ...
        for (final BenchmarkRunner.BenchmarkCategory category : BenchmarkRunner.BenchmarkCategory.values()) {
    ...
    void testBenchmarkProfileValues() {
        ...
        assertThat(BenchmarkRunner.BenchmarkProfile.values()).containsExactly(
    ...
    void testBenchmarkProfileConfigurations() {
        ...
        final BenchmarkRunner.BenchmarkProfile comprehensive = BenchmarkRunner.BenchmarkProfile.COMPREHENSIVE;
    ...
    void testProfileProgressiveComplexity() {
        ...
        for (int i = 1; i < profiles.length; i++) {
            ...
            assertThat(current.getTimePerIteration().getTime()).isGreaterThanOrEqualTo(
                    previous.getTimePerIteration().getTime());
        }
    }
}