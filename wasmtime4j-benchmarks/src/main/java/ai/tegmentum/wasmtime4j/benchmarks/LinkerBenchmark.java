 ...
 * <ul>
 *   <li>Host function definition</li>
 *   <li>Module instantiation with import resolution</li>
 *   <li>Host function invocation overhead</li>
 *   <li>Linker creation and cleanup</li>
 * </ul>
 *
...
@Fork(value = 1, jvmArgs = {"-XX:+UnlockExperimentalVMOptions", "--enable-preview"})
...
public class LinkerBenchmark {
  ...
  private static final byte[] WASM_MODULE_WITH_IMPORTS = {
      ...
      // Type section
      0x01, 0x07, // Section id=1, length=7
      0x01, // 1 type
      0x60, 0x02, 0x7f, 0x7f, 0x01, 0x7f, // (i32, i32) -> i32

      // Import section
      0x02, 0x0b, // Section id=2, length=11
      0x01, // 1 import
      0x03, 0x65, 0x6e, 0x76, // Module name "env"
      0x03, 0x61, 0x64, 0x64, // Field name "add"
      0x00, 0x00, // Import type: function index 0

      // Function section
      0x03, 0x02, // Section id=3, length=2
      0x01, 0x00, // 1 function, type index 0

      // Export section
      0x07, 0x0c, // Section id=7, length=12
      0x01, // 1 export
      0x08, 0x63, 0x61, 0x6c, 0x6c, 0x5f, 0x61, 0x64, 0x64, // Name "call_add"
      0x00, 0x01, // Export type: function index 1

      // Code section
      0x0a, 0x09, // Section id=10, length=9
  ...
  private static final byte[] WASM_MODULE_NO_IMPORTS = {
      ...
      // Type section
      0x01, 0x05, // Section id=1, length=5
      0x01, // 1 type
      ...
      // Export section
      0x07, 0x0e, // Section id=7, length=14
      0x01, // 1 export
      0x0a, 0x67, 0x65, 0x74, 0x5f, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, // Name "get_answer"
      0x00, 0x00, // Export type: function index 0

      // Code section
      0x0a, 0x06, // Section id=10, length=6
      0x01, // 1 function body
      0x04, // Body length=4
      0x00, // Local declarations count=0
  ...
  public void setup() throws WasmException {
    ...
    final FunctionType addType = new FunctionType(
        new WasmValueType[]{WasmValueType.I32, WasmValueType.I32},
        new WasmValueType[]{WasmValueType.I32}
    );

    final HostFunction addFunction = (params) -> {
  ...
  public void benchmarkDefineHostFunction() throws WasmException {
    ...
    try {
      final FunctionType mathType = new FunctionType(
          new WasmValueType[]{WasmValueType.I32, WasmValueType.I32},
          new WasmValueType[]{WasmValueType.I32}
      );

      final HostFunction multiplyFunction = (params) -> {
        final int a = params[0].asI32();
        final int b = params[1].asI32();
        return new WasmValue[]{WasmValue.ofI32(a * b)};
      };
  ...
  public void benchmarkDefineMultipleHostFunctions() throws WasmException {
    ...
    try {
      ...
      tempLinker.defineHostFunction("env", "add", mathType, (params) -> {
        final int a = params[0].asI32();
        final int b = params[1].asI32();
        return new WasmValue[]{WasmValue.ofI32(a + b)};
      });

      tempLinker.defineHostFunction("env", "sub", mathType, (params) -> {
        final int a = params[0].asI32();
        final int b = params[1].asI32();
        return new WasmValue[]{WasmValue.ofI32(a - b)};
      });

      tempLinker.defineHostFunction("env", "mul", mathType, (params) -> {
        final int a = params[0].asI32();
        final int b = params[1].asI32();
        return new WasmValue[]{WasmValue.ofI32(a * b)};
      });

      tempLinker.defineHostFunction("env", "div", mathType, (params) -> {
        final int a = params[0].asI32();
        final int b = params[1].asI32();
        return new WasmValue[]{WasmValue.ofI32(a / b)};
      });

      tempLinker.defineHostFunction("env", "mod", mathType, (params) -> {
        final int a = params[0].asI32();
        final int b = params[1].asI32();
        return new WasmValue[]{WasmValue.ofI32(a % b)};
      });
  ...
  public void benchmarkLinkerCleanup() throws WasmException {
    ...
    tempLinker.defineHostFunction("env", "test1", mathType, (params) -> new WasmValue[]{WasmValue.ofI32(1)});
    tempLinker.defineHostFunction("env", "test2", mathType, (params) -> new WasmValue[]{WasmValue.ofI32(2)});
    tempLinker.defineHostFunction("env", "test3", mathType, (params) -> new WasmValue[]{WasmValue.ofI32(3)});
