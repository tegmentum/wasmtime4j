 ...
 *
 * <p>This benchmark class measures the performance characteristics of WebAssembly
 * memory operations, comparing JNI and Panama implementations across different
 * memory access patterns and data sizes.
 *
 * <p>Key metrics measured:
 * <ul>
 *   <li>Memory allocation and deallocation performance</li>
 *   <li>Memory read/write operations</li>
 *   <li>Bulk memory operations</li>
 *   <li>Memory growth operations</li>
 *   <li>Cross-boundary data marshalling</li>
 * </ul>
 */
...
public class MemoryOperationBenchmark extends BenchmarkBase {
    ...
    private static final class MockWasmMemory {
        ...
        void copy(final int srcOffset, final int dstOffset, final int length) {
            if (srcOffset < 0 || srcOffset + length > currentSize ||
                dstOffset < 0 || dstOffset + length > currentSize) {
