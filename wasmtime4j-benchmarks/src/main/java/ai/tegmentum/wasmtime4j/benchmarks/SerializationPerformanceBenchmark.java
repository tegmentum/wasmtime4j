...
import ai.tegmentum.wasmtime4j.serialization.SerializationResult;
 ...
 *
 * <p>This benchmark suite measures the performance of various serialization strategies
 * including different formats, compression levels, optimization settings, and caching strategies.
 *
...
@Fork(value = 2, jvmArgs = {"-Xmx4g", "-XX:+UseG1GC"})
@Warmup(iterations = 3, time = 2, timeUnit = TimeUnit.SECONDS)
@Measurement(iterations = 5, time = 3, timeUnit = TimeUnit.SECONDS)
public class SerializationPerformanceBenchmark {

    private static final Logger LOGGER = Logger.getLogger(SerializationPerformanceBenchmark.class.getName());
    ...
    private static class MockModule implements ai.tegmentum.wasmtime4j.Module {
        ...
        @Override
        public java.util.Optional<ai.tegmentum.wasmtime4j.FuncType> getFunctionType(String functionName) {
