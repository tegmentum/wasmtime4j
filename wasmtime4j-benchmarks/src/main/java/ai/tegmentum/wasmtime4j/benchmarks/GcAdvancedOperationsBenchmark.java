 ...
 *
 * <p>This benchmark suite measures the performance of complex GC operations including advanced
 * reference type operations, struct and array manipulations, garbage collection strategies, and
 * debugging tools.
 *
 * @since 1.0.0
 */
...
public class GcAdvancedOperationsBenchmark {
    ...
    for (int i = 0; i < 1000; i++) {
      ...
      testArrays[i] =
          gcRuntime.createArray(
              intArrayType, List.of(GcValue.i32(i), GcValue.i32(i * 2), GcValue.i32(i * 3)));
    }
  }
  ...
  public StructInstance benchmarkStructCreation(Blackhole bh) {
    StructInstance struct =
        gcRuntime.createStruct(
            personType, List.of(GcValue.i32(25), GcValue.f32(175.5f), GcValue.i32(10)));
    bh.consume(struct);
    return struct;
  }
  ...
  public StructInstance benchmarkPackedStructCreation(Blackhole bh) {
    ...
    StructInstance packed =
        gcRuntime.createPackedStruct(
            packedType, List.of(GcValue.i32(127), GcValue.i32(1000)), alignment);
    bh.consume(packed);
    return packed;
  }
  ...
  public ReferenceSafetyResult benchmarkReferenceSafetyValidation(Blackhole bh) {
    ReferenceSafetyResult result =
        gcRuntime.validateReferenceSafety(List.of(testStructs[0], testStructs[1]));
    bh.consume(result);
    return result;
  }
  ...
  public void benchmarkMixedOperationsStress(Blackhole bh) {
    ...
    StructInstance struct =
        gcRuntime.createStruct(
            personType, List.of(GcValue.i32(25), GcValue.f32(170.0f), GcValue.i32(8)));
