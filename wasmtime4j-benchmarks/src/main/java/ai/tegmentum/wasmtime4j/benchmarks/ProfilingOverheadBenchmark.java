 ...
 *
 * <p>This benchmark measures the performance impact of profiling on various operations to ensure
 * that the profiling infrastructure doesn't significantly degrade application performance in
...
public class ProfilingOverheadBenchmark {
  ...
  public void profiledSimpleOperation(BenchmarkState state, Blackhole blackhole) {
    final int result =
        state.profiler.profileOperation(
            "simple_computation", () -> performSimpleComputation(100), "JNI");
    blackhole.consume(result);
  }
  ...
  public void profiledNestedOperations(BenchmarkState state, Blackhole blackhole) {
    final int result =
        state.profiler.profileOperation(
            "nested_root",
            () -> {
              return state.profiler.profileOperation(
                  "nested_level_1",
                  () -> {
                    return state.profiler.profileOperation(
                        "nested_level_2",
  ...
  public void functionExecutionRecording(BenchmarkState state, Blackhole blackhole) {
    state.profiler.recordFunctionExecution(
        "benchmark_function", Duration.ofNanos(1000), 256, "JNI");
  ...
  public void flameGraphDataCollection(BenchmarkState state, Blackhole blackhole) {
    final long sampleId =
        state.flameGraphGenerator.recordSample(
  ...
  public void stackTraceCollection(BenchmarkState state, Blackhole blackhole) {
    ...
    state.profiler.recordFunctionExecution("stack_trace_test", Duration.ofNanos(2000), 0, "JNI");
  ...
  public void measureOverheadPercentage(BenchmarkState state, Blackhole blackhole) {
    ...
    for (int i = 0; i < iterations; i++) {
      state.profiler.profileOperation(
          "overhead_measurement", () -> performSimpleComputation(10), "JNI");
    }
