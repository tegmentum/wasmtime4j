...
/**
 * Benchmarks measuring per-operation overhead of typed function calls.
 *
 * <p>This benchmark isolates the overhead of individual typed function call operations to measure
 * the impact of eliminating redundant ensureNotClosed() checks and caching store native handles in
 * JniTypedFunc.
 */
@State(Scope.Thread)
...
@Fork(2)
public class TypedFuncOverheadBenchmark extends BenchmarkBase {
