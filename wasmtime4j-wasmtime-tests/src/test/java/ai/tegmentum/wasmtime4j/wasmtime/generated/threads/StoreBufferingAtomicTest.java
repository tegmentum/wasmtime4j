...
/**
 * Store Buffering (SB) memory model test with atomic operations.
 *
 * <p>Tests the Store Buffering litmus test using atomic stores and loads. With atomic operations,
 * the outcome (L_0=0 && L_1=0) is forbidden due to sequential consistency.
 *
 * <p>Allowed: (L_0=1 && L_1=1) || (L_0=0 && L_1=1) || (L_0=1 && L_1=0)
 *
 * <p>Source:
 * https://github.com/bytecodealliance/wasmtime/blob/main/tests/misc_testsuite/threads/SB_atomic.wast
 */
public final class StoreBufferingAtomicTest extends DualRuntimeTest {

  private static final String SHARED_MEMORY_MODULE =
      "(module (memory (export \"shared\") 1 1 shared))";

  /** Thread 1: atomic store 1 to offset 0, atomic load from offset 4. */
  ...
  /** Thread 2: atomic store 1 to offset 4, atomic load from offset 0. */
  ...
  /**
   * Check module: verifies allowed results. With atomics, (L_0=0 && L_1=0) is forbidden.
   *
   * <p>Allowed: (L_0=1 && L_1=1) || (L_0=0 && L_1=1) || (L_0=1 && L_1=0)
   */
  ...
  @DisplayName("Store Buffering - atomic")
  public void testStoreBufferingAtomic(final RuntimeType runtime) throws Exception {
    setRuntime(runtime);
