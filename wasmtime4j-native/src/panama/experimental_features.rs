...
pub extern "C" fn wasmtime4j_panama_experimental_enable_stack_switching(
    ...
    ffi_utils::ffi_try_code(|| unsafe {
        core::enable_stack_switching(config_ptr, stack_size as u64, max_stacks as u32)
    })
}
...
pub extern "C" fn wasmtime4j_panama_experimental_enable_call_cc(
    ...
    ffi_utils::ffi_try_code(|| unsafe {
        core::enable_call_cc(config_ptr, max_continuations as u32, storage_strategy)
    })
}
...
pub extern "C" fn wasmtime4j_panama_experimental_apply_features(
    ...
    ffi_utils::ffi_try_code(|| {
        unsafe {
            ...
            core::apply_experimental_features(experimental_config_ptr, wasmtime_config)
        }
    })
}
...
pub extern "C" fn wasmtime4j_panama_experimental_enable_custom_page_sizes(
    ...
    ffi_utils::ffi_try_code(|| unsafe {
        core::enable_custom_page_sizes(config_ptr, page_size as u32, strategy, strict_alignment)
    })
}
