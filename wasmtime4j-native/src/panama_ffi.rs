...
pub mod store {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_store_set_fuel(
        store_ptr: *mut c_void,
        fuel: c_ulong,
    ) -> c_int {
        use crate::error::ffi_utils;
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_store_get_fuel(
        store_ptr: *mut c_void,
    ...
    /// Add fuel to a WebAssembly store (Panama FFI version)
    #[no_mangle]
    pub extern "C" fn wasmtime4j_store_add_fuel(
        store_ptr: *mut c_void,
        fuel: c_ulong,
        ...
        ffi_utils::ffi_try_code(|| {
            let store = unsafe { crate::store::core::get_store_ref(store_ptr)? };
            crate::store::core::add_fuel(store, fuel as u64)?;
            Ok(())
        })
    }
    
    /// Set epoch deadline for a WebAssembly store (Panama FFI version)
    #[no_mangle]
    pub extern "C" fn wasmtime4j_store_set_epoch_deadline(
        store_ptr: *mut c_void,
        ticks: c_ulong,
        ...
        ffi_utils::ffi_try_code(|| {
            let store = unsafe { crate::store::core::get_store_ref(store_ptr)? };
            crate::store::core::set_epoch_deadline(store, ticks as u64);
            Ok(())
        })
    }
    
    /// Trigger garbage collection for a WebAssembly store (Panama FFI version)
    #[no_mangle]
    pub extern "C" fn wasmtime4j_store_gc(
        store_ptr: *mut c_void,
    ) -> c_int {
        use crate::error::ffi_utils;
        ...
        ffi_utils::ffi_try_code(|| {
            let store = unsafe { crate::store::core::get_store_ref(store_ptr)? };
            crate::store::core::garbage_collect(store)?;
            Ok(())
        })
    }
    
    /// Get execution statistics for a WebAssembly store (Panama FFI version)
    #[no_mangle]
    pub extern "C" fn wasmtime4j_store_get_execution_stats(
        store_ptr: *mut c_void,
        execution_count: *mut c_ulong,
        fuel_consumed: *mut c_ulong,
        total_execution_time_ns: *mut c_ulong,
    ) -> c_int {
        use crate::error::ffi_utils;
        ...
        ffi_utils::ffi_try_code(|| {
            ...
            let stats = crate::store::core::get_execution_stats(store)?;
            
            unsafe {
                if !execution_count.is_null() {
                    *execution_count = stats.execution_count as c_ulong;
                }
                if !fuel_consumed.is_null() {
                    *fuel_consumed = stats.fuel_consumed as c_ulong;
                }
                if !total_execution_time_ns.is_null() {
                    *total_execution_time_ns = stats.total_execution_time.as_nanos() as c_ulong;
                }
            }
    ...
    /// Get memory usage statistics for a WebAssembly store (Panama FFI version)
    #[no_mangle]
    pub extern "C" fn wasmtime4j_store_get_memory_usage(
        store_ptr: *mut c_void,
        ...
        ffi_utils::ffi_try_code(|| {
            ...
            let usage = crate::store::core::get_memory_usage(store)?;
            
            unsafe {
                if !total_bytes.is_null() {
                    *total_bytes = usage.total_bytes;
                }
                if !used_bytes.is_null() {
    ...
    /// Validate store functionality (Panama FFI version)
    #[no_mangle]
    pub extern "C" fn wasmtime4j_store_validate(
        store_ptr: *mut c_void,
    ) -> c_int {
        use crate::error::ffi_utils;
        ...
        ffi_utils::ffi_try_code(|| {
            let store = unsafe { crate::store::core::get_store_ref(store_ptr)? };
            crate::store::core::validate_store(store)?;
            Ok(())
        })
    }
}
...
pub mod function {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_func_get(
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_func_get_param_types(
        func_ptr: *mut c_void,
        store_ptr: *mut c_void,
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_func_get_result_types(
        func_ptr: *mut c_void,
        store_ptr: *mut c_void,
        types_ptr: *mut *mut c_int,
        count_ptr: *mut usize,
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_func_call(
        func_ptr: *mut c_void,
        store_ptr: *mut c_void,
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_func_type(
        func_ptr: *mut c_void,
        store_ptr: *mut c_void,
    ) -> *mut c_void {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_func_type_destroy(func_type_ptr: *mut c_void) {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_func_free_types_array(types_ptr: *mut c_int, count: usize) {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_func_destroy(func_ptr: *mut c_void) {
        if !func_ptr.is_null() {
            unsafe {
