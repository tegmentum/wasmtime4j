...
pub mod caller {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_get_fuel(
        ...
        ffi_utils::ffi_try_int(|| {
            ...
            match core::caller_get_fuel(caller)? {
                ...
                None => Ok(0), // Fuel metering not enabled
            }
        })
    }
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_get_fuel_remaining(
        caller_ptr: *mut c_void,
        fuel_out: *mut c_ulong,
    ) -> c_int {
        if caller_ptr.is_null() || fuel_out.is_null() {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_add_fuel(
        caller_ptr: *mut c_void,
        fuel: c_ulong,
    ) -> c_int {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_set_epoch_deadline(
        caller_ptr: *mut c_void,
        deadline: c_ulong,
    ) -> c_int {
        if caller_ptr.is_null() {
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_has_epoch_deadline(
        caller_ptr: *mut c_void,
    ) -> c_int {
        if caller_ptr.is_null() {
            return -1; // Error: null pointer
        ...
        ffi_utils::ffi_try_int(|| {
            ...
            match core::caller_has_epoch_deadline(caller)? {
                true => Ok(1), // Has deadline
                false => Ok(0), // No deadline
            }
        })
    }
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_has_export(
        caller_ptr: *mut c_void,
        name: *const c_char,
    ) -> c_int {
        ...
        ffi_utils::ffi_try_int(|| {
            ...
            match core::caller_has_export(caller, name_str)? {
                true => Ok(1), // Has export
                false => Ok(0), // No export
            }
        })
    }
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_get_memory(
        caller_ptr: *mut c_void,
        name: *const c_char,
        ...
        ffi_utils::ffi_try_int(|| {
            ...
            match core::caller_get_memory(caller, name_str)? {
                ...
                None => {
                    ...
                    Ok(0) // No memory export with this name
                }
            }
        })
    }
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_get_function(
        caller_ptr: *mut c_void,
        name: *const c_char,
        ...
        ffi_utils::ffi_try_int(|| {
            ...
            match core::caller_get_function(caller, name_str)? {
                ...
                None => {
                    ...
                    Ok(0) // No function export with this name
                }
            }
        })
    }
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_get_global(
        caller_ptr: *mut c_void,
        name: *const c_char,
        ...
        ffi_utils::ffi_try_int(|| {
            ...
            match core::caller_get_global(caller, name_str)? {
                ...
                None => {
                    ...
                    Ok(0) // No global export with this name
                }
            }
        })
    }
    ...
    #[no_mangle]
    pub extern "C" fn wasmtime4j_caller_get_table(
        caller_ptr: *mut c_void,
        name: *const c_char,
        ...
        ffi_utils::ffi_try_int(|| {
            ...
            match core::caller_get_table(caller, name_str)? {
                ...
                None => {
                    ...
                    Ok(0) // No table export with this name
                }
            }
        })
    }
