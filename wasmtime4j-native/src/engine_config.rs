...
#[derive(Debug, Clone, Default)]
pub struct CompilationTimeLimitsConfig {
...
#[derive(Debug, Clone, Default)]
pub struct AddressSanitizationConfig {
    pub enabled: bool,
}
...
#[derive(Debug, Clone, Default)]
pub struct CompilationMetricsConfig {
    pub enabled: bool,
}
...
#[derive(Debug, Clone, Default)]
pub struct ParallelCompilationSettings {
    pub enabled: bool,
}

#[derive(Debug, Clone, Default)]
pub struct FunctionParallelismConfig {
    pub enabled: bool,
}

#[derive(Debug, Clone, Default)]
pub struct ModuleParallelismConfig {
    pub enabled: bool,
}
...
#[derive(Debug, Clone, Default)]
pub struct WorkSchedulingConfig {
    pub strategy: String,
}
