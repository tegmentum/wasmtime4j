 ...
 * wasmtime4j-bindgen --wasm module.wasm --package com.example --output target/generated
 *
 * # Generate legacy Java 8 compatible code
 * wasmtime4j-bindgen --wit src/main/wit --package com.example --style LEGACY
 *
 * # Generate with multiple sources
 * wasmtime4j-bindgen --wit api.wit --wit types.wit --package com.example
 * </pre>
 */
@Command(
    name = "wasmtime4j-bindgen",
    mixinStandardHelpOptions = true,
    version = "wasmtime4j-bindgen 1.0.0",
