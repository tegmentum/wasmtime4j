 ...
 * @since 1.0.0
 */
public final class CompleteTestAnalysis {
  ...
  /**
   * Creates a new complete test analysis.
   *
  ...
  /**
   * Gets the behavioral analysis results.
   *
  ...
  /**
   * Gets the performance comparison results.
   *
  ...
  /**
   * Gets the coverage analysis results.
   *
