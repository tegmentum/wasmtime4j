...
final class FormattingConfiguration {
...
/** Levels of recommendation detail to include in reports. */
...
enum DateTimeFormat {
  ...
  /** Short format (01/01/23 12:00). */
  SHORT,

  /** Full format (January 1, 2023 12:00:00 PM UTC). */
  FULL,
...
enum NumberFormat {
  ...
  /** Scientific formatting (1.23E+3). */
  SCIENTIFIC,

  /** Detailed formatting with precision (1,234.5600). */
  DETAILED
}
