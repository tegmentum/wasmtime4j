...
final class SearchConfiguration {
  ...
  private final boolean enableRegexSearch;
  private final boolean caseSensitive;
  private final int maxSearchResults;

  public SearchConfiguration(
      final boolean enableFuzzySearch,
      final boolean enableRegexSearch,
      final boolean caseSensitive,
      final int maxSearchResults) {
    this.enableFuzzySearch = enableFuzzySearch;
    this.enableRegexSearch = enableRegexSearch;
  ...
  public boolean isEnableRegexSearch() {
  ...
  public static SearchConfiguration defaultConfiguration() {
    return new SearchConfiguration(false, true, false, 1000);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enableFuzzySearch, enableRegexSearch, caseSensitive, maxSearchResults);
  }
