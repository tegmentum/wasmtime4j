...
public final class SinkFloatButDontTrapTest extends DualRuntimeTest {
  ...
  public void testSinkFloatButDontTrap(final RuntimeType runtime) throws Exception {
    ...
    try (final WastTestRunner runner = new WastTestRunner()) {
      ...
      // WAT file: ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/SinkFloatButDontTrapTest_module1.wat
      final String moduleWat1 = loadResource("/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/SinkFloatButDontTrapTest_module1.wat");
      runner.compileAndInstantiate(moduleWat1);

      // ( assert_return ( invoke "select-with-sink" ( i32.const 0xfff8)) ( f64.const 0))
      runner.assertReturn("select-with-sink", new WasmValue[] { WasmValue.f64(0.0) }, WasmValue.i32(0xfff8));

      // ( assert_return ( invoke "select-with-fcmp-and-sink" ( i32.const 0xfff8) ( f64.const 0) ( f64.const 0)) ( f64.const 1))
      runner.assertReturn("select-with-fcmp-and-sink", new WasmValue[] { WasmValue.f64(1.0) }, WasmValue.i32(0xfff8), WasmValue.f64(0.0), WasmValue.f64(0.0));
      ...
      runner.assertTrap("select-with-fcmp-and-sink", "out of bounds", WasmValue.i32(0xfff9), WasmValue.f64(0.0), WasmValue.f64(0.0));
      ...
      runner.assertTrap("select-with-fcmp-and-sink-other-way", "out of bounds", WasmValue.i32(0xfff9), WasmValue.f64(0.0), WasmValue.f64(0.0));
