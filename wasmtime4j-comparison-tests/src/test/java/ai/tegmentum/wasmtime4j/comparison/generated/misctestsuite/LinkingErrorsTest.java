 ...
 *
 * <p>Original source: linking-errors.wast:1 Category: misc_testsuite
 *
...
public final class LinkingErrorsTest {
  ...
  public void testLinkingErrors() {
    ...
    //   "expected table limits (min: 1, max: none) doesn't match provided table limits (min: 0,
    // max: none)")
    //
    // (assert_unlinkable
    ...
    //   "expected memory limits (min: 1, max: none) doesn't match provided memory limits (min: 0,
    // max: none)")
    //
    // ;; errors on functions
    // (assert_unlinkable
    ...
    //   "expected type `(func (param i32 i32) (result f64))`, found type `(func (param f32) (result
    // i32 i64))`")
