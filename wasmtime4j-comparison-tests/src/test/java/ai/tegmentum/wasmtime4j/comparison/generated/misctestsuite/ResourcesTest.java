...
/**
 * Equivalent Java test for Wasmtime test: misc_testsuite::resources
 *
 * <p>Original source: resources.wast:1 Category: misc_testsuite
 *
...
public final class ResourcesTest {
  ...
  @Test
  @DisplayName("misc_testsuite::resources")
  public void testResources() {
    ...
    //     (export "[method]resource1.take-borrow" (func (param "self" (borrow $r)) (param "b"
    // (borrow $r))))
    //     (export "[method]resource1.take-own" (func (param "self" (borrow $r)) (param "b" (own
    // $r))))
    //   ))
    //
    //   (alias export $host "resource1" (type $r))
