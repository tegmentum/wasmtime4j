...
public final class MemoryCombosTest extends DualRuntimeTest {
  ...
  public void testMemoryCombos(final RuntimeType runtime) throws Exception {
    ...
    try (final WastTestRunner runner = new WastTestRunner()) {
      ...
      // WAT file: ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/MemoryCombosTest_module1.wat
      final String moduleWat1 = loadResource("/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/MemoryCombosTest_module1.wat");
      ...
      runner.assertTrap("store_m1", "out of bounds memory access", WasmValue.i32(65536), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m1", "out of bounds memory access", WasmValue.i32(-1), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m2", "out of bounds memory access", WasmValue.i32(65536), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m2", "out of bounds memory access", WasmValue.i32(-1), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m3", "out of bounds memory access", WasmValue.i32(1), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m4", "out of bounds memory access", WasmValue.i32(1), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m6", "out of bounds memory access", WasmValue.i32(65536), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m6", "out of bounds memory access", WasmValue.i32(-1), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m8", "out of bounds memory access", WasmValue.i32(1), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m9", "out of bounds memory access", WasmValue.i64(65536L), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m9", "out of bounds memory access", WasmValue.i64(-1L), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m10", "out of bounds memory access", WasmValue.i64(65536L), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m10", "out of bounds memory access", WasmValue.i64(-1L), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m11", "out of bounds memory access", WasmValue.i64(1L), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m12", "out of bounds memory access", WasmValue.i64(1L), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m14", "out of bounds memory access", WasmValue.i64(65536L), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m14", "out of bounds memory access", WasmValue.i64(-1L), WasmValue.i32(0));
      ...
      runner.assertTrap("store_m16", "out of bounds memory access", WasmValue.i64(1L), WasmValue.i32(0));
