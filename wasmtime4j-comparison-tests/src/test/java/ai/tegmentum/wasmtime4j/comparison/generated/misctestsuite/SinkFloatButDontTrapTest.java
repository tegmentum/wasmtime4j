 ...
 *
 * <p>Original source: sink-float-but-dont-trap.wast:1 Category: misc_testsuite
 *
...
public final class SinkFloatButDontTrapTest {
  ...
  public void testSinkFloatButDontTrap() {
    ...
    // (assert_trap (invoke "select-with-fcmp-and-sink" (i32.const 0xfff9) (f64.const 0) (f64.const
    // 0)) "out of bounds")
    // (assert_trap (invoke "select-with-sink-other-way" (i32.const 0xfff9)) "out of bounds")
    // (assert_trap (invoke "select-with-fcmp-and-sink-other-way" (i32.const 0xfff9) (f64.const 0)
