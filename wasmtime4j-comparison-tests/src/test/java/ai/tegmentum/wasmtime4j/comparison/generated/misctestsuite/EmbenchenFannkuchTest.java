 ...
 *
 * <p>Original source: embenchen_fannkuch.wast:1 Category: misc_testsuite
 *
...
public final class EmbenchenFannkuchTest {
  ...
  public void testEmbenchenFannkuch() {
    ...
    try (final InputStream is =
        getClass().getResourceAsStream("/wasmtime-tests/misc_testsuite/embenchen-fannkuch.wat")) {
      if (is == null) {
        throw new AssertionError(
            "WAT resource not found: /wasmtime-tests/misc_testsuite/embenchen-fannkuch.wat");
      }
