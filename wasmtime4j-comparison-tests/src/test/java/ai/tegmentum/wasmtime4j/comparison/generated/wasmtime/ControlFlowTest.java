  ...
  public void testControlFlow(final RuntimeType runtime) throws Exception {
    ...
    try (final WastTestRunner runner = new WastTestRunner()) {
      ...
      final String moduleWat1 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/ControlFlowTest_module1.wat");
      ...
      final String moduleWat2 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/ControlFlowTest_module2.wat");
      ...
      final String moduleWat3 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/ControlFlowTest_module3.wat");
      runner.compileAndInstantiate(moduleWat3);

      // ( assert_return ( invoke "block" ( i32.const 10) ( i32.const 20)) ( i32.const 10))
      runner.assertReturn(
          "block", new WasmValue[] {WasmValue.i32(10)}, WasmValue.i32(10), WasmValue.i32(20));
      ...
      final String moduleWat4 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/ControlFlowTest_module4.wat");
      runner.compileAndInstantiate(moduleWat4);

      // ( assert_return ( invoke "br_block" ( i32.const 5) ( i32.const 7)) ( i32.const 12))
      runner.assertReturn(
          "br_block", new WasmValue[] {WasmValue.i32(12)}, WasmValue.i32(5), WasmValue.i32(7));
      ...
      final String moduleWat5 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/ControlFlowTest_module5.wat");
      runner.compileAndInstantiate(moduleWat5);

      // ( assert_return ( invoke "brif_block" ( i32.const 5) ( i32.const 7)) ( i32.const 12))
      runner.assertReturn(
          "brif_block", new WasmValue[] {WasmValue.i32(12)}, WasmValue.i32(5), WasmValue.i32(7));
      ...
      final String moduleWat6 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/ControlFlowTest_module6.wat");
      runner.compileAndInstantiate(moduleWat6);

      // ( assert_return ( invoke "brif_block_passthru" ( i32.const 0) ( i32.const 3)) ( i32.const
      // 6))
      runner.assertReturn(
          "brif_block_passthru",
          new WasmValue[] {WasmValue.i32(6)},
          WasmValue.i32(0),
          WasmValue.i32(3));
      ...
      final String moduleWat7 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/ControlFlowTest_module7.wat");
      ...
      final String moduleWat8 =
          loadResource(
              "/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/ControlFlowTest_module8.wat");
