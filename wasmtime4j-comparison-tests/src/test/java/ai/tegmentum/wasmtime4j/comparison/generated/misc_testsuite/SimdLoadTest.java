...
/**
 * Equivalent Java test for Wasmtime test: misc_testsuite::_simd_load
 *
 * <p>Original source: _simd_load.wast:1 Category: misc_testsuite
 *
 * <p>This test validates that wasmtime4j produces the same results as the upstream Wasmtime
 * implementation for this test case.
 */
public final class SimdLoadTest {

  @Test
  @DisplayName("misc_testsuite::_simd_load")
  public void testSimdLoad() {
    ...
    // )
    //
    // (assert_return (invoke "v128.load") (v128.const i8x16 0x00 0x01 0x02 0x03 0x04 0x05 0x06 0x07
    // 0x08 0x09 0x0a 0x0b 0x0c 0x0d 0x0e 0x0f))
    // (assert_return (invoke "v128.load") (v128.const i16x8 0x0100 0x0302 0x0504 0x0706 0x0908
    // 0x0b0a 0x0d0c 0x0f0e))
    // (assert_return (invoke "v128.load") (v128.const i32x4 0x03020100 0x07060504 0x0b0a0908
    // 0x0f0e0d0c))
    //
    //
    ...
    // ;;   )
    // ;; )
    // ;; (assert_return (invoke "as-i8x16.eq-operand") (v128.const i32x4 0xffffffff 0x00000000
    ...
    // ;;   )
    // ;; )
    // ;; (assert_return (invoke "as-v128.not-operand") (v128.const i32x4 0xfcfdfeff 0xf8f9fafb
    // 0xf4f5f6f7 0xf0f1f2f3))
    ...
    // ;;     (v128.bitselect (v128.load (i32.const 0)) (v128.load (i32.const 16)) (v128.load
    // (i32.const 32)))
    // ;;   )
    // ;; )
    // ;; (assert_return (invoke "as-v128.bitselect-operand") (v128.const i32x4 0xabababab
    // 0xaaaaaaaa 0xbbbbbbbb 0xbbaabbaa))
    //
    // ;; (module (memory 1)
    // ;;   (data (offset (i32.const 0)) "\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA")
    ...
    // ;;   )
    // ;; )
    // ;; (assert_return (invoke "as-i8x16.shl-operand") (v128.const i32x4 0x54545454 0x54545454
    // 0x54545454 0x54545454)) ;; 1010 1000 << 1010 1010
    //
    // ;; (module (memory 1)
    ...
    //
    // ;; (module (memory 1)
    // ;;   (data (offset (i32.const 0))  "\00\00\00\43\00\00\80\3f\66\66\e6\3f\00\00\80\bf")  ;;
    // 128 1.0 1.8 -1
    // ;;   (data (offset (i32.const 16)) "\00\00\00\40\00\00\00\40\00\00\00\40\00\00\00\40")  ;;
    // 2.0 2.0 2.0 2.0
    ...
    //
    // ;; (module (memory 1)
    // ;;   (data (offset (i32.const 0)) "\ff\ff\ff\ff\ff\ff\ff\ff\ff\ff\ff\ff\ff\ff\ff\ff")  ;;
    // 1111 ...
    // ;;   (func (export "as-f32x4.abs-operand") (result v128)
    // ;;     (f32x4.abs (v128.load (i32.const 0)))
    // ;;   )
    // ;; )
    // ;; (assert_return (invoke "as-f32x4.abs-operand") (v128.const i32x4 0x7fffffff 0x7fffffff
    // 0x7fffffff 0x7fffffff)) ;; 1111 -> 0111
    //
    // ;; (module (memory 1)
    // ;;   (data (offset (i32.const 0)) "\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA\AA")
    ...
    // ;;   )
    // ;; )
    // ;; (assert_return (invoke "as-f32x4.min-operand") (v128.const i32x4 0xaaaaaaaa 0xaaaaaaaa
    // 0xaaaaaaaa 0xaaaaaaaa)) ;; signed 1010 < 0010
    //
    // ;; (module (memory 1)
    // ;;   (data (offset (i32.const 0))  "\00\00\00\43\00\00\80\3f\66\66\e6\3f\00\00\80\bf")  ;;
    // 128 1.0 1.8 -1
    ...
    // ;;   )
    // ;; )
    // ;; (assert_return (invoke "as-i32x4.trunc_sat_f32x4_s-operand") (v128.const i32x4 128 1 1
    // -1)) ;; 128 1.0 1.8 -1 -> 128 1 1 -1
    //
    // ;; (module (memory 1)
    // ;;   (data (offset (i32.const 0)) "\02\00\00\00\02\00\00\00\02\00\00\00\02\00\00\00")
    ...
    //
    // ;; (module (memory 1)
    // ;;   (data (offset (i32.const 0)) "\64\65\66\67\68\69\6a\6b\6c\6d\6e\6f\70\71\72\73")  ;; 100
    // 101 102 103 104 105 106 107 108 109 110 111 112 113 114 115
    // ;;   (data (offset (i32.const 16)) "\0f\0e\0d\0c\0b\0a\09\08\07\06\05\04\03\02\01\00")  ;;
    ...
    // ;;   )
    // ;; )
    // ;; (assert_return(invoke "as-i8x16.swizzle-operand") (v128.const i8x16 115 114 113 112 111
    ...
    //   )
    // )
    // (assert_return (invoke "as-br-value") (v128.const i32x4 0x03020100 0x07060504 0x0b0a0908
    // 0x0f0e0d0c))
    //
    //
