 ...
 *
 * <p>Original source: partial-init-table-segment.wast:1 Category: misc_testsuite
 *
...
public final class PartialInitTableSegmentTest {
  ...
  public void testPartialInitTableSegment() {
    ...
    // (module $m
    //   (table (export "table") funcref (elem $zero $zero $zero $zero $zero $zero $zero $zero $zero
    // $zero))
    //
