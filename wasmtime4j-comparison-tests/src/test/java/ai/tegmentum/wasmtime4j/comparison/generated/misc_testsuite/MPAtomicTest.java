...
/**
 * Equivalent Java test for Wasmtime test: misc_testsuite::MP_atomic
 *
 * <p>Original source: MP_atomic.wast:1 Category: misc_testsuite
 *
 * <p>This test validates that wasmtime4j produces the same results as the upstream Wasmtime
 * implementation for this test case.
 */
public final class MPAtomicTest {

  @Test
  @DisplayName("misc_testsuite::MP_atomic")
  public void testMPAtomic() {
    ...
    //     (local.set 1)
    //
    //     ;; allowed results: (L_0 = 1 && L_1 = 42) || (L_0 = 0 && L_1 = 0) || (L_0 = 0 && L_1 =
    // 42)
    //
