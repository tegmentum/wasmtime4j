...
public final class PartialInitMemorySegmentTest extends DualRuntimeTest {
  ...
  public void testPartialInitMemorySegment(final RuntimeType runtime) throws Exception {
    ...
    try (final WastTestRunner runner = new WastTestRunner()) {
      ...
      // WAT file: ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/PartialInitMemorySegmentTest_module1.wat
      final String moduleWat1 = loadResource("/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/PartialInitMemorySegmentTest_module1.wat");
      runner.compileAndInstantiate(moduleWat1);

      // ( register "m" $m)
      runner.registerModule("m");

      // ( assert_trap ( module ( memory ( import "m" "mem") 1) ( data ( i32.const 0) "abc") ( data ( i32.const 65530) "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz")) "out of bounds")
