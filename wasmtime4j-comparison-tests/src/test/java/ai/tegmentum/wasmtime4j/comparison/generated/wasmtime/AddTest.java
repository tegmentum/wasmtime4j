...
public final class AddTest extends DualRuntimeTest {
  ...
  public void testAdd(final RuntimeType runtime) throws Exception {
    ...
    try (final WastTestRunner runner = new WastTestRunner()) {
      ...
      final String moduleWat1 = loadResource("/ai/tegmentum/wasmtime4j/comparison/generated/wasmtime/AddTest_module1.wat");
      runner.compileAndInstantiate(moduleWat1);

      // ( assert_return ( invoke "add" ( i32.const 1) ( i32.const 2)) ( i32.const 3))
      runner.assertReturn("add", new WasmValue[] { WasmValue.i32(3) }, WasmValue.i32(1), WasmValue.i32(2));
