 ...
 *
 * <p>This class provides WASI context functionality using JNI bindings to the native
 * Wasmtime WASI implementation. It supports both WASI Preview 1 and Preview 2 features
 * including async I/O, component model integration, and enhanced security.
 *
 * @since 1.0.0
 */
public final class JniWasiContextImpl extends JniResource implements WasiContext {
    ...
    public WasiContext preopenedDirWithPermissions(Path hostPath, String guestPath, WasiDirectoryPermissions permissions) throws WasmException {
        ...
        try {
            final int result = nativePreopenedDirWithPermissions(
                nativeHandle, hostPath.toString(), guestPath,
    ...
    private static native int nativePreopenedDir(long contextHandle, String hostPath, String guestPath);

    private static native int nativePreopenedDirReadOnly(long contextHandle, String hostPath, String guestPath);
    ...
    private static native int nativePreopenedDirWithPermissions(
        ...
        boolean canDelete, boolean canList, boolean canTraverse,
