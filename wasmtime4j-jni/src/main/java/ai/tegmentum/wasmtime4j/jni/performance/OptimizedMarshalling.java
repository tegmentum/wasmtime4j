 ...
 *
 * <p>This class provides high-performance parameter marshalling techniques that minimize
 * memory allocation and copying when transferring data between Java and WebAssembly.
 *
 * <p>Optimizations include:
 * <ul>
 *   <li>Direct ByteBuffer usage to avoid array copying</li>
 *   <li>Pooled buffer reuse for common parameter patterns</li>
 *   <li>Type-specific optimized marshalling paths</li>
 *   <li>Bulk parameter marshalling for multiple values</li>
 *   <li>Zero-copy techniques for large data transfers</li>
 *   <li>Native-endian format alignment for optimal performance</li>
 * </ul>
 *
 * <p>The marshalling system automatically selects the most efficient approach based on
 * parameter types, sizes, and usage patterns.
 *
 * @since 1.0.0
 */
public final class OptimizedMarshalling {
    ...
    private static final NativeObjectPool<ByteBuffer> BUFFER_POOL = NativeObjectPool.getPool(
        ByteBuffer.class, 
    ...
    private static final class MarshallingPlan {
        ...
        MarshallingPlan(final WasmValueType[] types, final int totalBytes, 
                       final boolean useDirect, final MarshallingStrategy strategy) {
     ...
     * @throws IllegalArgumentException if parameters are invalid
     */
    public static WasmValue[] unmarshalResults(final Object[] nativeResults, 
        ...
        try {
            if (nativeResults.length != expectedTypes.length) {
                throw new IllegalArgumentException("Result count mismatch: got " + nativeResults.length 
     ...
     * Buffered marshalling using pooled ByteBuffers.
     */
    private static Object[] marshalBuffered(final WasmValue[] parameters, final MarshallingPlan plan) {
     ...
     */
    private static WasmValue unmarshalSingleResult(final Object nativeResult, final WasmValueType expectedType) {
        ...
        throw new IllegalArgumentException("Cannot unmarshal " + nativeResult.getClass().getSimpleName() 
                                         + " as " + expectedType);
    }
    ...
    private static void evictOldMarshallingPlans() {
        ...
        MARSHALLING_CACHE.entrySet().removeIf(entry -> {
    ...
    public static String getStatistics() {
        ...
        final ConcurrentHashMap<MarshallingStrategy, Integer> strategyCounts = new ConcurrentHashMap<>();
