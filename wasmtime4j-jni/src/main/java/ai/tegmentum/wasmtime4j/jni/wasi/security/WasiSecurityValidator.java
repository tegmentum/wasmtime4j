...
/**
 * Security validation and path traversal protection for WASI operations.
 *
...
public final class WasiSecurityValidator {
  ...
  private WasiSecurityValidator(final Builder builder) {
    ...
    LOGGER.info(
        String.format(
            "Created WASI security validator: strict=%s, symlinks=%s, hidden=%s, "
   ...
   * @throws JniException if the path poses security risks
   */
   ...
   * @throws JniException if access to the variable poses security risks
   */
  ...
  public static final class Builder {
    ...
    public Builder withDangerousExtension(final String extension) {
      JniValidation.requireNonEmpty(extension, "extension");
    ...
    public Builder withBlockedDirectory(final String directory) {
      JniValidation.requireNonEmpty(directory, "directory");
    ...
    public Builder withMaxPathLength(final int maxPathLength) {
      JniValidation.requirePositive(maxPathLength, "maxPathLength");
    ...
    public Builder withMaxFileNameLength(final int maxFileNameLength) {
      JniValidation.requirePositive(maxFileNameLength, "maxFileNameLength");
