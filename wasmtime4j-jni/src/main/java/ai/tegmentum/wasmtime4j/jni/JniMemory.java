 ...
 * Wasmtime library. It supports reading and writing data at arbitrary offsets within the
 * memory space.
 *
 * <p>This implementation ensures defensive programming to prevent buffer overflows and
 * JVM crashes through extensive bounds checking.
 */
public final class JniMemory implements AutoCloseable {
     ...
     *
     * <p>The returned buffer provides direct access to the WebAssembly memory. Changes to the
     * buffer are immediately visible to WebAssembly code and vice versa.
     *
     ...
     *
     * <p>After calling this method, all operations on this memory will throw
