...
public final class JniDebugger implements Debugger {
    ...
    public SourceMapIntegration createSourceMapIntegration(final String sourceMapData) throws WasmException {
        ...
        try {
            final SourceMapIntegration integration = nativeCreateSourceMapIntegration(nativeHandle, sourceMapData);
    ...
    public ExecutionTracer createExecutionTracer(final Instance instance) throws WasmException {
        ...
        try {
            ...
            final ExecutionTracer tracer = new JniExecutionTracer(tracerHandle, instance);
    ...
    private long extractModuleHandle(final Module module) {
        JniValidation.validateNotNull(module, "module");
    ...
    private static native SourceMapIntegration nativeCreateSourceMapIntegration(long debuggerHandle, String sourceMapData);

    private static native long nativeCreateExecutionTracer(long debuggerHandle, long instanceHandle);

    private static native void nativeStartProfiling(long debuggerHandle, boolean cpuProfiling, boolean memoryProfiling);
    ...
    private static native long nativeSetBreakpointAtAddress(long debuggerHandle, long instanceHandle, int address);

    private static native long nativeSetBreakpointAtFunction(long debuggerHandle, long instanceHandle, String functionName);

    private static native long nativeSetBreakpointAtLine(long debuggerHandle, long instanceHandle, String fileName, int lineNumber);

    private static native boolean nativeRemoveBreakpoint(long debuggerHandle, long breakpointId);

    private static native List<StackFrame> nativeGetCallStack(long debuggerHandle, long instanceHandle);

    private static native List<Variable> nativeGetLocalVariables(long debuggerHandle, long instanceHandle, int frameIndex);

    private static native VariableValue nativeEvaluateExpression(long debuggerHandle, long instanceHandle, String expression);

    private static native MemoryInfo nativeInspectMemory(long debuggerHandle, long instanceHandle, int address, int length);
     ...
     */
    private static final class JniExecutionTracer implements ExecutionTracer {
        private final long nativeHandle;
