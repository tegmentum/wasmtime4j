 ...
 *
 * <p>This factory creates JNI-based WASI-NN contexts for neural network inference operations. The
 * wasi-nn feature must be compiled into the native library for this to work.
 *
 * @since 1.0.0
 */
public final class JniNnContextFactory implements NnContextFactory {
  ...
  public NnContext createNnContext() throws NnException {
    ...
    final long handle = JniNnContext.nativeCreate();
    if (handle == 0) {
