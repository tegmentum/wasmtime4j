 ...
 *
 * <p>This class represents a compiled WebAssembly module and provides access to its metadata and
 * exports through JNI calls to the native Wasmtime library. A module contains the compiled
...
public final class JniModule implements AutoCloseable {
   ...
   *
   * <p>After calling this method, all operations on this module will throw {@link
