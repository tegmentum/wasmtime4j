...
public final class JniExecutionController implements ExecutionController {
  ...
  public ExecutionContext createContext(final String contextId, final ExecutionContextConfig config) throws WasmException {
    ...
    long contextPtr = nativeCreateExecutionContext(
        contextId,
  ...
  public CompletableFuture<ExecutionResult> startExecution(final String contextId, final ExecutionRequest executionRequest) throws WasmException {
    ...
    return CompletableFuture.supplyAsync(() -> {
      try {
        long resultPtr = nativeStartExecution(
            contextPtr,
  ...
  public ExecutionTraceData exportExecutionTrace(final String contextId, final TraceFilter traceFilter) throws WasmException {
    ...
    long traceDataPtr = nativeExportExecutionTrace(
        contextPtr,
  ...
  public void configureDynamicQuotaAdjustment(final String contextId, final LoadBasedQuotaConfig loadBasedConfig) throws WasmException {
    ...
    if (!nativeConfigureDynamicQuotaAdjustment(
      ...
      throw new WasmException("Failed to configure dynamic quota adjustment for context: " + contextId);
    }
  }
  ...
  private native long nativeCreateExecutionContext(
      String contextId, int fuelPriority, long fuelQuota, long cpuTimeQuotaMs,
      long memoryQuota, int interruptMode);
  ...
  private native boolean nativeSetExecutionQuotas(
      long contextPtr, long fuelQuota, long cpuTimeQuotaMs, long memoryQuota,
      long ioOperationQuota, long networkRequestQuota, double ioRateLimit, int enforcementPolicy);

  private native boolean nativeEnableMonitoring(
      long contextPtr, boolean enableFuelTracking, boolean enablePerformanceMetrics,
      boolean enableResourceUsage, long metricsIntervalMs);

  private native boolean nativeConfigureTracing(
      long contextPtr, boolean enableFunctionTracing, boolean enableInstructionTracing,
      boolean enableMemoryTracing, long traceBufferSize);
  ...
  private native boolean nativeTerminateExecution(
      long contextPtr, boolean forceTermination, boolean cleanupResources, long terminationTimeoutMs);
  ...
  private native boolean nativeConfigureDynamicQuotaAdjustment(
      long contextPtr, boolean enabled, double loadThreshold, double adjustmentFactor, long adjustmentIntervalMs);

  private native boolean nativeEnableAnomalyDetection(
      long contextPtr, boolean enabled, double sensitivity, long detectionWindowMs, double anomalyThreshold);
