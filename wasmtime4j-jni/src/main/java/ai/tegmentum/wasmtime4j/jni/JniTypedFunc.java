...
public final class JniTypedFunc extends JniResource implements TypedFunc {
  ...
  public void callVoidToVoid() throws WasmException {
    beginOperation();
    try {
      nativeCallVoidToVoid(nativeHandle, storeNativeHandle);
    } finally {
      endOperation();
    }
  }
  ...
  public void callI32ToVoid(final int param) throws WasmException {
    beginOperation();
    try {
      nativeCallI32ToVoid(nativeHandle, storeNativeHandle, param);
    } finally {
      endOperation();
    }
  }
  ...
  public void callI32I32ToVoid(final int param1, final int param2) throws WasmException {
    beginOperation();
    try {
      nativeCallI32I32ToVoid(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
  ...
  public void callI64ToVoid(final long param) throws WasmException {
    beginOperation();
    try {
      nativeCallI64ToVoid(nativeHandle, storeNativeHandle, param);
    } finally {
      endOperation();
    }
  }
  ...
  public void callI64I64ToVoid(final long param1, final long param2) throws WasmException {
    beginOperation();
    try {
      nativeCallI64I64ToVoid(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
  ...
  public int callI32ToI32(final int param) throws WasmException {
    beginOperation();
    try {
      return nativeCallI32ToI32(nativeHandle, storeNativeHandle, param);
    } finally {
      endOperation();
    }
  }
  ...
  public int callI32I32ToI32(final int param1, final int param2) throws WasmException {
    beginOperation();
    try {
      return nativeCallI32I32ToI32(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
  ...
  public long callI64ToI64(final long param) throws WasmException {
    beginOperation();
    try {
      return nativeCallI64ToI64(nativeHandle, storeNativeHandle, param);
    } finally {
      endOperation();
    }
  }
  ...
  public long callI64I64ToI64(final long param1, final long param2) throws WasmException {
    beginOperation();
    try {
      return nativeCallI64I64ToI64(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
  ...
  public float callF32ToF32(final float param) throws WasmException {
    beginOperation();
    try {
      return nativeCallF32ToF32(nativeHandle, storeNativeHandle, param);
    } finally {
      endOperation();
    }
  }
  ...
  public double callF64ToF64(final double param) throws WasmException {
    beginOperation();
    try {
      return nativeCallF64ToF64(nativeHandle, storeNativeHandle, param);
    } finally {
      endOperation();
    }
  }
  ...
  public float callF32F32ToF32(final float param1, final float param2) throws WasmException {
    beginOperation();
    try {
      return nativeCallF32F32ToF32(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
  ...
  public double callF64F64ToF64(final double param1, final double param2) throws WasmException {
    beginOperation();
    try {
      return nativeCallF64F64ToF64(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
  ...
  public int callI32I32I32ToI32(final int param1, final int param2, final int param3)
    ...
    beginOperation();
    try {
      return nativeCallI32I32I32ToI32(nativeHandle, storeNativeHandle, param1, param2, param3);
    } finally {
      endOperation();
    }
  }
  ...
  public long callI64I64I64ToI64(final long param1, final long param2, final long param3)
    ...
    beginOperation();
    try {
      return nativeCallI64I64I64ToI64(nativeHandle, storeNativeHandle, param1, param2, param3);
    } finally {
      endOperation();
    }
  }
  ...
  public float callF32F32F32ToF32(final float param1, final float param2, final float param3)
    ...
    beginOperation();
    try {
      return nativeCallF32F32F32ToF32(nativeHandle, storeNativeHandle, param1, param2, param3);
    } finally {
      endOperation();
    }
  }
  ...
  public double callF64F64F64ToF64(final double param1, final double param2, final double param3)
    ...
    beginOperation();
    try {
      return nativeCallF64F64F64ToF64(nativeHandle, storeNativeHandle, param1, param2, param3);
    } finally {
      endOperation();
    }
  }
  ...
  public long callI32I32ToI64(final int param1, final int param2) throws WasmException {
    beginOperation();
    try {
      return nativeCallI32I32ToI64(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
  ...
  public int callI64ToI32(final long param) throws WasmException {
    beginOperation();
    try {
      return nativeCallI64ToI32(nativeHandle, storeNativeHandle, param);
    } finally {
      endOperation();
    }
  }
  ...
  public float callI32F32ToF32(final int param1, final float param2) throws WasmException {
    beginOperation();
    try {
      return nativeCallI32F32ToF32(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
  ...
  public float callF32I32ToF32(final float param1, final int param2) throws WasmException {
    beginOperation();
    try {
      return nativeCallF32I32ToF32(nativeHandle, storeNativeHandle, param1, param2);
    } finally {
      endOperation();
    }
  }
