 ...
 *
 * <p>This class provides JNI bindings for individual debugging sessions,
 * including breakpoint management, execution control, and variable inspection.
 *
...
public final class JniDebugSession implements DebugSession {
     ...
     */
    JniDebugSession(final JniDebugger debugger, final long debuggerHandle, final long instanceHandle) throws WasmException {
     ...
     */
    JniDebugSession(final JniDebugger debugger, final long debuggerHandle, final long[] instanceHandles) throws WasmException {
        ...
        try {
            this.nativeHandle = nativeCreateMultiSession(debuggerHandle, instanceHandles, DebugConfig.defaultConfig());
            ...
            LOGGER.log(Level.FINE, "Created JNI debug session {0} for {1} instances",
     ...
     */
    JniDebugSession(final JniDebugger debugger, final long debuggerHandle, final long instanceHandle, final DebugConfig config) throws WasmException {
        this.sessionId = "debug-session-" + SESSION_ID_COUNTER.getAndIncrement();
        this.debugger = Objects.requireNonNull(debugger, "debugger cannot be null");
        this.eventListeners = new CopyOnWriteArrayList<>();
        this.closed = false;
    ...
    public Breakpoint setBreakpoint(final String functionName, final int line) throws WasmException {
        ...
        try {
            ...
            throw JniExceptionHandler.wrapException(e, "Failed to set breakpoint at " + functionName + ":" + line);
        }
    }

    @Override
    public Breakpoint setBreakpoint(final String functionName, final long instructionOffset) throws WasmException {
        Objects.requireNonNull(functionName, "functionName cannot be null");
        ...
        try {
            ...
            throw JniExceptionHandler.wrapException(e, "Failed to set breakpoint at " + functionName + ":" + instructionOffset);
        }
    }
    ...
    public int removeBreakpoints(final String functionName) throws WasmException {
        ...
        try {
            ...
            throw JniExceptionHandler.wrapException(e, "Failed to remove breakpoints in function " + functionName);
        }
    }
    ...
    public CompletableFuture<DebugEvent> continueExecution() throws WasmException {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                throw new RuntimeException(JniExceptionHandler.wrapException(e, "Failed to continue execution"));
            }
        });
    }
    ...
    public CompletableFuture<DebugEvent> pause() throws WasmException {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                throw new RuntimeException(JniExceptionHandler.wrapException(e, "Failed to pause execution"));
            }
        });
    }
    ...
    public VariableValue getVariableValue(final String variableName) throws WasmException {
        ...
        try {
            ...
            throw JniExceptionHandler.wrapException(e, "Failed to get variable value for " + variableName);
        }
    }

    @Override
    public void setVariableValue(final String variableName, final VariableValue value) throws WasmException {
        Objects.requireNonNull(variableName, "variableName cannot be null");
        ...
        try {
            ...
            throw JniExceptionHandler.wrapException(e, "Failed to set variable value for " + variableName);
        }
    }
    ...
    @Override
    public List<Long> searchMemory(final byte[] pattern, final long startAddress, final long endAddress) throws WasmException {
    ...
    /**
     * Notifies event listeners of a debug event.
     * Called by native code via JNI callback.
     */
    ...
    private static native long nativeCreateSession(long debuggerHandle, long instanceHandle, DebugConfig config);

    private static native long nativeCreateMultiSession(long debuggerHandle, long[] instanceHandles, DebugConfig config);
    ...
    private static native Breakpoint nativeSetBreakpointAtLine(long sessionHandle, String functionName, int line);

    private static native Breakpoint nativeSetBreakpointAtOffset(long sessionHandle, String functionName, long offset);

    private static native boolean nativeRemoveBreakpoint(long sessionHandle, String breakpointId);

    private static native int nativeRemoveBreakpointsInFunction(long sessionHandle, String functionName);
    ...
    private static native VariableValue nativeGetVariableValue(long sessionHandle, String variableName);

    private static native void nativeSetVariableValue(long sessionHandle, String variableName, VariableValue value);
    ...
    private static native List<Long> nativeSearchMemory(long sessionHandle, byte[] pattern, long startAddress, long endAddress);

    private static native EvaluationResult nativeEvaluateExpression(long sessionHandle, String expression);

    private static native DebugEvent nativeWaitForEvent(long sessionHandle, long timeoutMs) throws InterruptedException;
