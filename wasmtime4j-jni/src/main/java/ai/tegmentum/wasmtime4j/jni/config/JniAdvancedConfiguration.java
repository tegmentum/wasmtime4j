 ...
 * specifically optimized for JNI-based operations.
 *
 * <p>Features include:
 *
 * <ul>
...
public final class JniAdvancedConfiguration implements AdvancedConfiguration {
  ...
  public JniAdvancedConfiguration() {
    ...
    try {
      ...
      LOGGER.log(
          Level.FINE, "Created JNI advanced configuration with handle: {0}", nativeConfigHandle);
  ...
  private static native void nativeSetResourceLimits(
      long configHandle,
      long maxMemory,
  ...
  private static native void nativeSetMemoryConfiguration(
      long configHandle,
      long initialSize,
      long maxSize,
  ...
  private static native void nativeSetThreadConfiguration(
      long configHandle,
      int maxThreads,
      long stackSize,
      boolean poolEnabled,
  ...
  private static native void nativeSetDebugConfiguration(
      long configHandle,
      boolean debugInfo,
      boolean profiling,
