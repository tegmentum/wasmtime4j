 ...
 *
 * <p>This class represents an instantiated WebAssembly module and provides access to its
 * functions, memories, tables, and globals through JNI calls to the native Wasmtime library.
 * An instance is the runtime representation of a compiled module.
 *
...
public final class JniInstance implements AutoCloseable {
     ...
     *
     * <p>After calling this method, all operations on this instance will throw
