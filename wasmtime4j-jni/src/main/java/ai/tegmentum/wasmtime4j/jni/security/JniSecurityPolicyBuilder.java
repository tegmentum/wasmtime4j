...
/**
 * JNI implementation of SecurityPolicyBuilder.
 *
 * @since 1.0.0
 */
public final class JniSecurityPolicyBuilder implements SecurityPolicyBuilder {
    ...
    public JniSecurityPolicyBuilder() {
    ...
    public SecurityPolicyBuilder withMaxMemory(final long maxMemoryBytes) {
        this.resourceLimits = ResourceLimits.builder()
    ...
    private void validate() throws SecurityPolicyException {
        ...
        if (sandboxMode) {
            final Set<Capability> dangerousCapabilities = EnumSet.of(
