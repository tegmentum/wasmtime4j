...
/**
 * JNI implementation of {@link PoolingAllocatorConfig}.
 *
 ...
 * @since 1.0.0
 */
public final class JniPoolingAllocatorConfig implements PoolingAllocatorConfig {
  ...
  /**
   * Creates a new JniPoolingAllocatorConfig with all parameters.
   *
   ...
   */
  public JniPoolingAllocatorConfig(
  ...
  /**
   * Creates a new JniPoolingAllocatorConfig with all parameters including extended options.
   *
   * @param instancePoolSize the number of instances in the pool
   * @param maxMemoryPerInstance maximum memory per instance in bytes
   * @param stackSize stack size for WebAssembly execution in bytes
  ...
  /** Creates a new JniPoolingAllocatorConfig with default values. */
  public JniPoolingAllocatorConfig() {
    this(
  ...
  public String toString() {
    return "JniPoolingAllocatorConfig{"
        + "instancePoolSize="
        + instancePoolSize
        + ", maxMemoryPerInstance="
        + maxMemoryPerInstance
