...
/**
 * JNI implementation of pooling allocator configuration.
 *
 * @since 1.0.0
 */
public final class JniPoolingAllocatorConfig extends AbstractPoolingAllocatorConfig {
  ...
  /**
   * Creates a new JniPoolingAllocatorConfig with the original 14 parameters.
   *
  ...
  /**
   * Creates a new JniPoolingAllocatorConfig with all 29 parameters.
   *
   * @param instancePoolSize the number of instances in the pool
   * @param maxMemoryPerInstance maximum memory per instance in bytes
   * @param stackSize stack size for WebAssembly execution in bytes
