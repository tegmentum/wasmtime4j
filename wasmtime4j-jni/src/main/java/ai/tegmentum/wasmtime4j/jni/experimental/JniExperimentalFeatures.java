...
public final class JniExperimentalFeatures extends JniResource {
    ...
    public void configureCallCc(final int maxContinuations, final int storageStrategy, final int compressionEnabled) {
        ...
        try {
            nativeConfigureCallCc(getNativeHandle(), maxContinuations, storageStrategy, compressionEnabled);
    ...
    public void configureAdvancedSecurity(final int securityLevel, final int enableSandboxing,
        ...
        try {
            nativeConfigureAdvancedSecurity(getNativeHandle(), securityLevel, enableSandboxing,
    ...
    public void configureAdvancedProfiling(final int enablePerfCounters, final int enableTracing,
        ...
        try {
            nativeConfigureAdvancedProfiling(getNativeHandle(), enablePerfCounters, enableTracing,
    ...
    private static native void nativeConfigureStackSwitching(long handle, long stackSize,
                                                             int maxStacks, int strategy);

    private static native void nativeConfigureCallCc(long handle, int maxContinuations,
                                                     int storageStrategy, int compressionEnabled);

    private static native void nativeConfigureAdvancedSecurity(long handle, int securityLevel,
                                                              int enableSandboxing, int enableResourceLimits,
                                                              int maxMemoryMb);

    private static native void nativeConfigureAdvancedProfiling(long handle, int enablePerfCounters,
                                                               int enableTracing, int granularity,
