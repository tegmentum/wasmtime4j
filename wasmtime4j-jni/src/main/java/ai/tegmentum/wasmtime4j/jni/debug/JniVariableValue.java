...
/**
 * Represents a variable value in WebAssembly debugging context.
 *
 ...
 * @since 1.0.0
 */
public final class JniVariableValue {

  private final ValueType type;
  private final Object value;

  private JniVariableValue(final ValueType type, final Object value) {
   ...
   */
  public static JniVariableValue i32(final int value) {
    return new JniVariableValue(ValueType.I32, value);
  }
   ...
   */
  public static JniVariableValue i64(final long value) {
    return new JniVariableValue(ValueType.I64, value);
  }
   ...
   */
  public static JniVariableValue f32(final float value) {
    return new JniVariableValue(ValueType.F32, value);
  }
   ...
   */
  public static JniVariableValue f64(final double value) {
    return new JniVariableValue(ValueType.F64, value);
  }
   ...
   */
  public static JniVariableValue v128(final byte[] bytes) {
    if (bytes == null || bytes.length != 16) {
      throw new IllegalArgumentException("v128 requires exactly 16 bytes");
    }
    return new JniVariableValue(ValueType.V128, Arrays.copyOf(bytes, 16));
  }
   ...
   */
  public static JniVariableValue funcRef(final Integer funcIndex) {
    return new JniVariableValue(ValueType.FUNCREF, funcIndex);
  }
   ...
   */
  public static JniVariableValue externRef(final Long refValue) {
    return new JniVariableValue(ValueType.EXTERNREF, refValue);
  }
   ...
   */
  public static JniVariableValue memory(final long address, final long size) {
    return new JniVariableValue(ValueType.MEMORY, new long[] {address, size});
  }
   ...
   */
  public static JniVariableValue complex(final String json) {
    return new JniVariableValue(ValueType.COMPLEX, json);
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof JniVariableValue)) {
      return false;
    }
    final JniVariableValue other = (JniVariableValue) obj;
    if (type != other.type) {
      return false;
    }
    if (type == ValueType.V128) {
