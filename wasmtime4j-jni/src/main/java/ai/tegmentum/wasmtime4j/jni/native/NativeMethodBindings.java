 ...
 *
 * <p>This class manages the initialization of native methods and provides a single point of
 * control for loading and validating JNI bindings. It ensures that the native library is
 * loaded before any native methods are called.
 *
...
public final class NativeMethodBindings {
     ...
     *
     * <p>This method must be called before any native methods are used. It loads the native
     * library and validates that all required methods are available. This method is thread-safe
     ...
     *
     * <p>This is a convenience method that should be called at the beginning of any operation
     * that requires native methods. It will initialize the bindings if they haven't been
     * initialized yet.
     *
     ...
     *
     * <p>This method can be used to verify that the correct version of the native library
     ...
     *
     * <p>This method performs basic validation by calling native methods that should always
     * be available. If any critical method is missing, it throws an exception.
     *
    ...
    private static void validateNativeMethods() {
        try {
            ...
            if (testHandle != 0) {
                ...
                LOGGER.warning("Native runtime creation returned null handle (may be normal during initialization)");
            }
     ...
     *
     * <p>This method can be used to call native initialization functions that need to be
     * executed once after the library is loaded.
     */
