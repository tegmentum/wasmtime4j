...
/**
 * JNI provider for ModuleCache.
 *
 * <p>This provider is registered via META-INF/services for ServiceLoader discovery.
 *
 * @since 1.0.0
 */
public final class JniModuleCacheProvider implements ModuleCacheFactory.ModuleCacheProvider {
  ...
  public ModuleCache create(final Engine engine, final ModuleCacheConfig config)
    ...
    return new JniModuleCache((JniEngine) engine, config);
  }
}
