...
/**
 * JNI implementation of debug configuration.
 *
 * <p>This class provides configuration options for WebAssembly debugging sessions.
 *
 * @since 1.0.0
 */
public final class JniDebugConfig implements DebugConfig {
  ...
  private JniDebugConfig(final Builder builder) {
   ...
   */
  public static JniDebugConfig getDefault() {
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof JniDebugConfig)) {
      return false;
    }
    final JniDebugConfig other = (JniDebugConfig) obj;
  ...
  public static final class Builder {
     ...
     */
    public JniDebugConfig build() {
      return new JniDebugConfig(this);
    }
  }
}
