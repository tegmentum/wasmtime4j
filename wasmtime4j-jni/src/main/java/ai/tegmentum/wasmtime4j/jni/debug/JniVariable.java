...
/**
 * Represents a variable in WebAssembly debugging context.
 *
 ...
 * @since 1.0.0
 */
public final class JniVariable {

  private final String name;
  private final String varType;
  private final JniVariableValue value;
   ...
   */
  public static JniVariable local(
      final String name, final String varType, final JniVariableValue value, final int index) {
    return new JniVariable(name, varType, value, VariableScope.LOCAL, index, true, null);
  }
   ...
   */
  public static JniVariable parameter(
      final String name, final String varType, final JniVariableValue value, final int index) {
    return new JniVariable(name, varType, value, VariableScope.PARAMETER, index, false, null);
  }
   ...
   */
  public static JniVariable global(
      final String name,
      final String varType,
      final JniVariableValue value,
      final int index,
      final boolean mutable) {
    return new JniVariable(name, varType, value, VariableScope.GLOBAL, index, mutable, null);
  }
   ...
   * @return the value
   */
  public JniVariableValue getValue() {
    return value;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof JniVariable)) {
      return false;
    }
    final JniVariable other = (JniVariable) obj;
