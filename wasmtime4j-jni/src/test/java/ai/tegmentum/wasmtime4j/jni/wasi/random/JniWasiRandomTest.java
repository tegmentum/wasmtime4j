...
/**
 * Tests for {@link JniWasiRandom} class.
 *
 * <p>JniWasiRandom provides JNI-based access to WASI Preview 2 cryptographically-secure random
 * number generation.
 */
@DisplayName("JniWasiRandom Tests")
class JniWasiRandomTest {
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() throws ClassNotFoundException {
      ...
      assertTrue(Modifier.isFinal(clazz.getModifiers()), "JniWasiRandom should be final");
    }
    ...
    void shouldBePublic() throws ClassNotFoundException {
      final Class<?> clazz = loadClassWithoutInit();
      assertTrue(Modifier.isPublic(clazz.getModifiers()), "JniWasiRandom should be public");
    }
