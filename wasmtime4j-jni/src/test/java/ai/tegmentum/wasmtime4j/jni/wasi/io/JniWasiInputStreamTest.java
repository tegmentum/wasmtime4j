...
/**
 * Tests for {@link JniWasiInputStream} class.
 *
 * <p>JniWasiInputStream provides JNI-based access to WASI Preview 2 input stream operations.
 */
@DisplayName("JniWasiInputStream Tests")
class JniWasiInputStreamTest {
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() throws ClassNotFoundException {
      ...
      assertTrue(Modifier.isFinal(clazz.getModifiers()), "JniWasiInputStream should be final");
    }
    ...
    void shouldBePublic() throws ClassNotFoundException {
      final Class<?> clazz = loadClassWithoutInit();
      assertTrue(Modifier.isPublic(clazz.getModifiers()), "JniWasiInputStream should be public");
    }
  ...
  class NativeMethodTests {
    ...
    void shouldHaveNativeMethodsDeclared() throws ClassNotFoundException {
      ...
      assertTrue(nativeMethodCount >= 5, "Should have at least 5 native methods");
    }
  }
