...
class JniWasiExitTest {
  ...
  private Class<?> loadClassWithoutInit() throws ClassNotFoundException {
    return Class.forName(
        "ai.tegmentum.wasmtime4j.jni.wasi.cli.JniWasiExit", false, getClass().getClassLoader());
  }
  ...
  class ClassStructureTests {
    ...
    void shouldBeFinalClass() throws ClassNotFoundException {
      ...
      assertTrue(Modifier.isFinal(clazz.getModifiers()), "JniWasiExit should be final");
    }
    ...
    void shouldBePublic() throws ClassNotFoundException {
      final Class<?> clazz = loadClassWithoutInit();
      assertTrue(Modifier.isPublic(clazz.getModifiers()), "JniWasiExit should be public");
    }
  ...
  class NativeMethodTests {
    ...
    void shouldHaveNativeMethodsDeclared() throws ClassNotFoundException {
      ...
      assertTrue(nativeMethodCount >= 1, "Should have at least 1 native method");
    }
