 ...
 * <ul>
 *   <li>Reading/writing at various offsets</li>
 *   <li>Testing boundary conditions</li>
 *   <li>Testing memory growth</li>
 *   <li>Testing buffer access patterns</li>
 * </ul>
 *
 * @since 1.0.0
 */
public class MemoryFuzzer {
     ...
     *
     * <p>Tests memory access through exported functions that use
     * i32.load and i32.store instructions.
     *
     * @param data fuzzed data provider
     */
    @FuzzTest
    public void fuzzMemoryViaWasm(final FuzzedDataProvider data) {
        ...
        try (Engine engine = Engine.create();
            ...
            try {
                // Store a value
                instance.callFunction("store_i32",
                ...
                final ai.tegmentum.wasmtime4j.WasmValue[] results =
                    instance.callFunction("load_i32",
                        ai.tegmentum.wasmtime4j.WasmValue.i32(offset));
