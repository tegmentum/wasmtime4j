 ...
 *
 * <p>This fuzzer tests the robustness of WASM/WAT module parsing by feeding
 * arbitrary byte sequences to the module loader. It aims to discover:
 * <ul>
 *   <li>Malformed magic bytes handling</li>
 *   <li>Invalid section length handling</li>
 *   <li>Type index out of bounds</li>
 *   <li>Circular type references</li>
 *   <li>Maximum limits exceeded</li>
 *   <li>Memory safety issues in parsing code</li>
 * </ul>
 *
 * @since 1.0.0
 */
public class ModuleLoadFuzzer {
     ...
     *
     * <p>This test feeds arbitrary byte sequences to the module loader.
     * The module loader should handle all inputs gracefully without crashing.
     *
     ...
     *
     * <p>This test feeds arbitrary strings to the WAT parser.
     * The parser should handle all inputs gracefully.
     *
     * @param data fuzzed data provider
     */
    @FuzzTest
     ...
     *
     * <p>Tests the validation path separately from full compilation
     * to ensure validation handles malformed modules correctly.
     *
     * @param data fuzzed data provider
     */
    @FuzzTest
